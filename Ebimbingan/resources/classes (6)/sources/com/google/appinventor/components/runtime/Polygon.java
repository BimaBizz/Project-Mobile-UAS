...
public class Polygon extends PolygonBase implements MapFactory.MapPolygon {
    ...
    public void PointsFromString(String str) {
        ...
        try {
            ...
            this.TcZoKXUijRhvOFm1gZ0ppEfXWxECqlUNNvncSPIfT3ZrTDcozo05OAb21mkMXciT = this.KbzcIEn6WDqjdY1QBot1TMrBwhEYy4xAUKG2cbzQ22VNohlOtuBGKUJsEeMNZyEH.size() > 1;
            if (this.initialized) {
                clearGeometry();
                this.map.getController().updateFeaturePosition((MapFactory.MapPolygon) this);
            }
    ...
    public void HolePoints(YailList yailList) {
        ...
        try {
            ...
            } else if (this.TcZoKXUijRhvOFm1gZ0ppEfXWxECqlUNNvncSPIfT3ZrTDcozo05OAb21mkMXciT) {
