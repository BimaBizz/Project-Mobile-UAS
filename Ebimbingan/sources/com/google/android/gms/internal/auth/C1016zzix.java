...
/* renamed from: com.google.android.gms.internal.auth.zzix */
/* compiled from: com.google.android.gms:play-services-auth-base@@17.1.2 */
final class C1016zzix {
    static String zza(C1011zzis zzis, String str) {
        StringBuilder sb;
        new StringBuilder();
    ...
    private static void zza(C1011zzis zzis, StringBuilder sb, int i) {
        Map map;
        Map map2;
        Set set;
        Throwable th;
        ...
        new TreeSet();
        Set<String> set2 = set;
        Method[] declaredMethods = zzis2.getClass().getDeclaredMethods();
        ...
        for (String str15 : set2) {
            String str16 = str15;
            String substring = str15.startsWith("get") ? str16.substring(3) : str16;
            String str17 = substring;
            if (substring.endsWith("List") && !str17.endsWith("OrBuilderList") && !str17.equals("List")) {
                ...
                if (method2 != null && method3.getReturnType().equals(List.class)) {
                    zza(sb2, i2, zza(str20), C0978zzhm.zza(method3, (Object) zzis2, new Object[0]));
                }
            }
            if (str17.endsWith("Map") && !str17.equals("Map")) {
                ...
                if (method4 != null && method5.getReturnType().equals(Map.class) && !method5.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method5.getModifiers())) {
                    zza(sb2, i2, zza(str23), C0978zzhm.zza(method5, (Object) zzis2, new Object[0]));
                }
            }
            Map map5 = map4;
            ...
            if (((Method) map5.get(str2)) != null) {
                ...
                if (method6 != null) {
                    Object zza = C0978zzhm.zza(method6, (Object) zzis2, new Object[0]);
                    if (method7 == null) {
                        Object obj = zza;
                        Object obj2 = obj;
                        if (obj instanceof Boolean) {
                            ...
                            z = obj2.equals("");
                        } else if (obj2 instanceof C0947zzgi) {
                            z = obj2.equals(C0947zzgi.zza);
                        } else if (obj2 instanceof C1011zzis) {
                            z = obj2 == ((C1011zzis) obj2).zzh();
                        ...
                        booleanValue = ((Boolean) C0978zzhm.zza(method7, (Object) zzis2, new Object[0])).booleanValue();
                    }
                    if (booleanValue) {
                        zza(sb2, i2, zza(str28), zza);
                    }
                }
            }
        }
        if (zzis2 instanceof C0978zzhm.zzd) {
            Iterator<Map.Entry<C0978zzhm.zzc, Object>> zzd = ((C0978zzhm.zzd) zzis2).zzc.zzd();
            Iterator<Map.Entry<C0978zzhm.zzc, Object>> it = zzd;
            if (zzd.hasNext()) {
                C0978zzhm.zzc zzc = (C0978zzhm.zzc) it.next().getKey();
                Throwable th2 = th;
                new NoSuchMethodError();
                throw th2;
            }
        }
        if (((C0978zzhm) zzis2).zzb != null) {
            ((C0978zzhm) zzis2).zzb.zza(sb2, i2);
        }
    }
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj2 instanceof List) {
            ...
            if (obj2 instanceof String) {
                StringBuilder append4 = sb2.append(": \"").append(C1042zzjw.zza(C0947zzgi.zza((String) obj2))).append('\"');
            } else if (obj2 instanceof C0947zzgi) {
                StringBuilder append5 = sb2.append(": \"").append(C1042zzjw.zza((C0947zzgi) obj2)).append('\"');
            } else if (obj2 instanceof C0978zzhm) {
                StringBuilder append6 = sb2.append(" {");
                zza((C0978zzhm) obj2, sb2, i2 + 2);
