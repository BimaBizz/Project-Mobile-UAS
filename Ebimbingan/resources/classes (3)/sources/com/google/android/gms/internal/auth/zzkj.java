...
final class zzkj {
    ...
    static int zza(CharSequence charSequence) {
        ...
        new IllegalArgumentException(sb.append("UTF-8 length does not fit in int: ").append(((long) i2) + 4294967296L).toString());
        throw th4;
    }
    ...
    static String zzb(byte[] bArr, int i, int i2) throws zzhs {
