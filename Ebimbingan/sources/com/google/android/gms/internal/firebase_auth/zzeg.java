...
public final class zzeg implements zzdv<zzeg, zzp.zze> {
    ...
    public final /* synthetic */ zzdv zza(zzjc zzjc) {
        ...
        this.zzrf = C0615Strings.emptyToNull(zze.getLocalId());
        this.zzif = C0615Strings.emptyToNull(zze.getEmail());
        this.zzib = C0615Strings.emptyToNull(zze.getIdToken());
        this.zzkh = C0615Strings.emptyToNull(zze.zzs());
        this.zzrg = zze.zzu();
        this.zzrh = zze.zzt();
        return this;
    }
