...
public final class zzey {
    ...
    private zzey(Context context, String str) {
        ...
        this.packageName = C0446Preconditions.checkNotEmpty(str6);
        try {
            byte[] packageCertificateHashBytes = C0587AndroidUtilsLight.getPackageCertificateHashBytes(context2, this.packageName);
            ...
            this.zzqu = C0601Hex.bytesToStringUppercase(packageCertificateHashBytes, false);
