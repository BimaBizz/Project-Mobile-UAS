...
public class KodularFirebaseAuthentication extends AndroidNonvisibleComponent implements ActivityResultListener {
    ...
    private C0124GoogleSignInClient mGoogleSignInClient = null;
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mPhoneAuthCallbacks;
    private C0124GoogleSignInClient mPlayGamesSignInClient = null;
    ...
    public void EmailPasswordLogin(String str, String str2) {
        ...
        Task<AuthResult> addOnCompleteListener = this.mAuth.signInWithEmailAndPassword(str, str2).addOnCompleteListener(this.activity, onCompleteListener);
    }
    ...
    public void EmailPasswordSignUp(String str, String str2) {
        ...
        Task<AuthResult> addOnCompleteListener = this.mAuth.createUserWithEmailAndPassword(str, str2).addOnCompleteListener(this.activity, onCompleteListener);
    }
    ...
    public void VerifyEmail() {
        ...
        FirebaseUser firebaseUser = currentUser;
        if (currentUser != null) {
            Task<Void> sendEmailVerification = firebaseUser.sendEmailVerification(ActionCodeSettings.newBuilder().setAndroidPackageName(this.form.getPackageName(), true, "16").build());
        }
    }
    ...
    public void Logout() {
        ...
        Task<Void> signOut2 = getPlayGamesSignInClient().signOut();
    }
    ...
    public void UpdateProfile(String str, String str2) {
        ...
        if (currentUser != null) {
            ...
            Task<Void> addOnCompleteListener = firebaseUser.updateProfile(build).addOnCompleteListener(this.activity, onCompleteListener);
            return;
        }
    ...
    public void UpdateEmail(String str) {
        ...
        if (currentUser != null) {
            ...
            Task<Void> addOnCompleteListener = firebaseUser.updateEmail(str2).addOnCompleteListener(this.activity, onCompleteListener);
            return;
        }
    ...
    public void GetIdToken() {
        ...
        if (currentUser != null) {
            ...
            Task<GetTokenResult> addOnSuccessListener = firebaseUser.getIdToken(true).addOnSuccessListener(onSuccessListener);
            return;
        }
        GotIdToken("");
    }
    ...
    public void SendResetPasswordEmail(String str) {
        ...
        Task<Void> addOnCompleteListener = this.mAuth.sendPasswordResetEmail(str).addOnCompleteListener(onCompleteListener);
    }
    ...
    private void firebaseAuthWithGoogle(C0122GoogleSignInAccount googleSignInAccount) {
        StringBuilder sb;
    ...
    private void firebaseAuthWithPlayGames(C0122GoogleSignInAccount googleSignInAccount) {
        StringBuilder sb;
        C0122GoogleSignInAccount googleSignInAccount2 = googleSignInAccount;
    ...
    private void firebaseAuthWithCredential(AuthCredential authCredential, String str) {
        ...
        Task<AuthResult> addOnCompleteListener = this.mAuth.signInWithCredential(authCredential).addOnCompleteListener(this.activity, onCompleteListener);
    }
    ...
    public void firebaseAuthWithPhoneNumber(PhoneAuthCredential phoneAuthCredential) {
        ...
        if (this.phoneNewUser) {
            ...
            Task<AuthResult> addOnCompleteListener = this.mAuth.signInWithCredential(phoneAuthCredential2).addOnCompleteListener(this.activity, onCompleteListener2);
            return;
        }
        FirebaseUser currentUser = this.mAuth.getCurrentUser();
        FirebaseUser firebaseUser = currentUser;
        if (currentUser != null) {
            ...
            Task<Void> addOnCompleteListener2 = firebaseUser.updatePhoneNumber(phoneAuthCredential2).addOnCompleteListener(this.activity, onCompleteListener);
        }
    }

    private C0124GoogleSignInClient getGoogleSignInClient() {
        C0125GoogleSignInOptions.Builder builder;
        if (this.mGoogleSignInClient == null) {
            new C0125GoogleSignInOptions.Builder(C0125GoogleSignInOptions.DEFAULT_SIGN_IN);
            C0125GoogleSignInOptions build = builder.requestIdToken(KodularResourcesUtil.getString(this.context, "default_web_client_id")).requestEmail().build();
            this.mGoogleSignInClient = C0121GoogleSignIn.getClient(this.context, build);
        }
        return this.mGoogleSignInClient;
    }

    private C0124GoogleSignInClient getPlayGamesSignInClient() {
        if (this.mPlayGamesSignInClient == null) {
            this.mPlayGamesSignInClient = C0121GoogleSignIn.getClient(this.context, C0125GoogleSignInOptions.DEFAULT_GAMES_SIGN_IN);
        }
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i3 == this.googleRequestCode) {
            ...
            try {
                firebaseAuthWithGoogle(C0121GoogleSignIn.getSignedInAccountFromIntent(intent2).getResult(C0212ApiException.class));
            } catch (C0212ApiException e) {
                C0212ApiException apiException = e;
            ...
            try {
                firebaseAuthWithPlayGames(C0121GoogleSignIn.getSignedInAccountFromIntent(intent2).getResult(C0212ApiException.class));
            } catch (C0212ApiException e2) {
                C0212ApiException apiException2 = e2;
