...
public final class zzee extends zzai implements C0211Api.ApiOptions.HasOptions {
    private final String zzht;

    private zzee(String str) {
        this.zzht = C0446Preconditions.checkNotEmpty(str, "A valid API key must be provided");
    }
    ...
    public final int hashCode() {
        return C0444Objects.hashCode(this.zzht);
    }
