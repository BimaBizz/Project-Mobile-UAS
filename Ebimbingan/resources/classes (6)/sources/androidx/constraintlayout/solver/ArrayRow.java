...
public class ArrayRow implements LinearSystem.Row {
    ...
    public boolean hasKeyVariable() {
        return (this.variable == null || (this.variable.mType != SolverVariable.Type.UNRESTRICTED && this.constantValue < 0.0f)) ? DEBUG : true;
    }
    ...
    public boolean isEmpty() {
        return (this.variable == null && this.constantValue == 0.0f && this.variables.currentSize == 0) ? true : DEBUG;
    }
