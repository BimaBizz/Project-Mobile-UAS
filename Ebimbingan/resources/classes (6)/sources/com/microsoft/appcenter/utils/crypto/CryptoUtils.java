...
public class CryptoUtils {
    ...
    public String encrypt(@Nullable String str) {
        ...
        try {
            ...
            String encryptedString = Base64.encodeToString(handler.encrypt(this.mCryptoFactory, this.mApiLevel, getKeyStoreEntry(handlerEntry), data.getBytes(com.bumptech.glide.load.Key.STRING_CHARSET_NAME)), 0);
            new StringBuilder();
    ...
    private DecryptedData getDecryptedData(CryptoHandler cryptoHandler, int aliasIndex, String data) throws Exception {
        ...
        DecryptedData decryptedData;
        CryptoHandler cryptoHandler2 = cryptoHandler;
        new String(cryptoHandler2.decrypt(this.mCryptoFactory, this.mApiLevel, getKeyStoreEntry(cryptoHandler2, aliasIndex), Base64.decode(data, 0)), com.bumptech.glide.load.Key.STRING_CHARSET_NAME);
