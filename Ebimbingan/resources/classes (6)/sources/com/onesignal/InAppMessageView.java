...
class InAppMessageView {
    ...
    public DraggableRelativeLayout.Params createDraggableLayoutParams(int i, WebViewManager.Position position) {
        ...
        switch (AnonymousClass9.$SwitchMap$com$onesignal$WebViewManager$Position[displayLocation2.ordinal()]) {
            case 1:
    ...
    public void animateInAppMessage(WebViewManager.Position position, View view, View view2) {
        ...
        CardView messageViewCardView = messageView.findViewWithTag(IN_APP_MESSAGE_CARD_VIEW_TAG);
    ...
    private Animation.AnimationListener createAnimationListenerForAndroidApi23Elevation(CardView messageViewCardView) {
        Animation.AnimationListener animationListener;
        final CardView cardView = messageViewCardView;
    ...
    private void animateCenter(View messageView, View backgroundView, Animation.AnimationListener cardViewAnimCallback, Animator.AnimatorListener backgroundAnimCallback) {
        ...
        ValueAnimator backgroundAnimation = animateBackgroundColor(backgroundView, IN_APP_BACKGROUND_ANIMATION_DURATION_MS, ACTIVITY_BACKGROUND_COLOR_EMPTY, ACTIVITY_BACKGROUND_COLOR_FULL, backgroundAnimCallback);
    ...
    public void animateAndDismissLayout(View backgroundView, WebViewManager.OneSignalGenericCallback callback) {
        ...
        animateBackgroundColor(backgroundView, IN_APP_BACKGROUND_ANIMATION_DURATION_MS, ACTIVITY_BACKGROUND_COLOR_FULL, ACTIVITY_BACKGROUND_COLOR_EMPTY, animCallback).start();
    }
