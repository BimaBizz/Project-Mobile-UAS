...
@C0463SafeParcelable.Class(creator = "ActivityRecognitionResultCreator")
@C0463SafeParcelable.Reserved({1000})
public class ActivityRecognitionResult extends C0460AbstractSafeParcelable implements C0447ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@C0463SafeParcelable.Param(id = 1) List<DetectedActivity> list, @C0463SafeParcelable.Param(id = 2) long j, @C0463SafeParcelable.Param(id = 3) long j2, @C0463SafeParcelable.Param(id = 4) int i, @C0463SafeParcelable.Param(id = 5) Bundle bundle) {
        List<DetectedActivity> list2 = list;
        long j3 = j;
        long j4 = j2;
        int i2 = i;
        Bundle bundle2 = bundle;
        C0446Preconditions.checkArgument(list2 != null && list2.size() > 0, "Must have at least 1 detected activity");
        C0446Preconditions.checkArgument(j3 > 0 && j4 > 0, "Must set times");
        this.zze = list2;
        this.zzf = j3;
        this.zzg = j4;
        this.zzh = i2;
    ...
    public static com.google.android.gms.location.ActivityRecognitionResult extractResult(android.content.Intent r9) {
        /*
            ...
            com.google.android.gms.common.internal.safeparcel.SafeParcelable r5 = com.google.android.gms.common.internal.safeparcel.C0464SafeParcelableSerializer.deserializeFromBytes(r5, r6)
    ...
    private static List<ActivityRecognitionResult> zza(Intent intent) {
        ...
        return C0464SafeParcelableSerializer.deserializeIterableFromIntentExtra(intent2, "com.google.android.location.internal.EXTRA_ACTIVITY_RESULT_LIST", CREATOR);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeTypedList(parcel2, 1, this.zze, false);
        C0462SafeParcelWriter.writeLong(parcel2, 2, this.zzf);
        C0462SafeParcelWriter.writeLong(parcel2, 3, this.zzg);
        C0462SafeParcelWriter.writeInt(parcel2, 4, this.zzh);
        C0462SafeParcelWriter.writeBundle(parcel2, 5, this.extras, false);
