...
class OSOutcomeEventsController {
    ...
    private void sendAndCreateOutcomeEvent(@NonNull String str, @NonNull float f, @NonNull List<OSInfluence> influences, @Nullable OneSignal.OutcomeCallback outcomeCallback) {
        ...
        for (OSInfluence influence : influences) {
            switch (AnonymousClass5.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[influence.getInfluenceType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            $SwitchMap$com$onesignal$influence$model$OSInfluenceChannel = new int[OSInfluenceChannel.values().length];
            try {
                $SwitchMap$com$onesignal$influence$model$OSInfluenceChannel[OSInfluenceChannel.IAM.ordinal()] = 1;
