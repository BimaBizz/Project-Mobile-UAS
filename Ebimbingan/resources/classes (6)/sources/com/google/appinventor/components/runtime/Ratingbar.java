...
public final class Ratingbar extends AndroidViewComponent implements RatingBar.OnRatingBarChangeListener {
    ...
    private final RatingBar f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public Ratingbar(com.google.appinventor.components.runtime.ComponentContainer r8) {
        /*
            ...
            r4.<init>(r5)
            r2.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            android.widget.RatingBar r2 = r2.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
            ...
            r2 = r6
            r3 = r6
            android.widget.RatingBar r3 = r3.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public final RatingBar getView() {
        return this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public final void SetNumberOfStars(int i) {
        this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setNumStars(i);
    }

    @SimpleProperty(description = "Returns the number of stars shown.")
    public final int GetNumberOfStars() {
        return this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getNumStars();
    }
    ...
    public final void IsIndicator(boolean z) {
        this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setIsIndicator(z);
    }

    @SimpleProperty(description = "Sets the rating (the number of stars filled).")
    public final void SetRating(float f) {
        this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRating(f);
    }

    @SimpleProperty(description = "Gets the current rating (number of stars filled).")
    public final float GetRating() {
        return this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getRating();
    }
    ...
    public final void SetStepSize(float f) {
        this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setStepSize(f);
    }

    @SimpleProperty(description = "Gets the step size (granularity) of this rating bar.")
    public final float GetStepSize() {
        return this.f200hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getStepSize();
    }
