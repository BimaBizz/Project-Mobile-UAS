...
public final class BytesToNameCanonicalizer {
    ...
    private void mergeChild(TableInfo tableInfo) {
        ...
        if (i > tableInfo3.count) {
            if (i > MAX_ENTRIES_FOR_REUSE || tableInfo2.longestCollisionList > MAX_COLL_CHAIN_FOR_REUSE) {
    ...
    public Name findName(int i, int i2) {
        ...
        int i8 = i7 & MAX_COLL_CHAIN_LENGTH;
    ...
    public Name findName(int[] iArr, int i) {
        ...
        int i7 = i6 & MAX_COLL_CHAIN_LENGTH;
    ...
    private void _addSymbol(int i, Name name) {
        ...
        if (this._mainNames[i4] == null) {
            ...
            int i6 = i5 & MAX_COLL_CHAIN_LENGTH;
            if (i6 == 0) {
