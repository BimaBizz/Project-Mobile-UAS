...
interface zzkx {
    ...
    void zza(int i, zzgi zzgi) throws IOException;

    <K, V> void zza(int i, zzin<K, V> zzin, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzji zzji) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzji zzji) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzji zzji) throws IOException;

    void zzb(int i, List<zzgi> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzji zzji) throws IOException;
