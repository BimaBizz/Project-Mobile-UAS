...
@C0463SafeParcelable.Class(creator = "LocationRequestCreator")
@C0463SafeParcelable.Reserved({1000})
public final class LocationRequest extends C0460AbstractSafeParcelable implements C0447ReflectedParcelable {
    public static final Parcelable.Creator<LocationRequest> CREATOR;
    public static final int PRIORITY_BALANCED_POWER_ACCURACY = 102;
    public static final int PRIORITY_HIGH_ACCURACY = 100;
    public static final int PRIORITY_LOW_POWER = 104;
    public static final int PRIORITY_NO_POWER = 105;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", id = 1)
    private int priority;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", id = 5)
    private long zzaf;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", id = 2)
    private long zzaw;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", id = 3)
    private long zzax;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", id = 4)
    private boolean zzay;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", id = 7)
    private float zzaz;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", id = 8)
    private long zzba;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", id = 6)
    private int zzx;
    ...
    LocationRequest(@C0463SafeParcelable.Param(id = 1) int i, @C0463SafeParcelable.Param(id = 2) long j, @C0463SafeParcelable.Param(id = 3) long j2, @C0463SafeParcelable.Param(id = 4) boolean z, @C0463SafeParcelable.Param(id = 5) long j3, @C0463SafeParcelable.Param(id = 6) int i2, @C0463SafeParcelable.Param(id = 7) float f, @C0463SafeParcelable.Param(id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeInt(parcel2, 1, this.priority);
        C0462SafeParcelWriter.writeLong(parcel2, 2, this.zzaw);
        C0462SafeParcelWriter.writeLong(parcel2, 3, this.zzax);
        C0462SafeParcelWriter.writeBoolean(parcel2, 4, this.zzay);
        C0462SafeParcelWriter.writeLong(parcel2, 5, this.zzaf);
        C0462SafeParcelWriter.writeInt(parcel2, 6, this.zzx);
        C0462SafeParcelWriter.writeFloat(parcel2, 7, this.zzaz);
        C0462SafeParcelWriter.writeLong(parcel2, 8, this.zzba);
