...
final class zzkg {
    ...
    private static final Logger zzb = Logger.getLogger(zzkg.class.getName());
    private static final Unsafe zzc = zzc();
    private static final Class<?> zzd = zzgb.zzb();
    ...
    static final class zza extends zzd {
        ...
        public final byte zza(Object obj, long j) {
            ...
            long j2 = j;
            if (zzkg.zza) {
                return zzkg.zzk(obj2, j2);
            }
            return zzkg.zzl(obj2, j2);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            ...
            long j2 = j;
            if (zzkg.zza) {
                return zzkg.zzm(obj2, j2);
            }
            return zzkg.zzn(obj2, j2);
        }
