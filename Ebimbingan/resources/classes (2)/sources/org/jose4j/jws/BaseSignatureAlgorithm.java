...
public abstract class BaseSignatureAlgorithm extends AlgorithmInfo implements JsonWebSignatureAlgorithm {
    ...
    public void validateSigningKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            Throwable th2 = th;
            new StringBuilder();
            new InvalidKeyException(sb.append(getBadKeyMessage(key2)).append("(not a private key or is the wrong type of key) for ").append(getJavaAlgorithm()).append(" / ").append(getAlgorithmIdentifier()).append(" ").append(e2).toString());
            throw th2;
        }
    }
    ...
    public void validateVerificationKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            Throwable th2 = th;
            new StringBuilder();
            new InvalidKeyException(sb.append(getBadKeyMessage(key2)).append("(not a public key or is the wrong type of key) for ").append(getJavaAlgorithm()).append("/").append(getAlgorithmIdentifier()).append(" ").append(e2).toString());
            throw th2;
        }
    }
