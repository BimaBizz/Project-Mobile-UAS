...
/* renamed from: com.google.android.gms.common.internal.zac */
/* compiled from: com.google.android.gms:play-services-base@@17.6.0 */
public final class C0487zac {
    @GuardedBy("sCache")
    ...
    static {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.C0487zac.<clinit>():void");
    }
    ...
    public static String zaf(Context context) {
        ...
        try {
            return C0628Wrappers.packageManager(context2).getApplicationLabel(packageName).toString();
    ...
    private static String zai(Context context, String str) {
        ...
        synchronized (simpleArrayMap) {
            try {
                ...
                String str7 = zaa.get(str6);
                if (str7 != null) {
                    return str7;
                }
                Resources remoteResource = C0196GooglePlayServicesUtil.getRemoteResource(context2);
                ...
                String put = zaa.put(str6, string);
                return string;
            } catch (Throwable th) {
                Throwable th2 = th;
