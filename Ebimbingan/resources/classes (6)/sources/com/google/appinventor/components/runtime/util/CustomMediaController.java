...
public class CustomMediaController extends MediaController implements View.OnTouchListener {
    private int wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG = PathInterpolatorCompat.MAX_NUM_POINTS;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (view == this.wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou) {
            show(this.wOjOOBWoVyNzDzaWXgy1S9rRvmLqhYagLoPiKuHlw4Kpu5E5zVoSLSrwTs2bXyKG);
        }
        return false;
    }
}
