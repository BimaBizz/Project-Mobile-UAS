...
public final class zzdq {
    ...
    public static int zza(int i, int i2) {
        ...
        if (i7 < 0) {
            ...
            zza = zzds.zza("%s (%s) must not be negative", objArr2);
        } else if (i6 < 0) {
            Throwable th2 = th;
            ...
            zza = zzds.zza("%s (%s) must be less than size (%s)", objArr5);
        }
    ...
    private static String zza(int i, int i2, @NullableDecl String str) {
        ...
        if (i3 < 0) {
            ...
            return zzds.zza("%s (%s) must not be negative", objArr2);
        } else if (i4 < 0) {
            Throwable th2 = th;
            new StringBuilder(26);
            ...
            return zzds.zza("%s (%s) must not be greater than size (%s)", objArr5);
        }
    }
    ...
    public static void zza(int i, int i2, int i3) {
        ...
        if (i4 < 0 || i5 < i4 || i5 > i6) {
            ...
            if (i9 < 0 || i10 > i7) {
                ...
                str = zzds.zza("end index (%s) must not be less than start index (%s)", objArr2);
            }
