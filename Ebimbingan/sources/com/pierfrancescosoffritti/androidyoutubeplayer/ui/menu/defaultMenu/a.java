...
class a extends RecyclerView.Adapter<C0006a> {
    ...
    class C0006a extends RecyclerView.ViewHolder {
        final View a;
        final TextView b;
        final /* synthetic */ a c;
        ...
        C0006a(com.pierfrancescosoffritti.androidyoutubeplayer.ui.menu.defaultMenu.a r7, android.view.View r8) {
            /*
                r6 = this;
                r0 = r6
                r1 = r7
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.pierfrancescosoffritti.androidyoutubeplayer.ui.menu.defaultMenu.a.C0006a.<init>(com.pierfrancescosoffritti.androidyoutubeplayer.ui.menu.defaultMenu.a, android.view.View):void");
        }
    }
    ...
    public C0006a onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        int i2 = i;
        new C0006a(this, LayoutInflater.from(viewGroup2.getContext()).inflate(R.layout.menu_item, viewGroup2, false));
        return aVar;
    }

    /* renamed from: a */
    public void onBindViewHolder(@NonNull C0006a aVar, int i) {
        C0006a aVar2 = aVar;
        int i2 = i;
