...
/* compiled from: LihatSK.yail */
public class LihatSK extends Form implements Runnable {
    public static LihatSK LihatSK;
    ...
    static final PairWithPosition Lit21 = PairWithPosition.make(Lit5, LList.Empty, "/tmp/1642941051720_0.11789778122575434-0/youngandroidproject/../src/io/kodular/mahendrabima278/Ebimbingan/LihatSK.yail", 90341);
    static final SimpleSymbol Lit22;
    static final PairWithPosition Lit23 = PairWithPosition.make(Lit53, PairWithPosition.make(Lit53, LList.Empty, "/tmp/1642941051720_0.11789778122575434-0/youngandroidproject/../src/io/kodular/mahendrabima278/Ebimbingan/LihatSK.yail", 90485), "/tmp/1642941051720_0.11789778122575434-0/youngandroidproject/../src/io/kodular/mahendrabima278/Ebimbingan/LihatSK.yail", 90480);
    ...
    static final IntNum Lit8 = IntNum.make(21);
    ...
    public Label Label1;
    public final ModuleMethod LihatSK$Initialize;
    ...
    static {
        ...
        Lit48 = (SimpleSymbol) simpleSymbol6.readResolve();
        new SimpleSymbol("add-to-global-vars");
        Lit47 = (SimpleSymbol) simpleSymbol7.readResolve();
        new SimpleSymbol("add-to-components");
        Lit46 = (SimpleSymbol) simpleSymbol8.readResolve();
        new SimpleSymbol("add-to-events");
        Lit45 = (SimpleSymbol) simpleSymbol9.readResolve();
        new SimpleSymbol("add-to-global-var-environment");
        Lit44 = (SimpleSymbol) simpleSymbol10.readResolve();
        new SimpleSymbol("is-bound-in-form-environment");
        Lit43 = (SimpleSymbol) simpleSymbol11.readResolve();
        new SimpleSymbol("lookup-in-form-environment");
        Lit42 = (SimpleSymbol) simpleSymbol12.readResolve();
        new SimpleSymbol("add-to-form-environment");
        Lit41 = (SimpleSymbol) simpleSymbol13.readResolve();
        new SimpleSymbol("android-log-form");
        Lit40 = (SimpleSymbol) simpleSymbol14.readResolve();
        new SimpleSymbol("get-simple-name");
        Lit39 = (SimpleSymbol) simpleSymbol15.readResolve();
        ...
        Lit34 = (SimpleSymbol) simpleSymbol17.readResolve();
        new SimpleSymbol("DesktopMode");
        Lit33 = (SimpleSymbol) simpleSymbol18.readResolve();
        new FString("com.google.appinventor.components.runtime.WebViewer");
        Lit32 = fString4;
        new FString("com.google.appinventor.components.runtime.Label");
        Lit31 = fString5;
        new SimpleSymbol("Width");
        Lit29 = (SimpleSymbol) simpleSymbol19.readResolve();
        new SimpleSymbol("Visible");
        Lit28 = (SimpleSymbol) simpleSymbol20.readResolve();
        new FString("com.google.appinventor.components.runtime.Label");
        Lit27 = fString6;
        new SimpleSymbol("Initialize");
        Lit26 = (SimpleSymbol) simpleSymbol21.readResolve();
        new SimpleSymbol("LihatSK$Initialize");
        Lit25 = (SimpleSymbol) simpleSymbol22.readResolve();
        new SimpleSymbol(PropertyTypeConstants.PROPERTY_TYPE_TEXT);
        SimpleSymbol simpleSymbol43 = (SimpleSymbol) simpleSymbol23.readResolve();
        Lit5 = simpleSymbol43;
        Lit24 = PairWithPosition.make(simpleSymbol43, LList.Empty, "/tmp/1642941051720_0.11789778122575434-0/youngandroidproject/../src/io/kodular/mahendrabima278/Ebimbingan/LihatSK.yail", 90600);
        new SimpleSymbol("CurrentUrl");
        ...
        Lit13 = (SimpleSymbol) simpleSymbol32.readResolve();
        new SimpleSymbol("ReceiveSharedText");
        Lit12 = (SimpleSymbol) simpleSymbol33.readResolve();
        int[] iArr = new int[2];
        iArr[0] = -12627531;
        Lit11 = IntNum.make(iArr);
        new SimpleSymbol("PrimaryColorDark");
        Lit10 = (SimpleSymbol) simpleSymbol34.readResolve();
        new SimpleSymbol("number");
        Lit9 = (SimpleSymbol) simpleSymbol35.readResolve();
        new SimpleSymbol("MinSdk");
        Lit7 = (SimpleSymbol) simpleSymbol36.readResolve();
        new SimpleSymbol("AppName");
        Lit6 = (SimpleSymbol) simpleSymbol37.readResolve();
        new SimpleSymbol("AppId");
        Lit4 = (SimpleSymbol) simpleSymbol38.readResolve();
        new SimpleSymbol("g$link");
        Lit3 = (SimpleSymbol) simpleSymbol39.readResolve();
        new SimpleSymbol("*the-null-value*");
        Lit2 = (SimpleSymbol) simpleSymbol40.readResolve();
        new SimpleSymbol("getMessage");
        Lit1 = (SimpleSymbol) simpleSymbol41.readResolve();
        new SimpleSymbol("LihatSK");
        Lit0 = (SimpleSymbol) simpleSymbol42.readResolve();
    }
    ...
    public LihatSK() {
        ...
        ModuleMethod moduleMethod25 = moduleMethod;
        new frame();
        frame frame3 = frame2;
        frame3.$main = this;
        frame frame4 = frame3;
        new ModuleMethod(frame4, 1, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.get$Mnsimple$Mnname = moduleMethod25;
        new ModuleMethod(frame4, 2, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = moduleMethod2;
        new ModuleMethod(frame4, 3, Lit41, 8194);
        this.add$Mnto$Mnform$Mnenvironment = moduleMethod3;
        new ModuleMethod(frame4, 4, Lit42, 8193);
        this.lookup$Mnin$Mnform$Mnenvironment = moduleMethod4;
        new ModuleMethod(frame4, 6, Lit43, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = moduleMethod5;
        new ModuleMethod(frame4, 7, Lit44, 8194);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = moduleMethod6;
        new ModuleMethod(frame4, 8, Lit45, 8194);
        this.add$Mnto$Mnevents = moduleMethod7;
        new ModuleMethod(frame4, 9, Lit46, 16388);
        this.add$Mnto$Mncomponents = moduleMethod8;
        new ModuleMethod(frame4, 10, Lit47, 8194);
        this.add$Mnto$Mnglobal$Mnvars = moduleMethod9;
        new ModuleMethod(frame4, 11, Lit48, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = moduleMethod10;
        new ModuleMethod(frame4, 12, Lit49, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        new ModuleMethod(frame4, 14, Lit50, 16388);
        this.dispatchEvent = moduleMethod13;
        new ModuleMethod(frame4, 15, Lit51, 16388);
        this.dispatchGenericEvent = moduleMethod14;
        new ModuleMethod(frame4, 16, Lit52, 8194);
        this.lookup$Mnhandler = moduleMethod15;
        new ModuleMethod(frame4, 17, (Object) null, 0);
        ModuleMethod moduleMethod26 = moduleMethod16;
        moduleMethod26.setProperty("source-location", "/tmp/runtime5171376252785622841.scm:615");
        lambda$Fn1 = moduleMethod26;
        ...
        new ModuleMethod(frame4, 21, Lit25, 0);
        this.LihatSK$Initialize = moduleMethod20;
    ...
    public final void run(CallContext $ctx) {
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addGlobalVarToCurrentFormEnvironment(Lit3, runtime.callYailPrimitive(runtime.get$Mnstart$Mnvalue, LList.Empty, LList.Empty, "get start value")), $result);
        } else {
            addToGlobalVars(Lit3, lambda$Fn2);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Object andCoerceProperty$Ex = runtime.setAndCoerceProperty$Ex(Lit0, Lit4, "4587113544679424", Lit5);
            Object andCoerceProperty$Ex2 = runtime.setAndCoerceProperty$Ex(Lit0, Lit6, "Ebimbingan", Lit5);
            Object andCoerceProperty$Ex3 = runtime.setAndCoerceProperty$Ex(Lit0, Lit7, Lit8, Lit9);
            Object andCoerceProperty$Ex4 = runtime.setAndCoerceProperty$Ex(Lit0, Lit10, Lit11, Lit9);
            Object andCoerceProperty$Ex5 = runtime.setAndCoerceProperty$Ex(Lit0, Lit12, AlgorithmIdentifiers.NONE, Lit5);
            Object andCoerceProperty$Ex6 = runtime.setAndCoerceProperty$Ex(Lit0, Lit13, Boolean.FALSE, Lit14);
            Object andCoerceProperty$Ex7 = runtime.setAndCoerceProperty$Ex(Lit0, Lit15, "LihatSK", Lit5);
        ...
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Object addToCurrentFormEnvironment = runtime.addToCurrentFormEnvironment(Lit25, this.LihatSK$Initialize);
        } else {
            addToFormEnvironment(Lit25, this.LihatSK$Initialize);
        }
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "LihatSK", "Initialize");
        } else {
            addToEvents(Lit0, Lit26);
        }
        this.Label1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit0, Lit27, Lit17, lambda$Fn4), $result);
        } else {
            addToComponents(Lit0, Lit31, Lit17, lambda$Fn5);
        }
        this.Web_Viewer1 = null;
        if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
            Values.writeValues(runtime.addComponentWithinRepl(Lit0, Lit32, Lit19, lambda$Fn6), $result);
        } else {
            addToComponents(Lit0, Lit35, Lit19, lambda$Fn7);
        }
    ...
    public Object LihatSK$Initialize() {
        runtime.setThisForm();
        Object andCoerceProperty$Ex = runtime.setAndCoerceProperty$Ex(Lit17, Lit18, runtime.callYailPrimitive(runtime.get$Mnstart$Mnvalue, LList.Empty, LList.Empty, "get start value"), Lit5);
        Object callComponentMethod = runtime.callComponentMethod(Lit19, Lit20, LList.list1(runtime.get$Mnproperty.apply2(Lit17, Lit18)), Lit21);
        return runtime.callYailPrimitive(runtime.yail$Mnnot$Mnequal$Qu, LList.list2(runtime.get$Mnproperty.apply2(Lit19, Lit22), runtime.get$Mnproperty.apply2(Lit17, Lit18)), Lit23, "=") != Boolean.FALSE ? runtime.callComponentMethod(Lit19, Lit20, LList.list1(runtime.get$Mnproperty.apply2(Lit17, Lit18)), Lit24) : Values.empty;
    }

    static Object lambda5() {
        Object andCoerceProperty$Ex = runtime.setAndCoerceProperty$Ex(Lit17, Lit18, "Text for Label1", Lit5);
        Object andCoerceProperty$Ex2 = runtime.setAndCoerceProperty$Ex(Lit17, Lit28, Boolean.FALSE, Lit14);
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit29, Lit30, Lit9);
    }
    ...
    static Object lambda7() {
        Object andCoerceProperty$Ex = runtime.setAndCoerceProperty$Ex(Lit19, Lit33, Boolean.FALSE, Lit14);
        Object andCoerceProperty$Ex2 = runtime.setAndCoerceProperty$Ex(Lit19, Lit34, Lit30, Lit9);
        return runtime.setAndCoerceProperty$Ex(Lit19, Lit29, Lit30, Lit9);
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object apply0(ModuleMethod moduleMethod) {
            ...
            switch (moduleMethod2.selector) {
                case 17:
                    return LihatSK.lambda2();
                case 18:
                    this.$main.$define();
                    return Values.empty;
                case 19:
                    return LihatSK.lambda3();
                case 20:
                    return LihatSK.lambda4();
                case 21:
                    return this.$main.LihatSK$Initialize();
                case 22:
                    return LihatSK.lambda5();
                case 23:
                    return LihatSK.lambda6();
                case 24:
                    return LihatSK.lambda7();
                case 25:
                    return LihatSK.lambda8();
                default:
