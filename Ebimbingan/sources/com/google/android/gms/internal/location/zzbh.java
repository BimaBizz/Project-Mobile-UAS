...
@C0463SafeParcelable.Class(creator = "ParcelableGeofenceCreator")
@C0463SafeParcelable.Reserved({1000})
@C0617VisibleForTesting
public final class zzbh extends C0460AbstractSafeParcelable implements Geofence {
    public static final Parcelable.Creator<zzbh> CREATOR;
    @C0463SafeParcelable.Field(getter = "getRequestId", id = 1)
    private final String zzad;
    @C0463SafeParcelable.Field(getter = "getTransitionTypes", id = 7)
    private final int zzae;
    @C0463SafeParcelable.Field(getter = "getType", id = 3)
    private final short zzag;
    @C0463SafeParcelable.Field(getter = "getLatitude", id = 4)
    private final double zzah;
    @C0463SafeParcelable.Field(getter = "getLongitude", id = 5)
    private final double zzai;
    @C0463SafeParcelable.Field(getter = "getRadius", id = 6)
    private final float zzaj;
    @C0463SafeParcelable.Field(defaultValue = "0", getter = "getNotificationResponsiveness", id = 8)
    private final int zzak;
    @C0463SafeParcelable.Field(defaultValue = "-1", getter = "getLoiteringDelay", id = 9)
    private final int zzal;
    @C0463SafeParcelable.Field(getter = "getExpirationTime", id = 2)
    ...
    public zzbh(@C0463SafeParcelable.Param(id = 1) String str, @C0463SafeParcelable.Param(id = 7) int i, @C0463SafeParcelable.Param(id = 3) short s, @C0463SafeParcelable.Param(id = 4) double d, @C0463SafeParcelable.Param(id = 5) double d2, @C0463SafeParcelable.Param(id = 6) float f, @C0463SafeParcelable.Param(id = 2) long j, @C0463SafeParcelable.Param(id = 8) int i2, @C0463SafeParcelable.Param(id = 9) int i3) {
        String str2;
        String str3;
        Throwable th;
        StringBuilder sb;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeString(parcel2, 1, getRequestId(), false);
        C0462SafeParcelWriter.writeLong(parcel2, 2, this.zzdo);
        C0462SafeParcelWriter.writeShort(parcel2, 3, this.zzag);
        C0462SafeParcelWriter.writeDouble(parcel2, 4, this.zzah);
        C0462SafeParcelWriter.writeDouble(parcel2, 5, this.zzai);
        C0462SafeParcelWriter.writeFloat(parcel2, 6, this.zzaj);
        C0462SafeParcelWriter.writeInt(parcel2, 7, this.zzae);
        C0462SafeParcelWriter.writeInt(parcel2, 8, this.zzak);
        C0462SafeParcelWriter.writeInt(parcel2, 9, this.zzal);
