...
/* renamed from: com.google.android.gms.internal.auth.zzjn */
/* compiled from: com.google.android.gms:play-services-auth-base@@17.1.2 */
class C1033zzjn<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<C1038zzjs> zzb;
    /* access modifiers changed from: private */
    public Map<K, V> zzc;
    private boolean zzd;
    private volatile C1040zzju zze;
    /* access modifiers changed from: private */
    public Map<K, V> zzf;
    private volatile C1034zzjo zzg;

    static <FieldDescriptorType extends C0972zzhg<FieldDescriptorType>> C1033zzjn<FieldDescriptorType, Object> zza(int i) {
        C1033zzjn<FieldDescriptorType, Object> zzjn;
        new C1032zzjm(i);
        return zzjn;
    }

    private C1033zzjn(int i) {
        this.zza = i;
    ...
    public final V put(K k, V v) {
        ...
        if (this.zzb.size() == this.zza) {
            C1038zzjs remove = this.zzb.remove(this.zza - 1);
            Object put = zzg().put((Comparable) remove.getKey(), remove.getValue());
        }
        new C1038zzjs(this, k2, v2);
        this.zzb.add(i3, obj);
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            new C1038zzjs(this, (Map.Entry) it.next());
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        C1040zzju zzju;
        if (this.zze == null) {
            new C1040zzju(this, (C1032zzjm) null);
            this.zze = zzju;
        }
        return this.zze;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        C1034zzjo zzjo;
        if (this.zzg == null) {
            new C1034zzjo(this, (C1032zzjm) null);
            this.zzg = zzjo;
        }
        return this.zzg;
    }
    ...
    public boolean equals(java.lang.Object r11) {
        ...
        L_0x0009:
            r6 = r1
            boolean r6 = r6 instanceof com.google.android.gms.internal.auth.C1033zzjn
        ...
        L_0x0016:
            r6 = r1
            com.google.android.gms.internal.auth.zzjn r6 = (com.google.android.gms.internal.auth.C1033zzjn) r6
            r2 = r6
            r6 = r0
            int r6 = r6.size()
            r9 = r6
        ...
        L_0x007b:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.auth.C1033zzjn.equals(java.lang.Object):boolean");
    }
    ...
    /* synthetic */ C1033zzjn(int i, C1032zzjm zzjm) {
        this(i);
