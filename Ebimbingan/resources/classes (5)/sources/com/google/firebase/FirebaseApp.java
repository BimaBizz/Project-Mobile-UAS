...
public class FirebaseApp {
        ...
        synchronized (obj) {
            try {
                ...
                if (defaultApp == null) {
                    Throwable th2 = th;
                    new StringBuilder();
                    new IllegalStateException(sb.append("Default FirebaseApp is not initialized in this process ").append(ProcessUtils.getMyProcessName()).append(". Make sure to call FirebaseApp.initializeApp(Context) first.").toString());
                    throw th2;
                }
                return firebaseApp;
            } finally {
    ...
    public static com.google.firebase.FirebaseApp initializeApp(@androidx.annotation.NonNull android.content.Context r14, @androidx.annotation.NonNull com.google.firebase.FirebaseOptions r15, @androidx.annotation.NonNull java.lang.String r16) {
        ...
        L_0x0028:
            ...
            com.google.android.gms.common.internal.Preconditions.checkState(r8, r9)     // Catch:{ all -> 0x0078 }
            r8 = r5
            java.lang.String r9 = "Application context cannot be null."
            java.lang.Object r8 = com.google.android.gms.common.internal.Preconditions.checkNotNull(r8, r9)     // Catch:{ all -> 0x0078 }
    ...
    public String getPersistenceKey() {
        StringBuilder sb;
        new StringBuilder();
        return sb.append(Base64Utils.encodeUrlSafeNoPadding(getName().getBytes(Charset.defaultCharset()))).append("+").append(Base64Utils.encodeUrlSafeNoPadding(getOptions().getApplicationId().getBytes(Charset.defaultCharset()))).toString();
    }
    ...
    public void addLifecycleEventListener(@NonNull FirebaseAppLifecycleListener firebaseAppLifecycleListener) {
        ...
        checkNotDeleted();
        Object checkNotNull = Preconditions.checkNotNull(listener);
    ...
    public static String getPersistenceKey(String name2, FirebaseOptions options2) {
        StringBuilder sb;
        new StringBuilder();
        return sb.append(Base64Utils.encodeUrlSafeNoPadding(name2.getBytes(Charset.defaultCharset()))).append("+").append(Base64Utils.encodeUrlSafeNoPadding(options2.getApplicationId().getBytes(Charset.defaultCharset()))).toString();
    }
    ...
    private static class GlobalBackgroundStateListener implements BackgroundDetector.BackgroundStateChangeListener {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v2, resolved type: com.google.android.gms.common.api.internal.BackgroundDetector$BackgroundStateChangeListener} */
        /* access modifiers changed from: private */
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static void ensureBackgroundStateListenerRegistered(android.content.Context r7) {
            /*
                r0 = r7
                boolean r3 = com.google.android.gms.common.util.PlatformVersion.isAtLeastIceCreamSandwich()
            ...
            L_0x0011:
                ...
                r1 = r3
                java.util.concurrent.atomic.AtomicReference<com.google.firebase.FirebaseApp$GlobalBackgroundStateListener> r3 = INSTANCE
                java.lang.Object r3 = r3.get()
                if (r3 != 0) goto L_0x0040
                com.google.firebase.FirebaseApp$GlobalBackgroundStateListener r3 = new com.google.firebase.FirebaseApp$GlobalBackgroundStateListener
                r6 = r3
                r3 = r6
                r4 = r6
                r4.<init>()
            ...
            L_0x0040:
                goto L_0x0010
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.FirebaseApp.GlobalBackgroundStateListener.ensureBackgroundStateListenerRegistered(android.content.Context):void");
        }
