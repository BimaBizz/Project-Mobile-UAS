...
public class MakeroidFBInterstitialAd extends AndroidNonvisibleComponent implements InterstitialAdListener, Component, OnDestroyListener {
    ...
    private KodularInterstitial f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidFBInterstitialAd(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            android.content.Context r5 = r5.context
            r4.<init>(r5)
            r2.f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.ads.KodularInterstitial r2 = r2.f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
    ...
    public void ShowAd() {
        ...
        } else if (!this.f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showAd()) {
            Error("The ad is already expired or invalidated. Please load a new ad.");
            return;
        } else {
    ...
    public void CommissionInterstitialAdsNetwork(String str) {
        this.f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.updateNetwork(str);
    }
    ...
    static /* synthetic */ void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(MakeroidFBInterstitialAd makeroidFBInterstitialAd) {
        ...
        if (random.nextFloat() <= makeroidFBInterstitialAd2.kodularAdsCommission.getCommision("facebook", "interstitial")) {
            ...
            makeroidFBInterstitialAd2.f162hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.loadAd(false);
        } else {
            makeroidFBInterstitialAd2.qPeHJnCLP0dAOwDPeFIn82vcSIsCMh6KFFn3o4kyIe0RhQKOQXDeyY2LFwPu2GbE = false;
            new InterstitialAd(makeroidFBInterstitialAd2.context, makeroidFBInterstitialAd2.ht6M5vNRogDvRYCDAZw5zQxzUwImwEpGaHRJyoKVPYuZoKA1X0CMwOko8kVy3tgl);
