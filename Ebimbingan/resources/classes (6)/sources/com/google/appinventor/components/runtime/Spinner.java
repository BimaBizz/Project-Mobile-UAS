...
public final class Spinner extends AndroidViewComponent implements AdapterView.OnItemSelectedListener {
    ...
    private final android.widget.Spinner f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    private YailList f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R;
    ...
    public Spinner(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4 = r7
            r4.<init>()
            r2.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R = r3
            r2 = r0
            r3 = -1
            ...
            r2 = r0
            android.widget.Spinner r2 = r2.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
    ...
    public final View getView() {
        return this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    }
    ...
    public final void ItemBackgroundColor(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPopupBackground().setColorFilter(i2, PorterDuff.Mode.SRC_ATOP);
        }
    }
    ...
    public final void SpinnerColor(int i) {
        ...
        this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getBackground().setColorFilter(i2, PorterDuff.Mode.SRC_ATOP);
    }
    ...
    public final void FontTypefaceImport(String str) {
        String str2 = str;
        this.pgq50Ta8BOwqZ1x44UiPoTcDoRPiNHTTIb3Jgmceok7eFp2gi0sO4JRUukOMKqHH = str2;
    }
    ...
    public final String Selection() {
        return SelectionIndex() == 0 ? "" : (String) this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getItemAtPosition(SelectionIndex() - 1);
    }
    ...
    public final void Selection(String str) {
        SelectionIndex(ElementsUtil.setSelectedIndexFromValue(str, this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R));
    }
    ...
    public final int SelectionIndex() {
        return ElementsUtil.selectionIndex(this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getSelectedItemPosition() + 1, this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R);
    }
    ...
    public final void SelectionIndex(int i) {
        ...
        this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setSelection(ElementsUtil.selectionIndex(i, this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R) - 1);
    }
    ...
    public final YailList Elements() {
        return this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R;
    }
    ...
    public final void Elements(YailList yailList) {
        ...
        if (yailList2.size() == 0) {
            SelectionIndex(0);
        } else if (yailList2.size() < this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R.size() && SelectionIndex() == this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R.size()) {
            SelectionIndex(yailList2.size());
        }
        this.f211vwEpIRqEf6xdtwTR9dehwBO7JUhyLV6iEzEK2WqfPN10eUMQDPn3AUmqAFfsnr6R = ElementsUtil.elements(yailList2, "Spinner");
    ...
    public final String Prompt() {
        return this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPrompt().toString();
    }
    ...
    public final void Prompt(String str) {
        this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setPrompt(str);
    }
    ...
    public final void DisplayDropdown() {
        boolean performClick = this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.performClick();
    }
    ...
    public final void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        if ((this.HThm2UFiN8mNIb2OEGwVoJpkwNLFwrt8FHi6kSBOC6T1EOtocK0hkK9xDo2LJOJZ == 0 && this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCount() > 0 && this.aWkZqinykMPj8SPm5jVT2wNdrJPpyMEjt10g4Ng570XD4n7VSaFhL3td3g0Xab2G == 0) || (this.HThm2UFiN8mNIb2OEGwVoJpkwNLFwrt8FHi6kSBOC6T1EOtocK0hkK9xDo2LJOJZ > this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCount() && this.aWkZqinykMPj8SPm5jVT2wNdrJPpyMEjt10g4Ng570XD4n7VSaFhL3td3g0Xab2G > this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCount())) {
            SelectionIndex(i2 + 1);
            this.HThm2UFiN8mNIb2OEGwVoJpkwNLFwrt8FHi6kSBOC6T1EOtocK0hkK9xDo2LJOJZ = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getCount();
        } else if (!this.q8iygSjgpTZ52A5K8GXhnvUs2CX4iXd4uIVtwvououVquIzlzfVOfWIR3CjSHG4 || i2 > 0) {
            SelectionIndex(i2 + 1);
    ...
    public final void onNothingSelected(AdapterView<?> adapterView) {
        AdapterView<?> adapterView2 = adapterView;
        this.f210hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setSelection(0);
    }
}
