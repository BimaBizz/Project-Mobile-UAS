...
public final class ArrayUtils {
    ...
    public static <T> java.util.ArrayList<T> newArrayList() {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.ArrayUtils.newArrayList():java.util.ArrayList");
    }
    ...
    public static <T> boolean contains(@RecentlyNonNull T[] tArr, @RecentlyNonNull T t) {
        ...
        while (true) {
            if (i >= length) {
                break;
            } else if (!Objects.equal(tArr2[i], t2)) {
                i++;
            } else if (i >= 0) {
                return true;
            }
