    ...
    public static Thread startHTTPConnection(String str, String str2, JSONObject jSONObject, ResponseHandler responseHandler, int i, @Nullable String str3) {
        ...
        try {
            ...
            if (jsonBody != null) {
                ...
                byte[] sendBytes = strJsonBody.getBytes(Key.STRING_CHARSET_NAME);
            ...
            switch (httpResponse) {
                ...
                case 202:
                    ...
                    new Scanner(con.getInputStream(), Key.STRING_CHARSET_NAME);
                ...
                default:
                    ...
                    if (inputStream != null) {
                        new Scanner(inputStream, Key.STRING_CHARSET_NAME);
