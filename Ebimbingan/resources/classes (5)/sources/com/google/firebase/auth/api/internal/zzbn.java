...
@VisibleForTesting
final class zzbn extends zzen<Void, zza> {
    private final zzdb zznh;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public zzbn(AuthCredential authCredential, @Nullable String str) {
        super(2);
        zzdb zzdb;
    ...
    public final /* synthetic */ void zzj(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        zzel<ResultT> zzel;
        zzdp zzdp2 = zzdp;
