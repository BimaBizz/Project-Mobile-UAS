...
final class zzu<TResult> extends Task<TResult> {
    ...
    private static class zza extends C0252LifecycleCallback {
        ...
        private zza(C0253LifecycleFragment lifecycleFragment) {
    ...
    public final void setException(@NonNull Exception exc) {
        Exception exc2 = exc;
        Object checkNotNull = C0446Preconditions.checkNotNull(exc2, "Exception must not be null");
        Object obj = this.mLock;
        Object obj2 = obj;
        synchronized (obj) {
            try {
    ...
    private final void zzb() {
        C0446Preconditions.checkState(this.zzy, "Task is not yet complete");
    }

    @GuardedBy("mLock")
    private final void zzc() {
        C0446Preconditions.checkState(!this.zzy, "Task is already complete");
    }
