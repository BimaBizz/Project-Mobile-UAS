...
public class GameInstance {
    ...
    private Map<String, String> F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho;
    ...
    public GameInstance(String str) {
        ...
        new HashMap();
        this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho = map;
    ...
    public String getMessageTime(String str) {
        String str2 = str;
        if (this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho.containsKey(str2)) {
            return this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho.get(str2);
        }
        return "";
    }

    public void putMessageTime(String str, String str2) {
        String put = this.F0SK4gPRNmAI2jCyU6DpJpRxlfo5Y8j9ZujjeLuDeDzReJBeSNN2RZtCnkXv1dho.put(str, str2);
    }
}
