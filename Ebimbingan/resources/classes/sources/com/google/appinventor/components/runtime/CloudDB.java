...
public final class CloudDB extends AndroidNonvisibleComponent implements Component, OnClearListener, OnDestroyListener {
    ...
    static class a {
        String BG2b8dRaEUNcWY5vxXAWfSqyg8ZvS4tysLlCvHPUDp1bRFO56FHQ3a9NvDEKgkS;
            ...
            if (!this.listenerRunning) {
                ...
                new Thread(this) {
                    ...
                    public final void run() {
                        ...
                        boolean access$202 = CloudDB.access$202(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, CloudDB.DEBUG);
    ...
    public final void StoreValue(String str, Object obj) {
        ...
        boolean z = (activeNetworkInfo == null || !activeNetworkInfo.isConnected()) ? DEBUG : true;
        if (obj3 != null) {
            try {
                                ...
                                while (true) {
                                    try {
                                        ...
                                        synchronized (access$600) {
                                            ...
                                            String str3 = aVar.BG2b8dRaEUNcWY5vxXAWfSqyg8ZvS4tysLlCvHPUDp1bRFO56FHQ3a9NvDEKgkS;
    ...
    public final void GetValue(String str, Object obj) {
        ...
        NetworkInfo activeNetworkInfo = this.cm.getActiveNetworkInfo();
        if ((activeNetworkInfo == null || !activeNetworkInfo.isConnected()) ? DEBUG : true) {
    ...
    public final Jedis getJedis(boolean z) {
        ...
        try {
            if (this.useSSL) {
                ...
                new Jedis(this.redisServer, this.redisPort, DEBUG);
                jedis2 = jedis;
            }
