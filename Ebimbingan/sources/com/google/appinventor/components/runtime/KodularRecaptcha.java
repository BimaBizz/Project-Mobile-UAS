    ...
    public void Prompt() {
        ...
        new OnFailureListener(this) {
            ...
            public final void onFailure(@NonNull Exception exc) {
                Exception exc2 = exc;
                if (exc2 instanceof C0212ApiException) {
                    int statusCode = ((C0212ApiException) exc2).getStatusCode();
        ...
        Task addOnFailureListener = SafetyNet.getClient(this.form).verifyWithRecaptcha(this.xaven5ecM0Ll2H1GHPRV82tONpToW8URGRDgxbH0b2M0q5wAsNNBDrpsKvL0qvHt).addOnSuccessListener(onSuccessListener).addOnFailureListener(onFailureListener);
    }
