...
public final class Component<T> {
    ...
    public static class Builder<T> {
        ...
        private Builder(Class<T> cls, Class<? super T>... clsArr) {
            ...
            T checkNotNull = C0446Preconditions.checkNotNull(anInterface, "Null interface");
            boolean add = this.providedInterfaces.add(anInterface);
            Class<? super T>[] clsArr2 = additionalInterfaces;
            int length = clsArr2.length;
            for (int i = 0; i < length; i++) {
                Object checkNotNull2 = C0446Preconditions.checkNotNull(clsArr2[i], "Null interface");
            }
        ...
        public Builder<T> add(Dependency dependency) {
            ...
            Object checkNotNull = C0446Preconditions.checkNotNull(dependency2, "Null dependency");
        ...
        private Builder<T> setInstantiation(int i) {
            ...
            C0446Preconditions.checkState(this.instantiation == 0, "Instantiation type has already been set.");
            this.instantiation = instantiation2;
            return this;
        }

        private void validateInterface(Class<?> anInterface) {
            C0446Preconditions.checkArgument(!this.providedInterfaces.contains(anInterface), "Components are not allowed to depend on interfaces they themselves provide.");
        }

        @C0206KeepForSdk
        public Builder<T> factory(ComponentFactory<T> value) {
            this.factory = (ComponentFactory) C0446Preconditions.checkNotNull(value, "Null factory");
            return this;
        }
        ...
        public com.google.firebase.components.Component<T> build() {
            ...
            L_0x0007:
                ...
                com.google.android.gms.common.internal.C0446Preconditions.checkState(r1, r2)
