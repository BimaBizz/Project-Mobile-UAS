...
import com.google.android.gms.common.api.internal.C0314zabq;
import com.google.android.gms.common.api.internal.C0315zabr;
import com.google.android.gms.common.api.internal.C0320zabw;
...
public class C0189GoogleApiAvailability extends C0190GoogleApiAvailabilityLight {
    @NonNull
    public static final String GOOGLE_PLAY_SERVICES_PACKAGE = "com.google.android.gms";
    public static final int GOOGLE_PLAY_SERVICES_VERSION_CODE = C0190GoogleApiAvailabilityLight.GOOGLE_PLAY_SERVICES_VERSION_CODE;
    private static final Object zaa;
    private static final C0189GoogleApiAvailability zab;
    @GuardedBy("mLock")
    private String zac;

    static {
        Object obj;
        C0189GoogleApiAvailability googleApiAvailability;
        new Object();
        zaa = obj;
        new C0189GoogleApiAvailability();
        zab = googleApiAvailability;
    }

    public C0189GoogleApiAvailability() {
    }

    @NonNull
    public static C0189GoogleApiAvailability getInstance() {
        return zab;
    }

    @NonNull
    public static final Task<Map<C0241ApiKey<?>, String>> zai(@RecentlyNonNull C0223HasApiKey<?> hasApiKey, @RecentlyNonNull C0223HasApiKey<?>... hasApiKeyArr) {
        List list;
        C0223HasApiKey<?> hasApiKey2 = hasApiKey;
        C0223HasApiKey<?>[] hasApiKeyArr2 = hasApiKeyArr;
        Object checkNotNull = C0446Preconditions.checkNotNull(hasApiKey2, "Requested API must not be null.");
        int length = hasApiKeyArr2.length;
        for (int i = 0; i < length; i++) {
            Object checkNotNull2 = C0446Preconditions.checkNotNull(hasApiKeyArr2[i], "Requested API must not be null.");
        }
        ...
        return C0248GoogleApiManager.zab().zah(list);
    }

    @NonNull
    public Task<Void> checkApiAvailability(@RecentlyNonNull C0220GoogleApi<?> googleApi, @RecentlyNonNull C0220GoogleApi<?>... googleApiArr) {
        return zai(googleApi, googleApiArr).onSuccessTask(C0630zab.zaa);
    }
    ...
    public Task<Void> makeGooglePlayServicesAvailable(@RecentlyNonNull Activity activity) {
        ...
        C0446Preconditions.checkMainThread("makeGooglePlayServicesAvailable must be called from the main thread");
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(activity2, i);
        if (isGooglePlayServicesAvailable == 0) {
            zab2 = Tasks.forResult(null);
        } else {
            C0320zabw zaa2 = C0320zabw.zaa(activity2);
            new C0184ConnectionResult(isGooglePlayServicesAvailable, (PendingIntent) null);
    ...
    public void setDefaultNotificationChannelId(@RecentlyNonNull Context context, @RecentlyNonNull String str) {
        ...
        if (C0609PlatformVersion.isAtLeastO()) {
            Object checkNotNull = C0446Preconditions.checkNotNull(((NotificationManager) C0446Preconditions.checkNotNull(context2.getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME))).getNotificationChannel(str2));
        }
        Object obj = zaa;
        synchronized (obj) {
            try {
    ...
    public final boolean zaa(@RecentlyNonNull Activity activity, @RecentlyNonNull C0253LifecycleFragment lifecycleFragment, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Activity activity2 = activity;
        int i3 = i;
        int i4 = i2;
        DialogInterface.OnCancelListener onCancelListener2 = onCancelListener;
        Dialog zaf = zaf(activity2, i3, C0491zag.zad(lifecycleFragment, getErrorResolutionIntent(activity2, i3, "d"), 2), onCancelListener2);
        if (zaf == null) {
            return false;
        }
        zag(activity2, zaf, "GooglePlayServicesErrorDialog", onCancelListener2);
        return true;
    }
    ...
    public final void zab(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        ...
        if (i3 == 18) {
            ...
            String zab2 = C0487zac.zab(context2, i3);
            String zad = C0487zac.zad(context2, i3);
            Resources resources = context2.getResources();
            NotificationManager notificationManager = (NotificationManager) C0446Preconditions.checkNotNull(context2.getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME));
            ...
            if (C0598DeviceProperties.isWearable(context2)) {
                C0446Preconditions.checkState(C0609PlatformVersion.isAtLeastKitKatWatch());
            ...
            if (C0609PlatformVersion.isAtLeastO()) {
                C0446Preconditions.checkState(C0609PlatformVersion.isAtLeastO());
                Object obj = zaa;
                synchronized (obj) {
                    try {
                        str2 = this.zac;
                ...
                if (str2 == null) {
                    ...
                    String zag = C0487zac.zag(context2);
            ...
            switch (i3) {
                ...
                case 2:
                case 3:
                    C0197GooglePlayServicesUtilLight.sCanceledAvailabilityNotification.set(false);
                    i2 = 10436;
                    break;
                default:
                    i2 = 39789;
    ...
    public final boolean zac(@RecentlyNonNull Context context, @RecentlyNonNull C0184ConnectionResult connectionResult, int i) {
        Context context2 = context;
        ...
        zab(context2, connectionResult2.getErrorCode(), (String) null, PendingIntent.getActivity(context2, 0, C0221GoogleApiActivity.zaa(context2, errorResolutionPendingIntent, i2, true), Declaration.PACKAGE_ACCESS));
        return true;
    }
    ...
    public final Dialog zad(@RecentlyNonNull Activity activity, @RecentlyNonNull DialogInterface.OnCancelListener onCancelListener) {
        ...
        AlertDialog.Builder message = builder.setMessage(C0487zac.zac(activity2, 18));
    ...
    @Nullable
    public final C0315zabr zae(Context context, C0314zabq zabq) {
        IntentFilter intentFilter;
        C0315zabr zabr;
        Context context2 = context;
        C0314zabq zabq2 = zabq;
    ...
    public final void zag(Activity activity, Dialog dialog, String str, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        try {
            if (activity2 instanceof FragmentActivity) {
                C0204SupportErrorDialogFragment.newInstance(dialog2, onCancelListener2).show(((FragmentActivity) activity2).getSupportFragmentManager(), str2);
                return;
            }
        } catch (NoClassDefFoundError e) {
        }
        C0185ErrorDialogFragment.newInstance(dialog2, onCancelListener2).show(activity2.getFragmentManager(), str2);
    }

    /* access modifiers changed from: package-private */
    public final void zah(Context context) {
        Handler handler;
        new C0631zac(this, context);
    ...
    public Dialog getErrorDialog(@RecentlyNonNull Activity activity, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Activity activity2 = activity;
        int i3 = i;
        return zaf(activity2, i3, C0491zag.zab(activity2, getErrorResolutionIntent(activity2, i3, "d"), i2), onCancelListener);
    }

    @RecentlyNullable
    public PendingIntent getErrorResolutionPendingIntent(@RecentlyNonNull Context context, @RecentlyNonNull C0184ConnectionResult connectionResult) {
        Context context2 = context;
        C0184ConnectionResult connectionResult2 = connectionResult;
    ...
    public boolean showErrorDialogFragment(@RecentlyNonNull Activity activity, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        zag(activity2, errorDialog, "GooglePlayServicesErrorDialog", onCancelListener2);
        return true;
    }

    @NonNull
    public Task<Void> checkApiAvailability(@RecentlyNonNull C0223HasApiKey<?> hasApiKey, @RecentlyNonNull C0223HasApiKey<?>... hasApiKeyArr) {
        return zai(hasApiKey, hasApiKeyArr).onSuccessTask(C0629zaa.zaa);
    }

    public void showErrorNotification(@RecentlyNonNull Context context, @RecentlyNonNull C0184ConnectionResult connectionResult) {
        Context context2 = context;
        C0184ConnectionResult connectionResult2 = connectionResult;
    ...
    public Dialog getErrorDialog(@RecentlyNonNull Fragment fragment, int i, int i2, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        int i3 = i;
        return zaf(fragment2.requireContext(), i3, C0491zag.zac(fragment2, getErrorResolutionIntent(fragment2.requireContext(), i3, "d"), i2), onCancelListener);
    }

    /* access modifiers changed from: package-private */
    @Nullable
    public final Dialog zaf(@NonNull Context context, int i, C0491zag zag, @Nullable DialogInterface.OnCancelListener onCancelListener) {
