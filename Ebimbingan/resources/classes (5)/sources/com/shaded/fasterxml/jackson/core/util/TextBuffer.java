...
public final class TextBuffer {
    ...
    private char[] findBuffer(int i) {
        ...
        return new char[Math.max(i2, MIN_SEGMENT_LEN)];
    }
    ...
    public char[] expandCurrentSegment() {
        ...
        this._currentSegment = _charArray(length == MAX_SEGMENT_LEN ? 262145 : Math.min(MAX_SEGMENT_LEN, length + (length >> 1)));
    ...
    private void expand(int i) {
        ...
        char[] _charArray = _charArray(Math.min(MAX_SEGMENT_LEN, length + i3));
        this._currentSize = 0;
        this._currentSegment = _charArray;
    }
