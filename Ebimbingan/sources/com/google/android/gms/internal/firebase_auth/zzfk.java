...
@C0463SafeParcelable.Class(creator = "StringListCreator")
public final class zzfk extends C0460AbstractSafeParcelable {
    public static final Parcelable.Creator<zzfk> CREATOR;
    @C0463SafeParcelable.VersionField(id = 1)
    private final int versionCode;
    @C0463SafeParcelable.Field(getter = "getValues", id = 2)
    ...
    zzfk(@C0463SafeParcelable.Param(id = 1) int i, @C0463SafeParcelable.Param(id = 2) List<String> list) {
        ...
        for (int i2 = 0; i2 < list2.size(); i2++) {
            String str = list2.set(i2, C0615Strings.emptyToNull(list2.get(i2)));
        }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeStringList(parcel2, 2, this.zzsm, false);
