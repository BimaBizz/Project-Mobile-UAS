...
public abstract class Transition implements Cloneable {
    ...
    private static boolean isValidMatch(int i) {
        int match = i;
        return (match < 1 || match > 4) ? DBG : true;
    }
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        for (int i = 0; i < startValuesListCount; i++) {
            ...
            if (start != null || end != null) {
                if ((start == null || end == null || isTransitionRequired(start, end)) ? true : DBG) {
            ...
            if (listview.getAdapter().hasStableIds()) {
                ...
                if (transitionValuesMaps2.mItemIdValues.indexOfKey(itemId) >= 0) {
                    ...
                    if (alreadyMatched != null) {
                        ViewCompat.setHasTransientState(alreadyMatched, DBG);
    ...
    public void playTransition(ViewGroup viewGroup) {
        ...
        for (int i = numOldAnims - 1; i >= 0; i--) {
            ...
            if (!(anim == null || (oldInfo = runningAnimators.get(anim)) == null || oldInfo.mView == null || !windowId.equals(oldInfo.mWindowId))) {
                ...
                if ((!(startValues == null && endValues == null) && oldInfo.mTransition.isTransitionRequired(oldValues, endValues)) ? true : DBG) {
    ...
    private static boolean isValueChanged(TransitionValues oldValues, TransitionValues newValues, String str) {
        ...
        if (oldValue == null && newValue == null) {
            ...
            changed = !oldValue.equals(newValue) ? true : DBG;
        }
        return changed;
    }
