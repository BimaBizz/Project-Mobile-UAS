        ...
        new ThreadUtil.MainThreadCallback<T>(this) {
            ...
            public void updateItemCount(int generation, int i) {
                ...
                if (isRequestedGeneration(generation)) {
                    ...
                    recycleAllTiles();
                    this.this$0.mAllowScrollHints = AsyncListUtil.DEBUG;
            ...
            private boolean isRequestedGeneration(int generation) {
                return generation == this.this$0.mRequestedGeneration ? true : AsyncListUtil.DEBUG;
            }
        };
            ...
            public void updateRange(int i, int i2, int i3, int i4, int i5) {
                ...
                if (rangeStart <= rangeEnd) {
                    ...
                    if (scrollHint == 1) {
                        ...
                        requestTiles(lastVisibleTileStart + this.this$0.mTileSize, this.mLastRequiredTileStart, scrollHint, AsyncListUtil.DEBUG);
                        return;
                    }
