...
final class zzkl {
    ...
    /* access modifiers changed from: private */
    public static void zzb(byte b, byte b2, char[] cArr, int i) throws zzhs {
        byte b3 = b;
        byte b4 = b2;
        char[] cArr2 = cArr;
        int i2 = i;
    ...
    /* access modifiers changed from: private */
    public static void zzb(byte b, byte b2, byte b3, char[] cArr, int i) throws zzhs {
        byte b4 = b;
        byte b5 = b2;
        byte b6 = b3;
        char[] cArr2 = cArr;
    ...
    /* access modifiers changed from: private */
    public static void zzb(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzhs {
        byte b5 = b;
        byte b6 = b2;
        byte b7 = b3;
        byte b8 = b4;
