...
public class C0204SupportErrorDialogFragment extends DialogFragment {
    private Dialog zaa;
    private DialogInterface.OnCancelListener zab;
    @Nullable
    private Dialog zac;

    public C0204SupportErrorDialogFragment() {
    }

    @NonNull
    public static C0204SupportErrorDialogFragment newInstance(@RecentlyNonNull Dialog dialog) {
    ...
    @NonNull
    public static C0204SupportErrorDialogFragment newInstance(@RecentlyNonNull Dialog dialog, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        C0204SupportErrorDialogFragment supportErrorDialogFragment;
        DialogInterface.OnCancelListener onCancelListener2 = onCancelListener;
        new C0204SupportErrorDialogFragment();
