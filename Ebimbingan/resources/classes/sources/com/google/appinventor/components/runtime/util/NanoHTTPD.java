...
public class NanoHTTPD {
    ...
    public static int S8H3eYzvg6VJJXGfS9KsaceOQzr9BosWjP9J0PNzfqDjshHgeOMsb1PZpwnxucV5 = 16384;
    /* access modifiers changed from: private */
    public static SimpleDateFormat hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private static Hashtable f252hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    protected static PrintStream myErr = System.err;
    protected static PrintStream myOut = System.out;
    private int QGAZOXcdjHKQSTylJ1PoRPU6GviAfBkJokC9i5wWel7BvaAua8hNDN1OOldV05g5;
    private File hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private Thread f253hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private final ServerSocket f254hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

    /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
    private ThreadPoolExecutor f255hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public NanoHTTPD(int i, File file) throws IOException {
        ...
        this.f255hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = threadPoolExecutor;
        this.QGAZOXcdjHKQSTylJ1PoRPU6GviAfBkJokC9i5wWel7BvaAua8hNDN1OOldV05g5 = i;
        this.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO = file;
        new ServerSocket(this.QGAZOXcdjHKQSTylJ1PoRPU6GviAfBkJokC9i5wWel7BvaAua8hNDN1OOldV05g5);
        this.f254hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = serverSocket;
        new Runnable(this) {
            private /* synthetic */ NanoHTTPD hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        new Thread(runnable);
        this.f253hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = thread;
        this.f253hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setDaemon(true);
        this.f253hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.start();
    }

    public void stop() {
        try {
            this.f254hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.close();
            this.f253hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.join();
    ...
    class a implements Runnable {
        ...
        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
        private Socket f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        public a(NanoHTTPD nanoHTTPD, Socket socket) {
            ...
            this.f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = socket;
        ...
        public final void run() {
            ...
            try {
                InputStream inputStream3 = this.f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getInputStream();
                ...
                if (inputStream3 != null) {
                    ...
                    if (read > 0) {
                        ...
                        Response serve = this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.serve(property2, property, properties7, properties6, properties8, this.f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
        ...
        private void wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou(String str, String str2) throws InterruptedException {
            ...
            hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(str, NanoHTTPD.MIME_PLAINTEXT, (Properties) null, inputStream);
            Throwable th2 = th;
        ...
        private void hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(String str, String str2, Properties properties, InputStream inputStream) {
            ...
            if (str3 == null) {
                try {
                    ...
                    this.f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.close();
                } catch (Throwable th3) {
                }
            } else {
                OutputStream outputStream = this.f256hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getOutputStream();
                ...
                if (inputStream2 != null) {
                    ...
                    byte[] bArr = new byte[NanoHTTPD.S8H3eYzvg6VJJXGfS9KsaceOQzr9BosWjP9J0PNzfqDjshHgeOMsb1PZpwnxucV5];
                    while (available > 0) {
                        int read = inputStream2.read(bArr, 0, available > NanoHTTPD.S8H3eYzvg6VJJXGfS9KsaceOQzr9BosWjP9J0PNzfqDjshHgeOMsb1PZpwnxucV5 ? NanoHTTPD.S8H3eYzvg6VJJXGfS9KsaceOQzr9BosWjP9J0PNzfqDjshHgeOMsb1PZpwnxucV5 : available);
                        int i = read;
                        if (read <= 0) {
                            break;
                        }
    ...
    public Response serveFile(String str, Properties properties, File file, boolean z) {
        ...
        if (!file8.isDirectory()) {
            new Response(this, HTTP_INTERNALERROR, MIME_PLAINTEXT, "INTERNAL ERRROR: serveFile(): given homeDir is not a directory.");
        ...
        if (response12 == null) {
            ...
            if (str3.startsWith("..") || str3.endsWith("..") || str3.indexOf("../") >= 0) {
                new Response(this, HTTP_FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: Won't serve ../ for security reasons.");
        ...
        if (response12 == null && !file9.exists()) {
            new Response(this, HTTP_NOTFOUND, MIME_PLAINTEXT, "Error 404, file not found.");
            ...
            if (response12 == null) {
                ...
                if (file3.exists()) {
                    ...
                    if (file4.exists()) {
                        ...
                        new Response(this, HTTP_FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: No directory listing.");
        ...
        if (response12 == null) {
            ...
            try {
                ...
                int i4 = lastIndexOf2;
                if (lastIndexOf2 >= 0) {
                    str5 = (String) f252hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.get(file9.getCanonicalPath().substring(i4 + 1).toLowerCase());
                }
                if (str5 == null) {
                ...
                if (str6 == null || j < 0) {
                    ...
                    new Response(this, HTTP_RANGE_NOT_SATISFIABLE, MIME_PLAINTEXT, "");
                ...
                new Response(this, HTTP_FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: Reading file failed.");
                response12 = response;
            }
        }
    ...
    static {
        ...
        new Hashtable();
        f252hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = hashtable;
        new StringTokenizer("css            text/css htm            text/html html           text/html xml            text/xml txt            text/plain asc            text/plain gif            image/gif jpg            image/jpeg jpeg           image/jpeg png            image/png mp3            audio/mpeg m3u            audio/mpeg-url mp4            video/mp4 ogv            video/ogg flv            video/x-flv mov            video/quicktime swf            application/x-shockwave-flash js                     application/javascript pdf            application/pdf doc            application/msword ogg            application/x-ogg zip            application/octet-stream exe            application/octet-stream class          application/octet-stream ");
        StringTokenizer stringTokenizer2 = stringTokenizer;
        while (stringTokenizer2.hasMoreTokens()) {
            Object put = f252hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.put(stringTokenizer2.nextToken(), stringTokenizer2.nextToken());
        }
