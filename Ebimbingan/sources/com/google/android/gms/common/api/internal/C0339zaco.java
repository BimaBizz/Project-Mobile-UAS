...
/* renamed from: com.google.android.gms.common.api.internal.zaco */
/* compiled from: com.google.android.gms:play-services-base@@17.6.0 */
public final class C0339zaco extends C1138zac implements C0222GoogleApiClient.ConnectionCallbacks, C0222GoogleApiClient.OnConnectionFailedListener {
    private static final C0211Api.AbstractClientBuilder<? extends C1152zae, C1134SignInOptions> zaa = C1151zad.zac;
    private final Context zab;
    private final Handler zac;
    private final C0211Api.AbstractClientBuilder<? extends C1152zae, C1134SignInOptions> zad;
    private final Set<C0235Scope> zae;
    private final C0427ClientSettings zaf;
    private C1152zae zag;
    /* access modifiers changed from: private */
    public C0338zacn zah;

    @WorkerThread
    public C0339zaco(Context context, Handler handler, @NonNull C0427ClientSettings clientSettings) {
        C0427ClientSettings clientSettings2 = clientSettings;
        C0211Api.AbstractClientBuilder<? extends C1152zae, C1134SignInOptions> abstractClientBuilder = zaa;
        this.zab = context;
        this.zac = handler;
        this.zaf = (C0427ClientSettings) C0446Preconditions.checkNotNull(clientSettings2, "ClientSettings must not be null");
        this.zae = clientSettings2.getRequiredScopes();
        this.zad = abstractClientBuilder;
    }

    static /* synthetic */ void zaf(C0339zaco zaco, C1146zak zak) {
        StringBuilder sb;
        Throwable th;
        C0339zaco zaco2 = zaco;
        C1146zak zak2 = zak;
        C0184ConnectionResult zaa2 = zak2.zaa();
        if (zaa2.isSuccess()) {
            C0506zav zav = (C0506zav) C0446Preconditions.checkNotNull(zak2.zab());
    ...
    public final void zac(com.google.android.gms.common.api.internal.C0338zacn r15) {
        /*
            r14 = this;
            r0 = r14
            r1 = r15
        ...
        L_0x0069:
            ...
            goto L_0x0068
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.api.internal.C0339zaco.zac(com.google.android.gms.common.api.internal.zacn):void");
    }

    public final void zad() {
        C1152zae zae2 = this.zag;
        if (zae2 != null) {
            zae2.disconnect();
        }
    }
