...
final class zzkx extends zzku {
        ...
        while (i8 < i7) {
            ...
            if (b < 0) {
                if (b2 < -32) {
                    ...
                    byte b5 = bArr3[i14];
                    byte b6 = b5;
                    if (b5 <= -65 && (((b2 << 28) + (b6 + Ev3Constants.Opcode.JR_NEQ8)) >> 30) == 0) {
                        int i16 = i15;
                        int i17 = i15 + 1;
                        if (bArr3[i16] <= -65) {
                            int i18 = i17;
    ...
    public final java.lang.String zzg(byte[] r20, int r21, int r22) throws com.google.android.gms.internal.firebase_auth.zzic {
        ...
        L_0x0140:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_auth.zzkx.zzg(byte[], int, int):java.lang.String");
    }
