...
import com.google.android.gms.common.util.C0618WorkSourceUtil;
...
public class WakeLock {
    ...
    private WakeLock(@NonNull Context context, int i, @NonNull String str, @Nullable String str2, @NonNull String str3, @Nullable String str4) {
        ...
        Object checkNotNull = C0446Preconditions.checkNotNull(context2, "WakeLock: context must not be null");
        String checkNotEmpty = C0446Preconditions.checkNotEmpty(str8, "WakeLock: wakeLockName must not be empty");
        this.zzd = i2;
        this.zzf = null;
        this.zzg = null;
        ...
        if (C0618WorkSourceUtil.hasWorkSourcePermission(context2)) {
            if (C0615Strings.isEmptyOrWhitespace(str10)) {
                str5 = context2.getPackageName();
            } else {
                str5 = str10;
            }
            this.zzc = C0618WorkSourceUtil.fromPackage(context2, str5);
            WorkSource workSource = this.zzc;
            if (workSource != null && C0618WorkSourceUtil.hasWorkSourcePermission(this.zzh)) {
                if (this.zzc != null) {
        ...
        if (zzn == null) {
            zzn = C0548PooledExecutorsProvider.getInstance().newSingleThreadScheduledExecutor();
        }
    }

    private final List<String> zza() {
        List<String> names = C0618WorkSourceUtil.getNames(this.zzc);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x00fc, code lost:
        com.google.android.gms.common.stats.C0585WakeLockTracker.getInstance().registerEvent(r12.zzh, com.google.android.gms.common.stats.C0583StatsUtils.getEventKey(r12.zzb, r16), 7, r12.zze, r16, (java.lang.String) null, r12.zzd, zza(), r14);
        r22 = r12;
        r22.zzl++;
     */
    ...
    public void acquire(long r36) {
        ...
        L_0x00e8:
            ...
            if (r22 != 0) goto L_0x014f
        L_0x00fc:
            com.google.android.gms.common.stats.WakeLockTracker r22 = com.google.android.gms.common.stats.C0585WakeLockTracker.getInstance()     // Catch:{ all -> 0x019d }
            r23 = r12
            r0 = r23
            ...
            r24 = r0
            r25 = r16
            java.lang.String r24 = com.google.android.gms.common.stats.C0583StatsUtils.getEventKey((android.os.PowerManager.WakeLock) r24, (java.lang.String) r25)     // Catch:{ all -> 0x019d }
            r25 = 7
            r26 = r12
            r0 = r26
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0078, code lost:
        com.google.android.gms.common.stats.C0585WakeLockTracker.getInstance().registerEvent(r4.zzh, com.google.android.gms.common.stats.C0583StatsUtils.getEventKey(r4.zzb, r6), 8, r4.zze, r6, (java.lang.String) null, r4.zzd, zza());
        r12 = r4;
        r21 = r12;
        r21.zzl--;
     */
    ...
    public void release() {
        ...
        L_0x0078:
            com.google.android.gms.common.stats.WakeLockTracker r12 = com.google.android.gms.common.stats.C0585WakeLockTracker.getInstance()     // Catch:{ all -> 0x00e6 }
            r13 = r4
            android.content.Context r13 = r13.zzh     // Catch:{ all -> 0x00e6 }
            r14 = r4
            android.os.PowerManager$WakeLock r14 = r14.zzb     // Catch:{ all -> 0x00e6 }
            r15 = r6
            java.lang.String r14 = com.google.android.gms.common.stats.C0583StatsUtils.getEventKey((android.os.PowerManager.WakeLock) r14, (java.lang.String) r15)     // Catch:{ all -> 0x00e6 }
            r15 = 8
            r16 = r4
            r0 = r16
