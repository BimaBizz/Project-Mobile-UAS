...
public class ContactPicker extends Picker implements ActivityResultListener {
    ...
    private final Uri f42hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    protected ContactPicker(com.google.appinventor.components.runtime.ComponentContainer r6, android.net.Uri r7) {
        /*
            ...
            r3.f42hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r4
        L_0x002a:
            return
        L_0x002b:
            int r3 = android.os.Build.VERSION.SDK_INT
    ...
    public Intent getIntent() {
        Intent intent;
        new Intent("android.intent.action.PICK", this.f42hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
        return intent;
    }
