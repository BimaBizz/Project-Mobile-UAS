...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        int direction = (targetPosition < getPosition(getChildAt(0)) ? true : DEBUG) != this.mShouldReverseLayout ? -1 : 1;
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            int fill = fill(recycler2, this.mLayoutState, state2, DEBUG);
            ...
            int fill2 = fill(recycler2, this.mLayoutState, state2, DEBUG);
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                int fill3 = fill(recycler2, this.mLayoutState, state2, DEBUG);
                startOffset = this.mLayoutState.mOffset;
            }
        } else {
            updateLayoutStateToFillEnd(this.mAnchorInfo);
            this.mLayoutState.mExtra = extraForEnd2;
            int fill4 = fill(recycler2, this.mLayoutState, state2, DEBUG);
            endOffset = this.mLayoutState.mOffset;
            ...
            this.mLayoutState.mExtra = extraForStart2;
            this.mLayoutState.mCurrentPosition += this.mLayoutState.mItemDirection;
            int fill5 = fill(recycler2, this.mLayoutState, state2, DEBUG);
            startOffset = this.mLayoutState.mOffset;
            if (this.mLayoutState.mAvailable > 0) {
                int extraForEnd3 = this.mLayoutState.mAvailable;
                updateLayoutStateToFillEnd(lastElement, endOffset);
                this.mLayoutState.mExtra = extraForEnd3;
                int fill6 = fill(recycler2, this.mLayoutState, state2, DEBUG);
                endOffset = this.mLayoutState.mOffset;
            }
        }
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                ...
                int fixOffset2 = fixLayoutStartGap(startOffset2, recycler2, state2, DEBUG);
                ...
                int fixOffset4 = fixLayoutEndGap(endOffset3, recycler2, state2, DEBUG);
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler, RecyclerView.State state, int i, int i2) {
        ...
        if (state2.willRunPredictiveAnimations() && getChildCount() != 0 && !state2.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            for (int i3 = 0; i3 < scrapSize; i3++) {
                ...
                if (!scrap.isRemoved()) {
                    if (((scrap.getLayoutPosition() < firstChildPos ? true : DEBUG) != this.mShouldReverseLayout ? -1 : 1) == -1) {
    ...
    private boolean updateAnchorFromChildren(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (focused != null && anchorInfo2.isViewValidAsAnchor(focused, state2)) {
            ...
            if (!state2.isPreLayout() && supportsPredictiveItemAnimations()) {
                if ((this.mOrientationHelper.getDecoratedStart(referenceChild) >= this.mOrientationHelper.getEndAfterPadding() || this.mOrientationHelper.getDecoratedEnd(referenceChild) < this.mOrientationHelper.getStartAfterPadding()) ? true : DEBUG) {
    ...
    private boolean updateAnchorFromPendingData(RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (this.mPendingSavedState != null && this.mPendingSavedState.hasValidAnchor()) {
            ...
            if (child == null) {
                if (getChildCount() > 0) {
                    anchorInfo2.mLayoutFromEnd = (this.mPendingScrollPosition < getPosition(getChildAt(0)) ? true : DEBUG) == this.mShouldReverseLayout ? true : DEBUG;
                }
                anchorInfo2.assignCoordinateFromPadding();
                ...
                anchorInfo2.mLayoutFromEnd = DEBUG;
                return true;
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ScrollbarHelper.computeScrollOffset(state2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ScrollbarHelper.computeScrollExtent(state2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ScrollbarHelper.computeScrollRange(state2, this.mOrientationHelper, findFirstVisibleChildClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), findFirstVisibleChildClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    public int scrollBy(int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        int consumed = this.mLayoutState.mScrollingOffset + fill(recycler2, this.mLayoutState, state2, DEBUG);
        if (consumed < 0) {
            return 0;
        }
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (layoutState2.mScrapList == null) {
            if (this.mShouldReverseLayout == (layoutState2.mLayoutDirection == -1 ? true : DEBUG)) {
                addView(view);
            } else {
                addView(view, 0);
            }
    ...
    public int findFirstVisibleItemPosition() {
        View child = findOneVisibleChild(0, getChildCount(), DEBUG, true);
        return child == null ? -1 : getPosition(child);
    }

    public int findFirstCompletelyVisibleItemPosition() {
        View child = findOneVisibleChild(0, getChildCount(), true, DEBUG);
        return child == null ? -1 : getPosition(child);
    }
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        ensureLayoutState();
        ensureLayoutState();
        updateLayoutState(layoutDir, (int) (MAX_SCROLL_FACTOR * ((float) this.mOrientationHelper.getTotalSpace())), DEBUG, state2);
        this.mLayoutState.mScrollingOffset = Integer.MIN_VALUE;
        this.mLayoutState.mRecycle = DEBUG;
        ...
        if (getChildCount() >= 1) {
            ...
            if (this.mShouldReverseLayout) {
                ...
                while (i < getChildCount()) {
                    ...
                    if (pos < lastPos) {
                        ...
                        new StringBuilder();
                        RuntimeException runtimeException2 = new RuntimeException(sb3.append("detected invalid position. loc invalid? ").append(screenLoc < lastScreenLoc ? true : DEBUG).toString());
            ...
            while (i2 < getChildCount()) {
                ...
                if (pos2 < lastPos) {
                    ...
                    new StringBuilder();
                    RuntimeException runtimeException4 = new RuntimeException(sb2.append("detected invalid position. loc invalid? ").append(screenLoc2 < lastScreenLoc ? true : DEBUG).toString());
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.mAnchorLayoutFromEnd = in.readInt() == 1 ? true : LinearLayoutManager.DEBUG;
        }
    ...
    static class AnchorInfo {
        ...
        public boolean isViewValidAsAnchor(View child, RecyclerView.State state) {
            ...
            return (lp.isItemRemoved() || lp.getViewLayoutPosition() < 0 || lp.getViewLayoutPosition() >= state2.getItemCount()) ? LinearLayoutManager.DEBUG : true;
        }
