...
public class AdmobRewardedVideo extends AndroidNonvisibleComponent implements RewardedVideoAdListener, Component, OnDestroyListener, OnPauseListener, OnResumeListener {
    ...
    private MakeroidDataProtection f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public AdmobRewardedVideo(com.google.appinventor.components.runtime.ComponentContainer r9) {
        /*
            ...
            r4.<init>(r5, r6)
            r2.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            com.google.appinventor.components.runtime.util.MakeroidDataProtection r2 = r2.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r3 = r0
    ...
    public void ConsentTitle(String str) {
        this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTitle(str);
    }

    @SimpleProperty
    public String ConsentTitle() {
        return this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTitle();
    }
    ...
    public void ConsentMessage(String str) {
        this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setMessage(str);
    }

    @SimpleProperty
    public String ConsentMessage() {
        return this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getMessage();
    }

    @SimpleFunction(description = "Deletes the user's consent. Useful if you want to test the consent dialog in development.")
    public void RevokeConsent() {
        this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.RevokeConsent();
    }
    ...
    public boolean PersonalizedResult() {
        return this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getPersonalizedResult();
    }
    ...
    public void ConsentDevelopmentMode(boolean z) {
        this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setDevelopmentMode(z);
    }

    @SimpleProperty
    public boolean ConsentDevelopmentMode() {
        return this.f13hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getDevelopmentMode();
    }
}
