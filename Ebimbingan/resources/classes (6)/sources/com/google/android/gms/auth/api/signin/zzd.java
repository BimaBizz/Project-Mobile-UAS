...
public final class zzd implements Parcelable.Creator<SignInAccount> {
    ...
    public final /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel3.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 4:
                    ...
                    break;
                case 7:
                    googleSignInAccount = (GoogleSignInAccount) SafeParcelReader.createParcelable(parcel3, i, GoogleSignInAccount.CREATOR);
                    break;
                case 8:
        ...
        new SignInAccount(str, googleSignInAccount, str2);
        return obj;
    }
}
