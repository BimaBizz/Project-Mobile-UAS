...
@C0206KeepForSdk
/* renamed from: com.google.android.gms.dynamic.SupportFragmentWrapper */
/* compiled from: com.google.android.gms:play-services-basement@@17.6.0 */
public final class C0666SupportFragmentWrapper extends C0660IFragmentWrapper.Stub {
    private Fragment zza;

    private C0666SupportFragmentWrapper(Fragment fragment) {
        this.zza = fragment;
    }

    @C0206KeepForSdk
    @RecentlyNullable
    public static C0666SupportFragmentWrapper wrap(@Nullable Fragment fragment) {
        C0666SupportFragmentWrapper supportFragmentWrapper;
        Fragment fragment2 = fragment;
        if (fragment2 == null) {
            return null;
        }
        new C0666SupportFragmentWrapper(fragment2);
