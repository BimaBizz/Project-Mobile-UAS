...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    static final /* synthetic */ boolean $assertionsDisabled = (!WindowDecorActionBar.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        new ViewPropertyAnimatorListenerAdapter(this) {
            ...
            public void onAnimationEnd(View view) {
                ...
                this.this$0.mContainerView.setTransitioning(WindowDecorActionBar.$assertionsDisabled);
    ...
    private void init(View view) {
        ...
        boolean homeAsUp = (this.mDecorToolbar.getDisplayOptions() & 4) != 0 ? true : $assertionsDisabled;
        if (homeAsUp) {
            this.mDisplayHomeAsUpSet = true;
        }
        ActionBarPolicy abp = ActionBarPolicy.get(this.mContext);
        setHomeButtonEnabled((abp.enableHomeButtonByDefault() || homeAsUp) ? true : $assertionsDisabled);
        setHasEmbeddedTabs(abp.hasEmbeddedTabs());
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, R.styleable.ActionBar, R.attr.actionBarStyle, 0);
        if (a.getBoolean(R.styleable.ActionBar_hideOnContentScroll, $assertionsDisabled)) {
    ...
    private void setHasEmbeddedTabs(boolean hasEmbeddedTabs) {
        ...
        this.mDecorToolbar.setCollapsible((this.mHasEmbeddedTabs || !isInTabMode) ? $assertionsDisabled : true);
        this.mOverlayLayout.setHasNonEmbeddedTabs((this.mHasEmbeddedTabs || !isInTabMode) ? $assertionsDisabled : true);
    }
    ...
    public void setCustomView(int resId) {
        setCustomView(LayoutInflater.from(getThemedContext()).inflate(resId, this.mDecorToolbar.getViewGroup(), $assertionsDisabled));
    }
    ...
    public boolean isShowing() {
        ...
        return (!this.mNowShowing || (height != 0 && getHideOffset() >= height)) ? $assertionsDisabled : true;
    }
    ...
    public boolean isTitleTruncated() {
        return (this.mDecorToolbar == null || !this.mDecorToolbar.isTitleTruncated()) ? $assertionsDisabled : true;
    }
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            if (this.this$0.mActionMode == this) {
                if (!WindowDecorActionBar.checkShowingFlags(this.this$0.mHiddenByApp, this.this$0.mHiddenBySystem, WindowDecorActionBar.$assertionsDisabled)) {
                ...
                this.mCallback = null;
                this.this$0.animateToMode(WindowDecorActionBar.$assertionsDisabled);
    ...
    public void setNavigationMode(int i) {
        ...
        this.mDecorToolbar.setCollapsible((mode != 2 || this.mHasEmbeddedTabs) ? $assertionsDisabled : true);
        this.mOverlayLayout.setHasNonEmbeddedTabs((mode != 2 || this.mHasEmbeddedTabs) ? $assertionsDisabled : true);
    }
    ...
    public boolean onKeyShortcut(int i, KeyEvent keyEvent) {
        ...
        menu.setQwertyMode(KeyCharacterMap.load(event != null ? event.getDeviceId() : -1).getKeyboardType() != 1 ? true : $assertionsDisabled);
