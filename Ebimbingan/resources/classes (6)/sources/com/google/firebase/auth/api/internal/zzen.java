...
abstract class zzen<ResultT, CallbackT> implements zzan<zzdp, ResultT> {
    ...
    static class zza extends LifecycleCallback {
        ...
        public static void zza(Activity activity, List<PhoneAuthProvider.OnVerificationStateChangedCallbacks> list) {
            ...
            if (fragment.getCallbackOrNull("PhoneAuthActivityStopCallback", zza.class) == null) {
    ...
    public final zzen<ResultT, CallbackT> zza(PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Activity activity, Executor executor) {
        ...
        synchronized (list) {
            try {
                boolean add = this.zzpv.add((PhoneAuthProvider.OnVerificationStateChangedCallbacks) Preconditions.checkNotNull(onVerificationStateChangedCallbacks2));
                this.zzpw = activity2;
                if (this.zzpw != null) {
                    zza.zza(activity2, this.zzpv);
                }
                this.zzpx = (Executor) Preconditions.checkNotNull(executor2);
                return this;
            } catch (Throwable th) {
                while (true) {
                    Throwable th2 = th;
    ...
    public final void zzc(ResultT resultt) {
        ...
        this.zzqj = true;
        this.zzqk = resultt2;
        this.zzpu.zza(resultt2, (Status) null);
    }
