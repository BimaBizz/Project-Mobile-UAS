...
public final class DynamiteModule {
    ...
    static {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.dynamite.DynamiteModule.<clinit>():void");
    }
    ...
    public static int getLocalVersion(@RecentlyNonNull Context context, @RecentlyNonNull String str) {
        ...
        try {
            ...
            if (Objects.equal(declaredField.get((Object) null), str3)) {
    ...
    public static DynamiteModule load(@RecentlyNonNull Context context, @RecentlyNonNull VersionPolicy versionPolicy, @RecentlyNonNull String str) throws LoadingException {
        ...
        Throwable th9;
        StringBuilder sb5;
        Class<DynamiteModule> cls2;
        Throwable th10;
        zzp zzp;
        Throwable th11;
        Class<DynamiteModule> cls3;
        Throwable th12;
        boolean z;
        Boolean valueOf;
        IObjectWrapper zze3;
        DynamiteModule dynamiteModule3;
        Throwable th13;
        Throwable th14;
        Throwable th15;
        Context context2 = context;
        ...
        try {
            ...
            zzn zza2 = versionPolicy2.zza(context2, str4, zzg);
            int i = zza2.zza;
            int i2 = zza2.zzb;
            ...
            if (i4 == 0 || ((i4 == -1 && zza2.zza == 0) || (i4 == 1 && zza2.zzb == 0))) {
                ...
                new LoadingException(sb2.toString(), (zzb) null);
                throw th;
            } else if (i4 == -1) {
                DynamiteModule zzd2 = zzd(context2, str4);
                if (longValue == 0) {
                    zzf.remove();
                } else {
                ...
                try {
                    int i7 = zza2.zzb;
                    cls = DynamiteModule.class;
                    synchronized (cls) {
                        bool = zzb;
                    }
                    if (bool == null) {
                        new LoadingException("Failed to determine which loading route to use.", (zzb) null);
                        throw th15;
                    }
                    if (bool.booleanValue()) {
                        ...
                        cls2 = DynamiteModule.class;
                        synchronized (cls2) {
                            zzp = zzj;
                        }
                        if (zzp == null) {
                            new LoadingException("DynamiteLoaderV2 was not cached.", (zzb) null);
                            throw th14;
                        }
                        zzk zzk3 = zze.get();
                        if (zzk3 == null || zzk3.zza == null) {
                            new LoadingException("No result cursor", (zzb) null);
                            throw th11;
                        }
                        Context applicationContext = context2.getApplicationContext();
                        Cursor cursor2 = zzk3.zza;
                        IObjectWrapper wrap = ObjectWrapper.wrap(null);
                        cls3 = DynamiteModule.class;
                        synchronized (cls3) {
                            if (zzd >= 2) {
                                z = true;
                            } else {
                        ...
                        if (valueOf.booleanValue()) {
                            ...
                            zze3 = zzp.zzf(ObjectWrapper.wrap(applicationContext), str4, i7, ObjectWrapper.wrap(cursor2));
                        } else {
                            int w = Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                            zze3 = zzp.zze(ObjectWrapper.wrap(applicationContext), str4, i7, ObjectWrapper.wrap(cursor2));
                        }
                        Context context3 = (Context) ObjectWrapper.unwrap(zze3);
                        if (context3 == null) {
                            new LoadingException("Failed to get module context", (zzb) null);
                            throw th13;
                        }
                        new DynamiteModule(context3);
                        ...
                        zzo zzf2 = zzf(context2);
                        if (zzf2 == null) {
                            new LoadingException("Failed to create IDynamiteLoader.", (zzb) null);
                            throw th9;
                        }
                        int zzi2 = zzf2.zzi();
                        if (zzi2 >= 3) {
                            zzk zzk4 = zze.get();
                            if (zzk4 == null) {
                                new LoadingException("No cached result cursor holder", (zzb) null);
                                throw th8;
                            }
                            zze2 = zzf2.zzk(ObjectWrapper.wrap(context2), str4, i7, ObjectWrapper.wrap(zzk4.zza));
                        } else if (zzi2 == 2) {
                            int w2 = Log.w("DynamiteModule", "IDynamite loader version = 2");
                            zze2 = zzf2.zzg(ObjectWrapper.wrap(context2), str4, i7);
                        } else {
                            int w3 = Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                            zze2 = zzf2.zze(ObjectWrapper.wrap(context2), str4, i7);
                        }
                        if (ObjectWrapper.unwrap(zze2) == null) {
                            new LoadingException("Failed to load remote module.", (zzb) null);
                            throw th7;
                        }
                        new DynamiteModule((Context) ObjectWrapper.unwrap(zze2));
                    ...
                    new LoadingException("Failed to load remote module.", e, (zzb) null);
                    throw th5;
                    ...
                    if (i10 != 0) {
                        ...
                        if (versionPolicy2.zza(context2, str4, zzm).zzc == -1) {
                            DynamiteModule zzd3 = zzd(context2, str4);
                            if (longValue == 0) {
                                zzf.remove();
                            } else {
                                zzf.set(Long.valueOf(longValue));
                    ...
                    new LoadingException("Remote load failed. No local fallback found.", loadingException, (zzb) null);
                    throw th3;
                } catch (Throwable th16) {
                    Throwable th17 = th16;
                    boolean addDynamiteErrorToDropBox = CrashUtils.addDynamiteErrorToDropBox(context2, th17);
                    new LoadingException("Failed to load remote module.", th17, (zzb) null);
                    throw th4;
                }
            } else {
                ...
                new LoadingException(sb3.toString(), (zzb) null);
                throw th2;
            }
    ...
    public static int zza(@androidx.annotation.RecentlyNonNull android.content.Context r16, @androidx.annotation.RecentlyNonNull java.lang.String r17, boolean r18) {
        /*
            ...
            java.lang.Class<com.google.android.gms.dynamite.DynamiteModule$DynamiteLoaderClassLoader> r11 = com.google.android.gms.dynamite.DynamiteModule.DynamiteLoaderClassLoader.class
        ...
        L_0x0075:
            ...
            r10 = r4
            r11 = r1
            com.google.android.gms.dynamic.IObjectWrapper r11 = com.google.android.gms.dynamic.ObjectWrapper.wrap(r11)     // Catch:{ RemoteException -> 0x0234, all -> 0x026b }
            r12 = r2
            r13 = r3
            ...
            java.lang.Object r10 = com.google.android.gms.dynamic.ObjectWrapper.unwrap(r10)     // Catch:{ RemoteException -> 0x0234, all -> 0x026b }
        ...
        L_0x016a:
            ...
            r9 = r10
            r10 = r9
            java.lang.Object r10 = com.google.android.gms.common.internal.Preconditions.checkNotNull(r10)     // Catch:{ LoadingException -> 0x0283 }
            r10 = r4
            r11 = r9
        ...
        L_0x01b1:
            ...
            r10 = r1
            r11 = r2
            boolean r10 = com.google.android.gms.common.util.CrashUtils.addDynamiteErrorToDropBox(r10, r11)
            r10 = r2
            throw r10
        L_0x01bb:
            r10 = move-exception
    ...
    private static int zzb(android.content.Context r14, java.lang.String r15, boolean r16) throws com.google.android.gms.dynamite.DynamiteModule.LoadingException {
        ...
        L_0x0084:
            r8 = r1
            boolean r8 = r8 instanceof com.google.android.gms.dynamite.DynamiteModule.LoadingException     // Catch:{ all -> 0x008d }
            r3 = r8
            r8 = r3
        ...
        L_0x009a:
            ...
            java.lang.Class<com.google.android.gms.dynamite.DynamiteModule> r8 = com.google.android.gms.dynamite.DynamiteModule.class
            r1 = r8
            r8 = r1
    ...
    private static void zze(ClassLoader classLoader) throws LoadingException {
        ...
        try {
            ...
            new LoadingException("Failed to instantiate dynamite loader", e, (zzb) null);
            throw th;
        }
    }
    ...
    public IBinder instantiate(@RecentlyNonNull String str) throws LoadingException {
        ...
        try {
            ...
            loadingException = new LoadingException(str2, th, (zzb) null);
            throw r3;
        }
    }
}
