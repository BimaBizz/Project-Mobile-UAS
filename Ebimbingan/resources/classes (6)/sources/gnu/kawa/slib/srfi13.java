...
public class srfi13 extends ModuleBody {
    ...
    static {
        ...
        new ModuleMethod(srfi132, YaVersion.YOUNG_ANDROID_VERSION, Lit77, -4094);
    ...
    public static Object stringFill$Ex$V(Object s, Object obj, Object[] argsArray) {
        ...
        frame823.s = s;
        frame823.f293char = obj;
        LList makeList = LList.makeList(argsArray, 0);
        LList lList = makeList;
        frame823.maybe$Mnstart$Plend = makeList;
        try {
            Object apply4 = Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), characters.char$Qu, frame823.f293char, string$Mnfill$Ex);
