...
/* renamed from: com.google.android.gms.internal.auth.zzkx */
...
interface C1070zzkx {
    ...
    void zza(int i, C0947zzgi zzgi) throws IOException;

    <K, V> void zza(int i, C1006zzin<K, V> zzin, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, C1028zzji zzji) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, C1028zzji zzji) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, C1028zzji zzji) throws IOException;

    void zzb(int i, List<C0947zzgi> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, C1028zzji zzji) throws IOException;
