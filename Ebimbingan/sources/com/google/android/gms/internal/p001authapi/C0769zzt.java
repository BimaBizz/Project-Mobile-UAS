...
@C0463SafeParcelable.Class(creator = "DeleteRequestCreator")
...
public final class C0769zzt extends C0460AbstractSafeParcelable {
    public static final Parcelable.Creator<C0769zzt> CREATOR;
    @C0463SafeParcelable.Field(getter = "getCredential", id = 1)
    private final C0062Credential zzam;

    @C0463SafeParcelable.Constructor
    public C0769zzt(@C0463SafeParcelable.Param(id = 1) C0062Credential credential) {
    ...
    static {
        Parcelable.Creator<C0769zzt> creator;
        new C0768zzs();
        CREATOR = creator;
    }
}
