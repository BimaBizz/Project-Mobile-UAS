...
class OneSignalSyncServiceUtils {
    ...
    private static PendingIntent syncServicePendingIntent(Context context) {
        ...
        return PendingIntent.getService(context2, SYNC_TASK_ID, intent, 134217728);
    }
    ...
    private static void scheduleSyncServiceAsAlarm(Context context, long j) {
        ...
        ((AlarmManager) context2.getSystemService("alarm")).set(0, System.currentTimeMillis() + delayMs + delayMs, pendingIntent);
    }
