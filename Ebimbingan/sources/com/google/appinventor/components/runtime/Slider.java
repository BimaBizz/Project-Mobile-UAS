...
public class Slider extends AndroidViewComponent implements SeekBar.OnSeekBarChangeListener {
    ...
    private final SeekBar f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public boolean symWhrqAyHWXMObHLoQEIMlJvqdZFvcp7UyC2VmDxP3CgSs0pkdkxz6qiaDBzrEK;
    ...
    public Slider(com.google.appinventor.components.runtime.ComponentContainer r11) {
        ...
        L_0x0026:
            ...
            r5.<init>(r6)
            r3.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r4
            r3 = r1
            r9 = r3
            r3 = r9
            r4 = r9
            android.widget.SeekBar r4 = r4.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
        ...
        L_0x0075:
            ...
            r3 = r1
            android.widget.SeekBar r3 = r3.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME
            r4 = r1
    ...
    private void wGMjbGuJ9Yk6s2LaEm8v1pEJlXt36TYBWZSsia0LUgb1yMdHNGB7uRz3VqnF79D0() {
        this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setProgress((int) (((this.EFLFxJJ7hYZabk7bFItjKUUJ7DOOvUWrCh3qTHGqJQXtWFnrbkhe9SsRqCU9oxdB - this.W6T0KLh0HOscnxSkBKrzTm675pNrsPjnoOd2dFOC45d2E2zbErFUDn8t6kBqwFa) / (this.kiRcALaZrUgDipBGGRCywmcwXV6owEI5LzNEBeYdXQPOcCNVgoIiuO1Q0ZEin4tA - this.W6T0KLh0HOscnxSkBKrzTm675pNrsPjnoOd2dFOC45d2E2zbErFUDn8t6kBqwFa)) * 100.0f));
    }
    ...
    public void RotationAngle(double d) {
        ...
        this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setRotation((float) d2);
    }
    ...
    public void ThumbEnabled(boolean z) {
        ...
        new View.OnTouchListener(this) {
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.symWhrqAyHWXMObHLoQEIMlJvqdZFvcp7UyC2VmDxP3CgSs0pkdkxz6qiaDBzrEK) {
                    return false;
                }
                return true;
            }
        };
        this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setOnTouchListener(onTouchListener);
    }
    ...
    public void ThumbImage(String str) {
        ...
        try {
            ...
            if (bitmapDrawable != null) {
                this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setThumb(bitmapDrawable2);
            }
        } catch (Exception e) {
            new StringBuilder();
    ...
    public void ThumbColor(int i) {
        ...
        if (this.referenceGetThumb) {
            this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getThumb().mutate().setColorFilter(i2, PorterDuff.Mode.SRC_IN);
        } else {
    ...
    public void PositionChanged(float f) {
        EventDispatcher.dispatchEvent(this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "PositionChanged", Float.valueOf(f));
    }
    ...
    public void TouchDown() {
        EventDispatcher.dispatchEvent(this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "TouchDown", new Object[0]);
    }
    ...
    public void TouchUp() {
        EventDispatcher.dispatchEvent(this.f208hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this, "TouchUp", new Object[0]);
    }
