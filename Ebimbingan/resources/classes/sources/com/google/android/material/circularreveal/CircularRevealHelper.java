...
public class CircularRevealHelper {
    ...
    public CircularRevealHelper(Delegate delegate2) {
        ...
        this.view.setWillNotDraw(DEBUG);
        new Path();
    ...
    public void buildCircularRevealCache() {
        ...
        if (STRATEGY == 0) {
            ...
            this.hasCircularRevealCache = DEBUG;
            ...
            this.buildingCircularRevealCache = DEBUG;
    ...
    public boolean isOpaque() {
        return (!this.delegate.actualIsOpaque() || shouldDrawCircularReveal()) ? DEBUG : true;
    }

    private boolean shouldDrawCircularReveal() {
        boolean invalidRevealInfo = (this.revealInfo == null || this.revealInfo.isInvalid()) ? true : DEBUG;
        if (STRATEGY == 0) {
            return (invalidRevealInfo || !this.hasCircularRevealCache) ? DEBUG : true;
        }
        return !invalidRevealInfo ? true : DEBUG;
    }

    private boolean shouldDrawScrim() {
        return (this.buildingCircularRevealCache || Color.alpha(this.scrimPaint.getColor()) == 0) ? DEBUG : true;
    }

    private boolean shouldDrawOverlayDrawable() {
        return (this.buildingCircularRevealCache || this.overlayDrawable == null || this.revealInfo == null) ? DEBUG : true;
    }
