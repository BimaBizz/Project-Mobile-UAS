...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private void updateViewsVisibility(boolean z) {
        ...
        boolean hasText = !TextUtils.isEmpty(this.mSearchSrcTextView.getText()) ? true : DBG;
        ...
        updateCloseButton();
        updateVoiceButton(!hasText ? true : DBG);
        updateSubmitArea();
    }
    ...
    private boolean hasVoiceSearch() {
        if (this.mSearchable != null && this.mSearchable.getVoiceSearchEnabled()) {
            ...
            if (testIntent != null) {
                return getContext().getPackageManager().resolveActivity(testIntent, 65536) != null ? true : DBG;
            }
        }
        return DBG;
    }
    ...
    private void updateCloseButton() {
        boolean hasText = !TextUtils.isEmpty(this.mSearchSrcTextView.getText()) ? true : DBG;
        this.mCloseButton.setVisibility((hasText || (this.mIconifiedByDefault && !this.mExpandedInActionView)) ? true : DBG ? 0 : 8);
    ...
    public void onTextChanged(CharSequence charSequence) {
        ...
        boolean hasText = !TextUtils.isEmpty(text) ? true : DBG;
        updateSubmitButton(hasText);
        updateVoiceButton(!hasText ? true : DBG);
        updateCloseButton();
        updateSubmitArea();
