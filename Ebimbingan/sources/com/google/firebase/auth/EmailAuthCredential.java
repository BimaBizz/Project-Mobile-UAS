...
@C0463SafeParcelable.Class(creator = "EmailAuthCredentialCreator")
public class EmailAuthCredential extends AuthCredential {
    ...
    private String zzig;
    @C0463SafeParcelable.Field(getter = "getSignInLink", id = 3)
    private final String zzih;
    @C0463SafeParcelable.Field(getter = "getCachedState", id = 4)
    private String zzii;
    @C0463SafeParcelable.Field(getter = "isForLinking", id = 5)
    private boolean zzij;

    @C0463SafeParcelable.Constructor
    EmailAuthCredential(@C0463SafeParcelable.Param(id = 1) @NonNull String str, @C0463SafeParcelable.Param(id = 2) @NonNull String str2, @C0463SafeParcelable.Param(id = 3) @NonNull String str3, @C0463SafeParcelable.Param(id = 4) @NonNull String str4, @C0463SafeParcelable.Param(id = 5) @NonNull boolean z) {
        Throwable th;
        String str5 = str2;
        String str6 = str3;
        String str7 = str4;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeString(parcel2, 3, this.zzih, false);
        C0462SafeParcelWriter.writeString(parcel2, 4, this.zzii, false);
        C0462SafeParcelWriter.writeBoolean(parcel2, 5, this.zzij);
