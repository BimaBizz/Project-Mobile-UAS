...
public final class zzap extends zzag {
    ...
    public final Task<AuthResult> zza(FirebaseApp firebaseApp, FirebaseUser firebaseUser, AuthCredential authCredential, zzax zzax) {
        ...
        Object checkNotNull4 = C0446Preconditions.checkNotNull(zzax2);
        List<String> zzcw = firebaseUser2.zzcw();
        List<String> list = zzcw;
        if (zzcw != null && list.contains(authCredential2.getProvider())) {
            new C0236Status(FirebaseError.ERROR_PROVIDER_ALREADY_LINKED);
            ...
            Object checkNotNull5 = C0446Preconditions.checkNotNull(firebaseApp3);
            Object checkNotNull6 = C0446Preconditions.checkNotNull(authCredential3);
            Object checkNotNull7 = C0446Preconditions.checkNotNull(firebaseUser3);
            Object checkNotNull8 = C0446Preconditions.checkNotNull(zzax6);
    ...
    public final Task<AuthResult> zzd(FirebaseApp firebaseApp, FirebaseUser firebaseUser, String str, zzax zzax) {
        ...
        Object checkNotNull3 = C0446Preconditions.checkNotNull(zzax2);
        List<String> zzcw = firebaseUser2.zzcw();
        List<String> list = zzcw;
        if ((zzcw == null || list.contains(str2)) && !firebaseUser2.isAnonymous()) {
            ...
            new C0236Status((int) FirebaseError.ERROR_NO_SUCH_PROVIDER, str2);
            return Tasks.forException(zzdr.zzb(status));
        }
    }
    ...
    static zzm zza(FirebaseApp firebaseApp, zzem zzem) {
        ...
        zzem zzem2 = zzem;
        Object checkNotNull = C0446Preconditions.checkNotNull(firebaseApp2);
        Object checkNotNull2 = C0446Preconditions.checkNotNull(zzem2);
        new ArrayList();
        List list2 = list;
