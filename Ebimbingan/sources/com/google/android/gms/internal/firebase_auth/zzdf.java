...
@C0463SafeParcelable.Class(creator = "SignInWithEmailAndPasswordAidlRequestCreator")
public final class zzdf extends C0460AbstractSafeParcelable {
    ...
    public zzdf(@C0463SafeParcelable.Param(id = 1) String str, @C0463SafeParcelable.Param(id = 2) String str2, @C0463SafeParcelable.Param(id = 3) @Nullable String str3) {
        this.zzif = str;
        this.zzig = str2;
        this.zzhy = str3;
    }
