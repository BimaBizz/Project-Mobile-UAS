...
public abstract class zzgv extends zzgf {
    private static final Logger zzb = Logger.getLogger(zzgv.class.getName());
    /* access modifiers changed from: private */
    public static final boolean zzc = zzkg.zza();
    zzgy zza;
    ...
    public abstract void zza(int i, zzis zzis) throws IOException;

    /* access modifiers changed from: package-private */
    public abstract void zza(int i, zzis zzis, zzji zzji) throws IOException;
    ...
    public abstract void zza(zzgi zzgi) throws IOException;

    public abstract void zza(zzis zzis) throws IOException;
    ...
    public static class zzb extends IOException {
        ...
        zzb(java.lang.String r10, java.lang.Throwable r11) {
            ...
            L_0x0022:
                ...
                goto L_0x001d
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.auth.zzgv.zzb.<init>(java.lang.String, java.lang.Throwable):void");
        }
    }
    ...
    static class zza extends zzgv {
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzis zzis, zzji zzji) throws IOException {
            zzis zzis2 = zzis;
            zzji zzji2 = zzji;
            zza(i, 2);
            zzji zzji3 = zzji2;
            zzfy zzfy = (zzfy) zzis2;
            zzfy zzfy2 = zzfy;
            int zzb2 = zzfy.zzb();
            int i2 = zzb2;
            if (zzb2 == -1) {
            ...
            zzb(i2);
            zzji2.zza(zzis2, (zzkx) this.zza);
        }

        public final void zza(int i, zzis zzis) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, 2);
            zza(zzis);
        ...
        public final void zzb(int i) throws IOException {
            ...
            if (!zzgv.zzc || zzgb.zza() || zza() < 5) {
                ...
                int i8 = i7 + 1;
                this.zze = i8;
                zzkg.zza(bArr3, (long) i7, (byte) i2);
            } else {
                byte[] bArr4 = this.zzb;
                int i9 = this.zze;
                int i10 = i9 + 1;
                this.zze = i10;
                zzkg.zza(bArr4, (long) i9, (byte) (i2 | 128));
                int i11 = i2 >>> 7;
                int i12 = i11;
                if ((i11 & -128) == 0) {
                    byte[] bArr5 = this.zzb;
                    ...
                    int i14 = i13 + 1;
                    this.zze = i14;
                    zzkg.zza(bArr5, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr6 = this.zzb;
                int i15 = this.zze;
                int i16 = i15 + 1;
                this.zze = i16;
                zzkg.zza(bArr6, (long) i15, (byte) (i12 | 128));
                int i17 = i12 >>> 7;
                int i18 = i17;
                if ((i17 & -128) == 0) {
                    byte[] bArr7 = this.zzb;
                    ...
                    int i20 = i19 + 1;
                    this.zze = i20;
                    zzkg.zza(bArr7, (long) i19, (byte) i18);
                    return;
                }
                byte[] bArr8 = this.zzb;
                int i21 = this.zze;
                int i22 = i21 + 1;
                this.zze = i22;
                zzkg.zza(bArr8, (long) i21, (byte) (i18 | 128));
                int i23 = i18 >>> 7;
                int i24 = i23;
                if ((i23 & -128) == 0) {
                    byte[] bArr9 = this.zzb;
                    ...
                    int i26 = i25 + 1;
                    this.zze = i26;
                    zzkg.zza(bArr9, (long) i25, (byte) i24);
                    return;
                }
                ...
                int i28 = i27 + 1;
                this.zze = i28;
                zzkg.zza(bArr10, (long) i27, (byte) (i24 | 128));
                byte[] bArr11 = this.zzb;
                int i29 = this.zze;
                int i30 = i29 + 1;
                this.zze = i30;
                zzkg.zza(bArr11, (long) i29, (byte) (i24 >>> 7));
            }
        }
        ...
        public final void zza(long j) throws IOException {
            ...
            while ((j2 & -128) != 0) {
                ...
                int i6 = i5 + 1;
                this.zze = i6;
                zzkg.zza(bArr3, (long) i5, (byte) ((((int) j2) & 127) | 128));
                j2 >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i7 = this.zze;
            int i8 = i7 + 1;
            this.zze = i8;
            zzkg.zza(bArr4, (long) i7, (byte) ((int) j2));
        }
        ...
        public final void zza(String str) throws IOException {
            ...
            try {
                ...
                if (zzg2 == zzg) {
                    this.zze = i + i2;
                    int zza = zzkj.zza(str2, this.zzb, this.zze, zza());
                    this.zze = i;
                    zzb((zza - i) - i2);
                    this.zze = zza;
                    return;
                }
                zzb(zzkj.zza((CharSequence) str2));
                this.zze = zzkj.zza(str2, this.zzb, this.zze, zza());
            } catch (zzkm e) {
                this.zze = i;
                zza(str2, e);
    ...
    public static int zza(int i, zzib zzib) {
        int i2 = i;
        int i3 = i2;
        int zzg = zzg(i2 << 3);
        int zzb2 = zzib.zzb();
    ...
    static int zzb(int i, zzis zzis, zzji zzji) {
        int i2 = i;
        int i3 = i2;
    ...
    public static int zzb(int i, zzib zzib) {
    ...
    public static int zzb(String str) {
        ...
        String str2 = str;
        try {
            length = zzkj.zza((CharSequence) str2);
        } catch (zzkm e) {
            length = str2.getBytes(zzho.zza).length;
        }
        int i = length;
        return zzg(i) + i;
    }

    public static int zza(zzib zzib) {
        int zzb2 = zzib.zzb();
        return zzg(zzb2) + zzb2;
    }

    public static int zzb(zzgi zzgi) {
        int zza2 = zzgi.zza();
    ...
    public static int zzb(zzis zzis) {
        int zzd = zzis.zzd();
        return zzg(zzd) + zzd;
    }

    static int zza(zzis zzis, zzji zzji) {
        zzji zzji2 = zzji;
        zzfy zzfy = (zzfy) zzis;
        zzfy zzfy2 = zzfy;
        int zzb2 = zzfy.zzb();
    ...
    /* access modifiers changed from: package-private */
    public final void zza(String str, zzkm zzkm) throws IOException {
        Throwable th;
        ...
        byte[] bytes = str.getBytes(zzho.zza);
        try {
            zzb(bytes.length);
    ...
    @Deprecated
    static int zzc(int i, zzis zzis, zzji zzji) {
        int i2 = i;
        int i3 = i2;
        int zzg = zzg(i2 << 3) << 1;
        zzji zzji2 = zzji;
    ...
    @Deprecated
    public static int zzc(zzis zzis) {
        return zzis.zzd();
    }
