...
public class MakeroidAirtable extends AndroidNonvisibleComponent {
    ...
    public void BaseId(String str) {
        String str2 = str;
        this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW = str2;
    }
    ...
    public void GetAllData() throws Exception {
        ...
        String sb5 = sb.append(this.sR32qIN7Ar1u7i1api4nHQx9ll4d2UKsyYwGlFPHAR6MP73rw39BVQBnLHX3cktp).toString();
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("?&view=").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).toString().replaceAll(" ", "%20"));
    ...
    public void GetAllWithOffset(String str, JSONArray jSONArray) {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("?&view=").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("&offset=").append(str2).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty("Authorization", sb5);
            httpURLConnection2.setRequestProperty("Content-Type", "application/json");
            ...
            this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA = jSONArray2.toString();
            this.N4rx6qe3Dkxm9iGosdnZviEGwwAyjrMopVTdmRoB5smsVn2ef0JNliQjJW08w5OT = httpURLConnection2.getResponseCode();
    ...
    public void Cell(int i, String str) throws Exception {
        ...
        String str2 = str;
        new StringBuilder(FusiontablesControl.AUTHORIZATION_HEADER_PREFIX);
        String sb4 = sb.append(this.sR32qIN7Ar1u7i1api4nHQx9ll4d2UKsyYwGlFPHAR6MP73rw39BVQBnLHX3cktp).toString();
        new StringBuilder("https://api.airtable.com/v0/");
        new URL(sb2.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("?fields[]=").append(str2).append("&view=").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).toString().replaceAll(" ", "%20"));
        HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
        HttpURLConnection httpURLConnection2 = httpURLConnection;
    ...
    public void GetCellWithOffset(String str, JSONArray jSONArray, String str2, int i) {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb3.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("?fields[]=").append(str4).append("&view=").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("&offset=").append(str3).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            HttpURLConnection httpURLConnection2 = httpURLConnection;
            httpURLConnection.setRequestProperty("Authorization", sb5);
            httpURLConnection2.setRequestProperty("Content-Type", "application/json");
    ...
    public void ColumnWithOffset(List<String> list, List<String> list2, List<String> list3, String str, int i, String str2) throws Exception {
        ...
        String sb4 = sb.append(this.sR32qIN7Ar1u7i1api4nHQx9ll4d2UKsyYwGlFPHAR6MP73rw39BVQBnLHX3cktp).toString();
        new StringBuilder("https://api.airtable.com/v0/");
        new URL(sb2.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("?fields[]=").append(str3).append("&maxRecords=").append(i2).append("&view=").append(this.Al9x361S9LLe4YuJ2FYrCTKylxVrvlRhCPyJ97vxqAo0DGA2cpEUDnPNY8RXP1UW).append("&offset=").append(str2).toString().replaceAll(" ", "%20"));
        HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
        HttpURLConnection httpURLConnection2 = httpURLConnection;
        httpURLConnection.setRequestProperty("Authorization", sb4);
        httpURLConnection2.setRequestProperty("Content-Type", "application/json");
    ...
    public void setCell(int i, String str, String str2) throws Exception {
        ...
        new StringBuilder(FusiontablesControl.AUTHORIZATION_HEADER_PREFIX);
        String sb5 = sb.append(this.sR32qIN7Ar1u7i1api4nHQx9ll4d2UKsyYwGlFPHAR6MP73rw39BVQBnLHX3cktp).toString();
        new JSONArray(this.WT81i4At6dHne14KPL5TcdNiShzKisif1ehRA81016Xex9QKtWws9m2RXtqd3wpA);
        String string = jSONArray.getJSONObject(i - 1).getString("id");
        DataOutputStream dataOutputStream2 = null;
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).append("/").append(string).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
    ...
    public void createRow(YailList yailList, YailList yailList2) throws Exception {
        ...
        try {
            new StringBuilder("https://api.airtable.com/v0/");
            new URL(sb2.append(this.sOlouMp7GHVTpUn4YBGbQbUCVWieKOYZN8RaxLZS4Jb0AfyW3N6tLVaVFyvseW).append("/").append(this.IMDN6rSQcZszgVNpJJVzEqq6OCV4rs9tTZyufLfJdSMnHOCoW11dHNeXoNpXCGNt).toString().replaceAll(" ", "%20"));
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            new StringBuilder("{\"fields\":");
