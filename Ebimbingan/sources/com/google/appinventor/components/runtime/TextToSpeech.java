...
public class TextToSpeech extends AndroidNonvisibleComponent implements Component, OnDestroyListener, OnResumeListener, OnStopListener {
    ...
    static /* synthetic */ boolean hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(TextToSpeech textToSpeech, boolean z) {
        boolean z2 = z;
        boolean z3 = z2;
        textToSpeech.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA = z3;
        return z2;
    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                ...
                if (iSO3Country.length() > 0) {
                    Locale put = l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j.put(str, locale);
                }
            ...
            try {
                ...
                if (iSO3Language.length() > 0) {
                    Locale put2 = mBLKdPlRolYfdtud5Z8giGWyhURWoCw9yHsOv08fUnIBAM4MuKAWkHVD8nEhBmIT.put(str2, locale);
                }
    ...
    public TextToSpeech(com.google.appinventor.components.runtime.ComponentContainer r11) {
        /*
            ...
            r4 = r0
            r5 = 0
            r4.tFNQ38WX0EWx1sBmwkfGOavwj0ohdRyv5RfL5KQ0qa5Pnr6qc7YsZTQu1aP3NtmA = r5
            r4 = r0
            java.lang.String r5 = ""
            r4.Language(r5)
            r4 = r0
        ...
        L_0x006d:
            ...
            r4 = r0
            r5 = 0
            r4.HD0pINq0k1DLtf3yXVbK8xQhU4iGPT4iryXVeTceizjENHUUCtIIAr11wB5gmj8l = r5
            r4 = r0
            ...
            com.google.appinventor.components.runtime.util.YailList r5 = com.google.appinventor.components.runtime.util.YailList.makeList((java.util.List) r5)
            r4.vOibdtOfNxMVixWab9VDGgvD9L4Kqb2ZDQBius3PMdhiP1dPN68Z9GzWJA49TUbE = r5
            return
        L_0x00be:
            r4 = 0
            goto L_0x002d
    ...
    public void Language(String str) {
        ...
        switch (str2.length()) {
            ...
            case 3:
                ...
                if (locale4 == null) {
                    locale5 = mBLKdPlRolYfdtud5Z8giGWyhURWoCw9yHsOv08fUnIBAM4MuKAWkHVD8nEhBmIT.get(str2.toLowerCase(Locale.ENGLISH));
                }
                if (locale5 == null) {
                ...
                locale2 = locale3;
                this.vQeIU3Nt6lISgDcgPcgMyfTsPOzVWtilFVqv3Ws2SOY6jXuMnX7gL1LFHvLOLuoZ = locale2.getISO3Language();
                break;
            default:
    ...
    public void Country(String str) {
        ...
        switch (str2.length()) {
            ...
            case 3:
                ...
                Locale locale5 = locale4;
                if (locale4 == null) {
                    locale5 = l557Ll1q9gLt3cEfyQaLTgWgvIutpQIPuKKLXX2glk42j33zjQ1xoBSDeCkOGk6j.get(str2.toUpperCase(Locale.ENGLISH));
                }
                if (locale5 == null) {
                    locale3 = Locale.getDefault();
                } else {
