...
public class ClientLoginHelper implements IClientLoginHelper {
    ...
    private HttpClient f238hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public ClientLoginHelper(Activity activity2, String str, String str2, HttpClient httpClient) {
        ...
        this.f238hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = httpClient2;
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest) throws ClientProtocolException, IOException {
        ...
        HttpResponse execute = this.f238hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest2);
        ...
        if (execute.getStatusLine().getStatusCode() == 401) {
            ...
            httpResponse = this.f238hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.execute(httpUriRequest2);
        }
        return httpResponse;
    }
