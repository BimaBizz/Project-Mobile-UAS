...
public class MemoryLeakUtil {
    ...
    private static final Map<String, WeakReference<Object>> moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0 = Maps.newTreeMap();
    ...
    public static String trackObject(String str, Object obj) {
        ...
        WeakReference<Object> put = moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0.put(str3, obj2);
        return str3;
    }
    ...
    public static boolean isTrackedObjectCollected(String str, boolean z) {
        ...
        boolean z2 = z;
        System.gc();
        WeakReference weakReference = moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0.get(str2);
        ...
        if (weakReference != null) {
            ...
            if (z2 && obj == null) {
                WeakReference<Object> remove = moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0.remove(str2);
            }
            if (obj == null) {
                return true;
            }
    ...
    public static void checkAllTrackedObjects(boolean z, boolean z2) {
        ...
        int i2 = 0;
        int i3 = 0;
        Iterator<Map.Entry<String, WeakReference<Object>>> it = moH2L3ThNq0Qhevz3oD0wpnUoXefdMi3gJ5JHfEbjrtgsvRvpM1e34BZQYI4s5i0.entrySet().iterator();
        while (it.hasNext()) {
