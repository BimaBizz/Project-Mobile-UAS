...
@C0463SafeParcelable.Class(creator = "DefaultFirebaseUserCreator")
public class zzm extends FirebaseUser {
    public static final Parcelable.Creator<zzm> CREATOR;
    @C0463SafeParcelable.Field(getter = "getDefaultOAuthCredential", id = 11)
    private zzf zzkw;
    @C0463SafeParcelable.Field(getter = "isNewUser", id = 10)
    private boolean zzrg;
    @C0463SafeParcelable.Field(getter = "getCachedTokenState", id = 1)
    private zzes zzth;
    @C0463SafeParcelable.Field(getter = "getDefaultAuthUserInfo", id = 2)
    private zzi zzti;
    @C0463SafeParcelable.Field(getter = "getFirebaseAppName", id = 3)
    private String zztj;
    @C0463SafeParcelable.Field(getter = "getUserType", id = 4)
    private String zztk;
    @C0463SafeParcelable.Field(getter = "getUserInfos", id = 5)
    private List<zzi> zztl;
    @C0463SafeParcelable.Field(getter = "getProviders", id = 6)
    private List<String> zztm;
    @C0463SafeParcelable.Field(getter = "getCurrentVersion", id = 7)
    private String zztn;
    @C0463SafeParcelable.Field(getter = "isAnonymous", id = 8)
    private Boolean zzto;
    @C0463SafeParcelable.Field(getter = "getMetadata", id = 9)
    private zzo zztp;
    @C0463SafeParcelable.Field(getter = "getMultiFactorInfoList", id = 12)
    private zzao zztq;

    @C0463SafeParcelable.Constructor
    zzm(@C0463SafeParcelable.Param(id = 1) zzes zzes, @C0463SafeParcelable.Param(id = 2) zzi zzi, @C0463SafeParcelable.Param(id = 3) String str, @C0463SafeParcelable.Param(id = 4) String str2, @C0463SafeParcelable.Param(id = 5) List<zzi> list, @C0463SafeParcelable.Param(id = 6) List<String> list2, @C0463SafeParcelable.Param(id = 7) String str3, @C0463SafeParcelable.Param(id = 8) Boolean bool, @C0463SafeParcelable.Param(id = 9) zzo zzo, @C0463SafeParcelable.Param(id = 10) boolean z, @C0463SafeParcelable.Param(id = 11) zzf zzf, @C0463SafeParcelable.Param(id = 12) zzao zzao) {
        this.zzth = zzes;
        this.zzti = zzi;
        this.zztj = str;
        this.zztk = str2;
    ...
    public zzm(FirebaseApp firebaseApp, List<? extends UserInfo> list) {
        ...
        Object checkNotNull = C0446Preconditions.checkNotNull(firebaseApp2);
    ...
    public final FirebaseUser zza(List<? extends UserInfo> list) {
        ...
        Object checkNotNull = C0446Preconditions.checkNotNull(list4);
    ...
    public final void zza(zzes zzes) {
        zzes zzes2 = (zzes) C0446Preconditions.checkNotNull(zzes);
        this.zzth = zzes2;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeParcelable(parcel2, 1, zzcy(), i2, false);
        C0462SafeParcelWriter.writeParcelable(parcel2, 2, this.zzti, i2, false);
        C0462SafeParcelWriter.writeString(parcel2, 3, this.zztj, false);
        C0462SafeParcelWriter.writeString(parcel2, 4, this.zztk, false);
        C0462SafeParcelWriter.writeTypedList(parcel2, 5, this.zztl, false);
        C0462SafeParcelWriter.writeStringList(parcel2, 6, zzcw(), false);
        C0462SafeParcelWriter.writeString(parcel2, 7, this.zztn, false);
        C0462SafeParcelWriter.writeBooleanObject(parcel2, 8, Boolean.valueOf(isAnonymous()), false);
        C0462SafeParcelWriter.writeParcelable(parcel2, 9, getMetadata(), i2, false);
        C0462SafeParcelWriter.writeBoolean(parcel2, 10, this.zzrg);
        C0462SafeParcelWriter.writeParcelable(parcel2, 11, this.zzkw, i2, false);
        C0462SafeParcelWriter.writeParcelable(parcel2, 12, this.zztq, i2, false);
