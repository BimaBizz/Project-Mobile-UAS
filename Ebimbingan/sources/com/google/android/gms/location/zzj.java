...
@C0463SafeParcelable.Class(creator = "DeviceOrientationRequestCreator")
public final class zzj extends C0460AbstractSafeParcelable {
    public static final Parcelable.Creator<zzj> CREATOR;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_SHOULD_USE_MAG", id = 1)
    private boolean zzt;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_MINIMUM_SAMPLING_PERIOD_MS", id = 2)
    private long zzu;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_SMALLEST_ANGLE_CHANGE_RADIANS", id = 3)
    private float zzv;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_EXPIRE_AT_MS", id = 4)
    private long zzw;
    @C0463SafeParcelable.Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_NUM_UPDATES", id = 5)
    private int zzx;
    ...
    zzj(@C0463SafeParcelable.Param(id = 1) boolean z, @C0463SafeParcelable.Param(id = 2) long j, @C0463SafeParcelable.Param(id = 3) float f, @C0463SafeParcelable.Param(id = 4) long j2, @C0463SafeParcelable.Param(id = 5) int i) {
        this.zzt = z;
        this.zzu = j;
        this.zzv = f;
        this.zzw = j2;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeBoolean(parcel2, 1, this.zzt);
        C0462SafeParcelWriter.writeLong(parcel2, 2, this.zzu);
        C0462SafeParcelWriter.writeFloat(parcel2, 3, this.zzv);
        C0462SafeParcelWriter.writeLong(parcel2, 4, this.zzw);
        C0462SafeParcelWriter.writeInt(parcel2, 5, this.zzx);
