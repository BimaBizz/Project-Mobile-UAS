...
public abstract class zzu<E> extends zzq<E> implements List<E>, RandomAccess {
    private static final zzy<Object> zza;
    ...
    public static <E> zzu<E> zzj(E e) {
        Object[] objArr = {e};
        Object[] zza2 = zzv.zza(objArr, 1);
        return zzn(objArr, 1);
    }

    public static <E> zzu<E> zzk(E e, E e2) {
        Object[] objArr = {e, e2};
        Object[] zza2 = zzv.zza(objArr, 2);
        return zzn(objArr, 2);
    }
            ...
            if (iterable2 instanceof Collection) {
                ...
                if (!it.hasNext()) {
                    ...
                    if (!it.hasNext()) {
                        ...
                        new zzr(4);
                        zzr zzb = zzr.zzb(next);
                        zzr<? extends E> zzc = zzr.zzc(it);
                        zzr.zzc = true;
    ...
    public static <E> zzu<E> zzm(Collection<? extends E> collection) {
        ...
        if (collection2 instanceof zzq) {
            zzu<E> zze = ((zzq) collection2).zze();
            if (!zze.zzf()) {
                return zze;
            }
        ...
        Object[] zza2 = zzv.zza(array2, length);
    ...
    public final boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r8) {
        ...
        L_0x002f:
            ...
            boolean r4 = com.google.android.gms.internal.common.zzk.zza(r4, r5)
        ...
        L_0x0088:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.common.zzu.equals(java.lang.Object):boolean");
    }
