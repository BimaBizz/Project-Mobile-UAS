...
@C0463SafeParcelable.Class(creator = "DetectedActivityCreator")
@C0463SafeParcelable.Reserved({1000})
public class DetectedActivity extends C0460AbstractSafeParcelable {
    ...
    public DetectedActivity(@C0463SafeParcelable.Param(id = 1) int i, @C0463SafeParcelable.Param(id = 2) int i2) {
        this.zzi = i;
        this.zzs = i2;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeInt(parcel2, 1, this.zzi);
        C0462SafeParcelWriter.writeInt(parcel2, 2, this.zzs);
