...
public class C1158DefaultTaskExecutor extends C1159TaskExecutor {
    private final ExecutorService mDiskIO;
    private final Object mLock;
    @Nullable
    private volatile Handler mMainHandler;

    public C1158DefaultTaskExecutor() {
        Object obj;
        ...
        new ThreadFactory(this) {
            ...
            final /* synthetic */ C1158DefaultTaskExecutor this$0;
            ...
            public Thread newThread(Runnable r) {
                ...
                new Thread(r);
                Thread t = thread;
                t.setName(String.format("arch_disk_io_%d", new Object[]{Integer.valueOf(this.mThreadId.getAndIncrement())}));
                return t;
            }
        };
