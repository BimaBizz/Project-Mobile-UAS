...
public final class zzfj implements zzdv<zzfj, zzp.zzm> {
    ...
    public final /* synthetic */ zzdv zza(zzjc zzjc) {
        ...
        this.zzif = C0615Strings.emptyToNull(zzm.getEmail());
        this.zzig = C0615Strings.emptyToNull(zzm.zzan());
        this.zzsl = Boolean.valueOf(zzm.zzao());
        this.zzjv = C0615Strings.emptyToNull(zzm.getDisplayName());
        this.zzkc = C0615Strings.emptyToNull(zzm.zzam());
        this.zzrq = zzey.zze(zzm.zzal());
        this.zzib = C0615Strings.emptyToNull(zzm.getIdToken());
        this.zzkh = C0615Strings.emptyToNull(zzm.zzs());
        this.zzrh = zzm.zzt();
        return this;
    }
}
