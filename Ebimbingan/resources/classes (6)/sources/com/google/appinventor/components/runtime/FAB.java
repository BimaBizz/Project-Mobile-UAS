...
public class FAB extends AndroidNonvisibleComponent implements Component {
    ...
    public void Icon(String str) {
        StringBuilder sb;
        String str2 = str;
        this.opkAxsBiNe4U2WnUIj3h2psrvR65Yw7R3K1A4XT1tnHgd80YyvpOyialIyu2UQYR = str2 == null ? "" : str2;
        try {
            this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = MediaUtil.getBitmapDrawable(this.container.$form(), this.opkAxsBiNe4U2WnUIj3h2psrvR65Yw7R3K1A4XT1tnHgd80YyvpOyialIyu2UQYR);
        } catch (Exception e) {
    ...
    public static class FloatingActionButton extends View {
        ...
        private static OvershootInterpolator f55hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        static {
            ...
            f55hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = overshootInterpolator;
        ...
        public void showFloatingActionButton(boolean z) {
            ...
            if (this.q0Zein2OQsQpQMJEzcCMbVGzaOYlGS7C9oJS7mmTl1ea6jnbwE6PEACmMQoD3fbj) {
                ...
                animatorArr2[1] = ofFloat2;
                animatorSet3.playTogether(animatorArr2);
                animatorSet4.setInterpolator(f55hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
                if (z2) {
