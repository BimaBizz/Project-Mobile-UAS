...
public final class FirebaseOptions {
    ...
    public static final class Builder {
        ...
        public Builder setApiKey(@NonNull String apiKey2) {
            this.apiKey = C0446Preconditions.checkNotEmpty(apiKey2, "ApiKey must be set.");
            return this;
        }

        @PublicApi
        public Builder setApplicationId(@NonNull String applicationId2) {
            this.applicationId = C0446Preconditions.checkNotEmpty(applicationId2, "ApplicationId must be set.");
            return this;
        }
    ...
    private FirebaseOptions(@NonNull String str, @NonNull String str2, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6, @Nullable String str7) {
        ...
        C0446Preconditions.checkState(!C0615Strings.isEmptyOrWhitespace(applicationId2), "ApplicationId must be set.");
    ...
    public static FirebaseOptions fromResource(Context context) {
        ...
        FirebaseOptions firebaseOptions;
        new C0453StringResourceValueReader(context);
        C0453StringResourceValueReader reader = stringResourceValueReader;
    ...
    public boolean equals(Object obj) {
        ...
        if (!C0444Objects.equal(this.applicationId, other.applicationId) || !C0444Objects.equal(this.apiKey, other.apiKey) || !C0444Objects.equal(this.databaseUrl, other.databaseUrl) || !C0444Objects.equal(this.gaTrackingId, other.gaTrackingId) || !C0444Objects.equal(this.gcmSenderId, other.gcmSenderId) || !C0444Objects.equal(this.storageBucket, other.storageBucket) || !C0444Objects.equal(this.projectId, other.projectId)) {
            z = false;
        } else {
            z = true;
        }
    ...
    public String toString() {
        return C0444Objects.toStringHelper(this).add("applicationId", this.applicationId).add("apiKey", this.apiKey).add("databaseUrl", this.databaseUrl).add("gcmSenderId", this.gcmSenderId).add("storageBucket", this.storageBucket).add("projectId", this.projectId).toString();
    }
}
