...
public final class Ball extends Sprite {
    ...
    private Paint f14hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public Ball(ComponentContainer componentContainer) {
        ...
        Paint paint;
        new Paint();
        this.f14hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = paint;
        PaintColor(-16777216);
        Radius(5);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.visible) {
            ...
            canvas2.drawCircle(deviceDensity + deviceDensity3, deviceDensity2 + deviceDensity3, deviceDensity3, this.f14hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME);
        }
    }
    ...
    public final void PaintColor(int i) {
        ...
        if (i2 != 0) {
            PaintUtil.changePaint(this.f14hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, i2);
        } else {
            PaintUtil.changePaint(this.f14hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, -16777216);
        }
        registerChange();
    }
