...
public final class WebViewer extends AndroidViewComponent implements DownloadListener, ActivityResultListener, OnPauseListener, OnResumeListener {
    ...
    static /* synthetic */ ValueCallback access$402(WebViewer webViewer, ValueCallback valueCallback) {
    ...
    static /* synthetic */ boolean access$702(WebViewer webViewer, boolean z) {
        boolean z2 = z;
        boolean z3 = z2;
    ...
    public final WebResourceResponse handleAppRequest(String str) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                WebResourceResponse webResourceResponse5 = webResourceResponse4;
                new WebResourceResponse(contentTypeFor, str4, 200, "OK", map3, openAsset);
                return webResourceResponse5;
            }
            WebResourceResponse webResourceResponse6 = webResourceResponse3;
            new WebResourceResponse(contentTypeFor, str4, openAsset);
            return webResourceResponse6;
        } catch (IOException e) {
            new ByteArrayInputStream(NanoHTTPD.HTTP_NOTFOUND.getBytes());
            InputStream inputStream2 = inputStream;
            if (Build.VERSION.SDK_INT >= 21) {
                new WebResourceResponse(NanoHTTPD.MIME_PLAINTEXT, "utf-8", 404, "Not Found", (Map) null, inputStream2);
                return webResourceResponse2;
            }
            new WebResourceResponse(NanoHTTPD.MIME_PLAINTEXT, "utf-8", inputStream2);
    ...
    public class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, WebChromeClient.FileChooserParams fileChooserParams) {
            ...
            if (this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.mFilePathCallback != null) {
                ...
                ValueCallback access$402 = WebViewer.access$402(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, (ValueCallback) null);
            }
            ValueCallback access$4022 = WebViewer.access$402(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, valueCallback2);
    ...
    private void loadUrl(String str, String str2) {
        ...
        new PermissionResultHandler(this) {
            ...
            public final void HandlePermissionResponse(String str, boolean z) {
                String str2 = str;
                if (z) {
                    boolean access$702 = WebViewer.access$702(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, true);
    ...
    public static void setupWebViewGeoLoc(WebViewer webViewer, WebView webView, Activity activity2) {
        ...
        new WebChromeClient(webViewer) {
            ...
            private /* synthetic */ WebViewer f232B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;

            {
                this.f232B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = r6;
            }
            ...
            public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
                ...
                String str3 = str2;
                if (this.f232B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.PromptforPermission()) {
                    ...
                    new DialogInterface.OnClickListener(this) {
                        ...
                        private /* synthetic */ AnonymousClass6 f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                        {
                            this.f233hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                        }
                    ...
                    new DialogInterface.OnClickListener(this) {
                        ...
                        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                        private /* synthetic */ AnonymousClass6 f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                        {
                            this.f234hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                        }
    ...
    public class WebViewInterface {
        ...
        /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
        final /* synthetic */ WebViewer f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

        WebViewInterface(WebViewer webViewer, Context context) {
            this.f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = webViewer;
        ...
        public void setWebViewString(String str) {
            ...
            new Runnable(this) {
                ...
                public final void run() {
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.WebViewStringChange(str3);
                }
            };
            this.f235hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.form.runOnUiThread(runnable);
        }
