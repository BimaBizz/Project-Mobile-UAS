...
@C0463SafeParcelable.Class(creator = "GeofencingRequestCreator")
@C0463SafeParcelable.Reserved({1000})
public class GeofencingRequest extends C0460AbstractSafeParcelable {
    ...
    @C0463SafeParcelable.Field(getter = "getParcelableGeofences", id = 1)
    private final List<zzbh> zzap;
    @C0463SafeParcelable.Field(getter = "getInitialTrigger", id = 2)
    ...
    public static final class Builder {
        ...
        public final Builder addGeofence(Geofence geofence) {
            ...
            Object checkNotNull = C0446Preconditions.checkNotNull(geofence2, "geofence can't be null.");
            C0446Preconditions.checkArgument(geofence2 instanceof zzbh, "Geofence must be created using Geofence.Builder.");
        ...
        public final GeofencingRequest build() {
            ...
            C0446Preconditions.checkArgument(!this.zzap.isEmpty(), "No geofence has been added to this request.");
    ...
    GeofencingRequest(@C0463SafeParcelable.Param(id = 1) List<zzbh> list, @C0463SafeParcelable.Param(id = 2) int i, @C0463SafeParcelable.Param(id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeTypedList(parcel2, 1, this.zzap, false);
        C0462SafeParcelWriter.writeInt(parcel2, 2, getInitialTrigger());
