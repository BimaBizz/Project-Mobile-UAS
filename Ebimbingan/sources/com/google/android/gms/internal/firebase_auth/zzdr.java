...
@C0463SafeParcelable.Class(creator = "UnlinkEmailCredentialAidlRequestCreator")
public final class zzdr extends C0460AbstractSafeParcelable {
    public static final Parcelable.Creator<zzdr> CREATOR;
    @C0463SafeParcelable.Field(getter = "getCachedState", id = 1)
    private final String zzii;

    @C0463SafeParcelable.Constructor
    public zzdr(@C0463SafeParcelable.Param(id = 1) String str) {
        this.zzii = str;
    }
