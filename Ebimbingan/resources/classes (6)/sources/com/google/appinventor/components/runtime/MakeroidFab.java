...
public class MakeroidFab extends AndroidNonvisibleComponent implements View.OnClickListener, View.OnLongClickListener, Component, OnOrientationChangeListener {
    ...
    private FrameLayout.LayoutParams f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;

    /* renamed from: B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T  reason: collision with other field name */
    private String f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = Component.DEFAULT_VALUE_FAB_ICON_NAME;
    ...
    private boolean O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = true;
    ...
    private FloatingActionButtonExtension f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public MakeroidFab(com.google.appinventor.components.runtime.ComponentContainer r7) {
        /*
            ...
            r2.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = r3
            r2 = r0
            r3 = -1
            ...
            r4 = r5
            r4.<init>()
            r2.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r3
            r2 = r0
            r2.Initialize()
            r2 = r1
    ...
    private void Initialize() {
        ...
        this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = layoutParams;
        this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.setMargins(0, 0, KodularUnitUtil.DpToPixels((Context) this.activity, this.J9GCddMpW5m7K6b7f8nFol5AuYTClyx20NTbEibimiSwx7sDFiwQjZjPs0Mw8DwU), KodularUnitUtil.DpToPixels((Context) this.activity, this.bVeTzqSexGvEaauwiYAVDIi0rEKwP38hsr4zIk14QJ70YrYaNw4t0FSa76teZ34b));
        this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.gravity = 8388693;
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        ...
        IconName(this.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        ...
        if (this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS) {
        ...
        this.activity.addContentView(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        new Runnable(this) {
    ...
    public void onOrientationChange() {
        ...
        if (this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME != null) {
            this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.invalidateOnOrientationChange();
        }
    }
    ...
    public void MarginRight(int i) {
        ...
        this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.setMargins(0, 0, KodularUnitUtil.DpToPixels((Context) this.activity, i2), KodularUnitUtil.DpToPixels((Context) this.activity, this.bVeTzqSexGvEaauwiYAVDIi0rEKwP38hsr4zIk14QJ70YrYaNw4t0FSa76teZ34b));
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
    ...
    public void MarginBottom(int i) {
        ...
        this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.setMargins(0, 0, KodularUnitUtil.DpToPixels((Context) this.activity, this.J9GCddMpW5m7K6b7f8nFol5AuYTClyx20NTbEibimiSwx7sDFiwQjZjPs0Mw8DwU), KodularUnitUtil.DpToPixels((Context) this.activity, i2));
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setLayoutParams(this.f163B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.invalidate();
    }
    ...
    public void Show() {
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.show();
        this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = true;
    }

    @SimpleFunction(description = "Hides the fab button.")
    public void Hide() {
        this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hide();
        this.O8YFlD3Safgd5vkxHRoLznZm2if21MG0IxIn5jepRi6FBTeulibRFlvEXsnDANgS = false;
    }
    ...
    public void Icon(String str) {
        ...
        if (str2 != null && !str2.isEmpty()) {
            try {
                ...
                this.bg8qLM0P8YgZYqRlUjDxWnoKnWRYKRDQeEjqrx0ja4Cy7jLWl3M1lZwjImM82eG = str2;
                this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setImageDrawable(this.B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T);
            } catch (Exception e) {
    ...
    public void IconName(String str) {
        this.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T = str;
    ...
    public String IconName() {
        return this.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T;
    }
    ...
    private void KbzcIEn6WDqjdY1QBot1TMrBwhEYy4xAUKG2cbzQ22VNohlOtuBGKUJsEeMNZyEH() {
        if (!this.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T.isEmpty()) {
            try {
                this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setImageBitmap(hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.f164B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T, this.e1IHYfRNckEvpOWbFvMtuN7w9PEpZtVYShhIlzbQR8mwSxiOizA6OYtX7vMfGCUT));
            } catch (Exception e) {
                int e2 = Log.e("Makeroid Fab", String.valueOf(e));
            }
        }
    ...
    public void ShowTextMessage() {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.showText();
    }

    @SimpleFunction(description = "Hides text message.")
    public void HideTextMessage() {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.hideText();
    }
    ...
    public void TextMessageText(String str) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setText(str);
    }

    @SimpleProperty(description = "Get the text message.")
    public String TextMessageText() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getText();
    }

    @DesignerProperty(defaultValue = "&HFFFFFFFF", editorType = "color", propertyType = "advanced")
    @SimpleProperty(description = "Set the text message color.")
    public void TextMessageTextColor(int i) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setTextColor(i);
    }

    @SimpleProperty(description = "Get the text message color.")
    public int TextMessageTextColor() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getTextColor();
    }
    ...
    public void TextMessageBackgroundColor(int i) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setBackgroundColor(i);
    }

    @SimpleProperty(description = "Get the text message background color.")
    public int TextMessageBackgroundColor() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getBackgroundColor();
    }
    ...
    public void TextMessageCornerRadius(float f) {
        float f2 = f;
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.cornerRadius = f2;
    }

    @SimpleProperty(description = "Get the text message corner radius.")
    public float TextMessageCornerRadius() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.cornerRadius;
    }
    ...
    public void ShowTextMessageOnLeftSide(boolean z) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setShowTextOnLeftSide(z);
    }

    @SimpleProperty(description = "Return true if the text message is on the left side.")
    public boolean ShowTextMessageOnLeftSide() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isShowTextOnLeftSide();
    }
    ...
    public void HideTextMessageOnTextClick(boolean z) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setHideTextOnClick(z);
    }
    ...
    public boolean HideTextMessageOnTextClick() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isHideTextOnClick();
    }
    ...
    public void HideTextMessageOnTextLongClick(boolean z) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setHideTextOnLongClick(z);
    }
    ...
    public boolean HideTextMessageOnTextLongClick() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isHideTextOnLongClick();
    }
    ...
    public void CallFabClickOnTextMessageClick(boolean z) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setCallFabClickOnTextClick(z);
    }
    ...
    public boolean CallFabClickOnTextMessageClick() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isCallFabClickOnTextClick();
    }
    ...
    public void CallFabLongClickOnTextMessageLongClick(boolean z) {
        this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setCallFabLongClickOnTextLongClick(z);
    }
    ...
    public boolean CallFabLongClickOnTextMessageLongClick() {
        return this.f165hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.isCallFabLongClickOnTextLongClick();
    }
}
