...
public class Base64 {
    ...
    public static final char[] encodeToChar(byte[] bArr, boolean z) {
        ...
        while (s < eLen) {
            ...
            int i3 = s3;
            s = s3 + 1;
            int i4 = ((sArr[i] & 255) << 16) | ((sArr[i2] & 255) << 8) | (sArr[i3] & 255);
            int i5 = d;
            int d2 = d + 1;
            dArr[i5] = CA[(i4 >>> 18) & 63];
            int i6 = d2;
        ...
        int left = sLen - eLen;
        if (left > 0) {
            int d6 = ((sArr[eLen] & 255) << 10) | (left == 2 ? (sArr[sLen - 1] & 255) << 2 : 0);
    ...
    public static final byte[] encodeToByte(byte[] bArr, boolean z) {
        ...
        if (left > 0) {
            ...
            dArr[dLen - 2] = left == 2 ? (byte) CA[d6 & 63] : 61;
            dArr[dLen - 1] = 61;
        }
        return dArr;
    }
