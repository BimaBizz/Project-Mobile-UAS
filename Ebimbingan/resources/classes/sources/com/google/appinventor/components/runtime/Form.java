...
@DesignerComponent(category = ComponentCategory.LAYOUT_GENERAL, description = "Top-level component containing all other components in the program", showOnPalette = false, version = 42)
...
public class Form extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener, Component, ComponentContainer, HandlesEventDispatching {
    ...
    private static boolean _initialized = $assertionsDisabled;
    ...
    private static boolean showListsAsJson = $assertionsDisabled;
    ...
    public Form() {
        ...
        this.keyboardReallyShown = $assertionsDisabled;
        new HashSet();
        this.permissions = set;
        this.highQuality = true;
        this.splashEnabled = true;
        this.keepScreenOn = $assertionsDisabled;
    ...
    public void onCreateFinish() {
        ...
        populatePermissions();
        if ((!doesAppDeclarePermission("android.permission.WRITE_EXTERNAL_STORAGE") || !IsCompanion()) ? $assertionsDisabled : true) {
    ...
    private void defaultPropertyValues() {
        ...
        ShowNavBar(true);
        TitleVisible(true);
        ShowListsAsJson($assertionsDisabled);
        ...
        HighQuality($assertionsDisabled);
        KeepScreenOn($assertionsDisabled);
        RTLSupport($assertionsDisabled);
    }
                ...
                public final void run() {
                    ...
                    if (z) {
                        ...
                        new Runnable(this) {
                            ...
                            private /* synthetic */ AnonymousClass12 f75hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                            {
                                this.f75hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r6;
                            }
    ...
    public void onGlobalLayout() {
        ...
        if (((double) height2) < 0.25d) {
            ...
            if (this.keyboardShown) {
                this.keyboardShown = $assertionsDisabled;
        ...
        this.keyboardReallyShown = ((double) (height3 - rect2.bottom)) > ((double) height3) * 0.15d ? true : $assertionsDisabled;
    ...
    public void dispatchErrorOccurredEvent(Component component, String str, int i, Object... objArr) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f80hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f80hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r9;
            }

            public final void run() {
                this.f80hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.ErrorOccurred(component2, str2, i2, ErrorMessages.formatMessage(i2, objArr2));
            }
        };
    ...
    public void dispatchErrorOccurredEventDialog(Component component, String str, int i, Object... objArr) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f81hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f81hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r9;
            }
            ...
            public final void run() {
                ...
                this.f81hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.ErrorOccurredDialog(component2, str2, i2, formatMessage, sb.append(str2).toString(), "Dismiss");
            }
        };
        runOnUiThread(runnable);
    }
    ...
    public void recomputeLayout() {
        ...
        new DrawerLayout.SimpleDrawerListener(this) {
            ...
            public final void onDrawerClosed(View view) {
                View view2 = view;
                boolean access$302 = Form.access$302(this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME, Form.$assertionsDisabled);
    ...
    public void Sizing(String str) {
        ...
        if (str2.equals("Fixed")) {
            ...
            sCompatibilityMode = $assertionsDisabled;
        }
    ...
    public boolean isCustomPackage() {
        if (!getPackageName().equals(getKodularPackageName())) {
            return true;
        }
    ...
    public boolean isInstalledThruStore() {
        if (!getInstalledFrom().equals("Unknown")) {
            return true;
        }
        return $assertionsDisabled;
    }
    ...
    public void setChildWidth(AndroidViewComponent androidViewComponent, int i) {
        ...
        if (Width == 0) {
            ...
            new Runnable(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ Form f83hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f83hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                }

                public final void run() {
                    System.err.println("(Form)Width not stable yet... trying again");
                    this.f83hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildWidth(androidViewComponent3, i4);
                }
            };
    ...
    public void setChildHeight(AndroidViewComponent androidViewComponent, int i) {
        ...
        if (Height() == 0) {
            ...
            new Runnable(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ Form f82hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f82hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
                }

                public final void run() {
                    System.err.println("(Form)Height not stable yet... trying again");
                    this.f82hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setChildHeight(androidViewComponent3, i3);
                }
            };
            boolean postDelayed = this.androidUIHandler.postDelayed(runnable, 100);
        }
    ...
    public void clear() {
        ...
        screenInitialized = $assertionsDisabled;
    ...
    public void ShowNavBar(boolean z) {
        ...
        new View.OnSystemUiVisibilityChangeListener(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f84hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f84hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r7;
            }

            public final void onSystemUiVisibilityChange(int i) {
                int i2 = i;
                view2.setSystemUiVisibility(this.f84hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.VisibilityHelper(z3));
            }
        };
    ...
    public void RemoveSideMenu() {
        if (this.drawerLayout != null && this.actionBarDrawerToggle != null && getSupportActionBar() != null) {
            try {
                ...
                this.actionBarDrawerToggle.setDrawerIndicatorEnabled($assertionsDisabled);
                getSupportActionBar().setDisplayHomeAsUpEnabled($assertionsDisabled);
                this.layoutBackup = null;
    ...
    public void UnlockSideMenu() {
        if (this.drawerLayout != null && this.actionBarDrawerToggle != null && getSupportActionBar() != null) {
            this.lockedMenu = $assertionsDisabled;
    ...
    public void TitleBarFontTypeface(int i) {
        ...
        if (getSupportActionBar() != null) {
            ...
            titleBarFontHelper("", i2, $assertionsDisabled);
        }
    }
        ...
        for (int i3 = 0; i3 < this.toolbar.getChildCount(); i3++) {
            ...
            if (childAt instanceof TextView) {
                ...
                if (textView.getText().equals(this.toolbar.getTitle()) || textView2.getText().equals(this.toolbar.getSubtitle())) {
                    if (z2) {
                        TextViewUtil.setCustomFontTypeface($form(), textView2, str2, $assertionsDisabled, $assertionsDisabled);
                    } else {
                        TextViewUtil.setFontTypeface(textView2, i2, $assertionsDisabled, $assertionsDisabled);
                    }
                }
            }
        }
    ...
    public void onRequestPermissionsResult(int i, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (iArr2.length <= 0) {
            ...
            permissionResultHandler2.HandlePermissionResponse(strArr2[0], $assertionsDisabled);
        }
    ...
    public void dispatchPermissionDeniedEvent(Component component, String str, String str2) {
        ...
        new Runnable(this) {
            ...
            /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
            private /* synthetic */ Form f79hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

            {
                this.f79hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r8;
            }

            public final void run() {
                this.f79hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.PermissionDenied(component2, str3, str4);
            }
        };
        runOnUiThread(runnable);
    }
