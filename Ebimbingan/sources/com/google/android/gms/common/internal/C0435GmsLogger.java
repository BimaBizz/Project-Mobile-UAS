...
public final class C0435GmsLogger {
    ...
    @C0206KeepForSdk
    public C0435GmsLogger(@RecentlyNonNull String str) {
    ...
    @C0206KeepForSdk
    public C0435GmsLogger(@RecentlyNonNull String str, @Nullable String str2) {
        boolean z;
        String str3 = str;
        String str4 = str2;
        Object checkNotNull = C0446Preconditions.checkNotNull(str3, "log tag cannot be null");
        if (str3.length() <= 23) {
            z = true;
        } else {
            z = false;
        }
        C0446Preconditions.checkArgument(z, "tag \"%s\" is longer than the %d character maximum", str3, 23);
        this.zza = str3;
