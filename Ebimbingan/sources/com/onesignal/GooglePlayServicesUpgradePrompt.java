...
class GooglePlayServicesUpgradePrompt {
            ...
            new Runnable() {
                public void run() {
                    ...
                    if (activity != null && !OneSignal.mInitBuilder.mDisableGmsMissingPrompt) {
                        ...
                        String alertButtonClose = OSUtils.getResourceString(activity, "onesignal_gms_missing_alert_button_close", HTTP.CONN_CLOSE);
    ...
    public static void OpenPlayStoreToApp(Activity activity) {
        ...
        try {
            C0189GoogleApiAvailability apiAvailability = C0189GoogleApiAvailability.getInstance();
