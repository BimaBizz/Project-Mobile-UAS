...
public class C1160CardView extends FrameLayout {
    private static final int[] COLOR_BACKGROUND_ATTR = {16842801};
    private static final C1165CardViewImpl IMPL;
    private final C1164CardViewDelegate mCardViewDelegate;
    ...
    static {
        C1165CardViewImpl cardViewImpl;
        C1165CardViewImpl cardViewImpl2;
        C1165CardViewImpl cardViewImpl3;
        if (Build.VERSION.SDK_INT >= 21) {
            new C1162CardViewApi21Impl();
            IMPL = cardViewImpl3;
        } else if (Build.VERSION.SDK_INT >= 17) {
            new C1161CardViewApi17Impl();
            IMPL = cardViewImpl2;
        } else {
            new C1163CardViewBaseImpl();
            IMPL = cardViewImpl;
        }
        IMPL.initStatic();
    }
    ...
    public C1160CardView(@NonNull Context context) {
        this(context, (AttributeSet) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public C1160CardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public C1160CardView(@androidx.annotation.NonNull android.content.Context r19, @androidx.annotation.Nullable android.util.AttributeSet r20, int r21) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
        ...
        L_0x0133:
            ...
            goto L_0x012c
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.cardview.widget.C1160CardView.<init>(android.content.Context, android.util.AttributeSet, int):void");
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!(IMPL instanceof C1162CardViewApi21Impl)) {
