    ...
    public JsonToken _handleUnexpectedValue(int i) throws IOException, JsonParseException {
        ...
        switch (i2) {
            ...
            case 43:
                ...
                int i4 = i3 + 1;
                this._inputPtr = i4;
                return _handleInvalidNumberStart(bArr[i3] & 255, false);
            case 78:
                _matchToken("NaN", 1);
