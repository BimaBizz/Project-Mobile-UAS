...
public final class zzt {
    @NonNull
    public static C0236Status zzdc(@Nullable String str) {
        C0236Status status;
        String str2 = str;
        ...
        String str3 = Constants.COMMON_SCHEMA_PREFIX_SEPARATOR;
        String str4 = str3;
    ...
    @NonNull
    private static C0236Status zzc(String str, @Nullable String str2) {
        int i;
        C0236Status status;
        C0236Status status2;
        C0236Status status3;
        ...
        switch (str5.hashCode()) {
            ...
            case -646022241:
                ...
                break;
            case -595928767:
                if (str5.equals(InstanceID.ERROR_TIMEOUT)) {
                    z = true;
                    break;
                }
                break;
        ...
        int i3 = i2;
        if (i2 != 17499) {
            new C0236Status(i3, str4);
            return status;
        } else if (str4 != null) {
            C0236Status status4 = status3;
            new StringBuilder(1 + String.valueOf(str3).length() + String.valueOf(str4).length());
            new C0236Status(i3, sb.append(str3).append(Constants.COMMON_SCHEMA_PREFIX_SEPARATOR).append(str4).toString());
            return status4;
        } else {
            new C0236Status(i3, str3);
            return status2;
        }
    }
}
