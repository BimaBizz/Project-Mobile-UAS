...
public abstract class BufferedSingleValueSensor extends SingleValueSensor {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.enabled && sensorEvent2.sensor.getType() == this.sensorType) {
            ...
            a aVar2 = aVar;
            a aVar3 = aVar2;
            Float[] fArr2 = aVar2.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            a aVar4 = aVar3;
            ...
            fArr2[i] = valueOf;
            if (aVar3.hR11jdqaRrvBRiBFd4KN6gI7d8MNQVP5Yc7fufDZjGGTeTxaualejjrhiR1Iz2xO == aVar3.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.length) {
    ...
    public float getAverageValue() {
        ...
        double d2 = 0.0d;
        int i = 0;
        for (int i2 = 0; i2 < aVar.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.length; i2++) {
            if (aVar.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME[i2] != null) {
                d2 += (double) aVar.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME[i2].floatValue();
                i++;
            }
        }
        if (i == 0) {
    ...
    class a {
        ...
        Float[] f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
        ...
        private a(BufferedSingleValueSensor bufferedSingleValueSensor, int i) {
            ...
            this.f20hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = new Float[i];
