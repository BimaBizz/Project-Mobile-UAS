...
/* renamed from: com.google.android.gms.common.api.internal.zaar */
/* compiled from: com.google.android.gms:play-services-base@@17.6.0 */
public final class C0288zaar implements C0298zaba {
    ...
    /* access modifiers changed from: private */
    public final C0190GoogleApiAvailabilityLight zad;
    @Nullable
    private C0184ConnectionResult zae;
    private int zaf;
    private int zag = 0;
    private int zah;
    private final Bundle zai;
    private final Set<C0211Api.AnyClientKey> zaj;
    /* access modifiers changed from: private */
    @Nullable
    public C1152zae zak;
    private boolean zal;
    ...
    /* access modifiers changed from: private */
    @Nullable
    public C0437IAccountAccessor zao;
    private boolean zap;
    private boolean zaq;
    /* access modifiers changed from: private */
    @Nullable
    public final C0427ClientSettings zar;
    private final Map<C0211Api<?>, Boolean> zas;
    @Nullable
    private final C0211Api.AbstractClientBuilder<? extends C1152zae, C1134SignInOptions> zat;
    private final ArrayList<Future<?>> zau;

    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public C0288zaar(com.google.android.gms.common.api.internal.C0301zabd r12, @androidx.annotation.Nullable com.google.android.gms.common.internal.C0427ClientSettings r13, java.util.Map<com.google.android.gms.common.api.C0211Api<?>, java.lang.Boolean> r14, com.google.android.gms.common.C0190GoogleApiAvailabilityLight r15, @androidx.annotation.Nullable com.google.android.gms.common.api.C0211Api.AbstractClientBuilder<? extends com.google.android.gms.signin.C1152zae, com.google.android.gms.signin.C1134SignInOptions> r16, java.util.concurrent.locks.Lock r17, android.content.Context r18) {
        /*
            r11 = this;
            r0 = r11
            r1 = r12
    ...
    private final void zaB() {
        ...
        Bundle bundle;
        this.zaa.zap();
        ExecutorService zaa2 = C0302zabe.zaa();
        new C0278zaah(this);
        zaa2.execute(runnable);
        C1152zae zae2 = this.zak;
        if (zae2 != null) {
            if (this.zap) {
                zae2.zab((C0437IAccountAccessor) C0446Preconditions.checkNotNull(this.zao), this.zaq);
            }
            zaG(false);
        }
        for (C0211Api.AnyClientKey anyClientKey : this.zaa.zab.keySet()) {
            ((C0211Api.Client) C0446Preconditions.checkNotNull(this.zaa.zaa.get(anyClientKey))).disconnect();
        }
        if (this.zai.isEmpty()) {
            bundle = null;
        } else {
    ...
    /* access modifiers changed from: private */
    @GuardedBy("mLock")
    public final void zaC(C0184ConnectionResult connectionResult, C0211Api<?> api, boolean z) {
        ...
        C0184ConnectionResult put = this.zaa.zab.put(api2.zac(), connectionResult2);
    }
    ...
    public final void zaD() {
        ...
        for (C0211Api.AnyClientKey next : this.zaj) {
            if (!this.zaa.zab.containsKey(next)) {
                Map<C0211Api.AnyClientKey<?>, C0184ConnectionResult> map = this.zaa.zab;
                new C0184ConnectionResult(17, (PendingIntent) null);
                C0184ConnectionResult put = map.put(next, obj);
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    @GuardedBy("mLock")
    public final boolean zaE(C0184ConnectionResult connectionResult) {
        return this.zal && !connectionResult.hasResolution();
    }

    /* access modifiers changed from: private */
    @GuardedBy("mLock")
    public final void zaF(C0184ConnectionResult connectionResult) {
        C0184ConnectionResult connectionResult2 = connectionResult;
        zaH();
    ...
    private final void zaG(boolean z) {
        ...
        if (zae2 != null) {
            ...
            zae2.disconnect();
            C0427ClientSettings clientSettings = (C0427ClientSettings) C0446Preconditions.checkNotNull(this.zar);
            this.zao = null;
        }
    }
    ...
    static /* synthetic */ Set zap(C0288zaar zaar) {
        Set set;
        Set set2;
        C0288zaar zaar2 = zaar;
        C0427ClientSettings clientSettings = zaar2.zar;
        if (clientSettings == null) {
            set2 = Collections.emptySet();
        } else {
            new HashSet(clientSettings.getRequiredScopes());
            Map<C0211Api<?>, C0486zab> zaa2 = zaar2.zar.zaa();
            for (C0211Api next : zaa2.keySet()) {
    ...
    static /* synthetic */ boolean zav(C0288zaar zaar, int i) {
        int i2 = i;
        return zaar.zaI(0);
    }

    static /* synthetic */ void zay(C0288zaar zaar, C1146zak zak2) {
        StringBuilder sb;
        Throwable th;
        C0288zaar zaar2 = zaar;
        C1146zak zak3 = zak2;
        if (zaar2.zaI(0)) {
            C0184ConnectionResult zaa2 = zak3.zaa();
            if (zaa2.isSuccess()) {
                C0506zav zav = (C0506zav) C0446Preconditions.checkNotNull(zak3.zab());
                C0184ConnectionResult zab2 = zav.zab();
                if (!zab2.isSuccess()) {
                ...
                zaar2.zan = true;
                zaar2.zao = (C0437IAccountAccessor) C0446Preconditions.checkNotNull(zav.zaa());
                zaar2.zap = zav.zac();
                zaar2.zaq = zav.zad();
                zaar2.zaA();
    ...
    public final void zaa() {
        ...
        L_0x0037:
            ...
            com.google.android.gms.common.api.Api r8 = (com.google.android.gms.common.api.C0211Api) r8
            r5 = r8
            r8 = r0
            com.google.android.gms.common.api.internal.zabd r8 = r8.zaa
            ...
            com.google.android.gms.common.api.Api$Client r8 = (com.google.android.gms.common.api.C0211Api.Client) r8
            java.lang.Object r8 = com.google.android.gms.common.internal.C0446Preconditions.checkNotNull(r8)
            com.google.android.gms.common.api.Api$Client r8 = (com.google.android.gms.common.api.C0211Api.Client) r8
            r6 = r8
            r8 = r5
        ...
        L_0x0114:
            ...
            r1 = r8
            java.util.concurrent.ExecutorService r8 = com.google.android.gms.common.api.internal.C0302zabe.zaa()
            r2 = r8
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.api.internal.C0288zaar.zaa():void");
    }
    ...
    public final boolean zaz() {
        ...
        C0184ConnectionResult connectionResult2 = this.zae;
    ...
    public final void zaA() {
        ...
        if (this.zah == 0) {
            if (!this.zam || this.zan) {
                ...
                for (C0211Api.AnyClientKey next : this.zaa.zaa.keySet()) {
                    if (!this.zaa.zab.containsKey(next)) {
