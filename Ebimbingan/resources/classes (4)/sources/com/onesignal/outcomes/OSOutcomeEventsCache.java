            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    try {
                        ...
                        switch (AnonymousClass1.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[notificationInfluenceType.ordinal()]) {
                            case 1:
                        ...
                        switch (AnonymousClass1.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[iamInfluenceType.ordinal()]) {
                            case 1:
