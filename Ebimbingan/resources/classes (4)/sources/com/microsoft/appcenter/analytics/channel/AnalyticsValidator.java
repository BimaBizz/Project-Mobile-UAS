    ...
    private static Map<String, String> validateProperties(Map<String, String> map, String str, String str2) {
        ...
        while (true) {
            ...
            if (result.size() >= MAX_PROPERTY_COUNT) {
                ...
                objArr2[1] = logName;
                Object[] objArr3 = objArr2;
                objArr3[2] = Integer.valueOf(MAX_PROPERTY_COUNT);
        ...
        if (properties != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (count >= MAX_PROPERTY_COUNT) {
                    if (!maxCountReached) {
                        AppCenterLog.warn(Analytics.LOG_TAG, String.format("Typed properties cannot contain more than %s items. Skipping other properties.", new Object[]{Integer.valueOf(MAX_PROPERTY_COUNT)}));
