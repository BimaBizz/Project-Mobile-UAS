...
public class LocationServices {
    ...
    public static abstract class zza<R extends C0231Result> extends C0243BaseImplementation.ApiMethodImpl<R, zzaz> {
        ...
        public zza(C0222GoogleApiClient googleApiClient) {
            super((C0211Api<?>) LocationServices.API, googleApiClient);
        }
    }
    ...
    static {
        ...
        new C0211Api<>("LocationServices.API", CLIENT_BUILDER, CLIENT_KEY);
        API = api;
        new zzq();
    ...
    public static zzaz zza(C0222GoogleApiClient googleApiClient) {
        C0222GoogleApiClient googleApiClient2 = googleApiClient;
        C0446Preconditions.checkArgument(googleApiClient2 != null, "GoogleApiClient parameter is required.");
        zzaz zzaz = (zzaz) googleApiClient2.getClient(CLIENT_KEY);
        zzaz zzaz2 = zzaz;
        C0446Preconditions.checkState(zzaz != null, "GoogleApiClient is not configured to use the LocationServices.API Api. Pass thisinto GoogleApiClient.Builder#addApi() to use this feature.");
        return zzaz2;
    }
}
