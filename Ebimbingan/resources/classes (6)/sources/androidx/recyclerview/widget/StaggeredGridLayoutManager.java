...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public boolean isAutoMeasureEnabled() {
        return this.mGapStrategy != 0 ? true : DEBUG;
    }
    ...
    public View hasGapsToFix() {
        ...
        while (true) {
            ...
            if (!lp.mFullSpan && i2 + nextChildDiff != childLimit) {
                ...
                if (compareSpans) {
                    if ((lp.mSpan.mIndex - ((LayoutParams) nextChild.getLayoutParams()).mSpan.mIndex < 0 ? true : DEBUG) != (preferredSpanDir < 0 ? true : DEBUG)) {
                        return child;
                    }
                } else {
                    continue;
    ...
    private boolean checkSpanForGap(Span span) {
        ...
        if (this.mShouldReverseLayout) {
            if (span2.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
                return !span2.getLayoutParams(span2.mViews.get(span2.mViews.size() + -1)).mFullSpan ? true : DEBUG;
            }
        } else if (span2.getStartLine() > this.mPrimaryOrientation.getStartAfterPadding()) {
            return !span2.getLayoutParams(span2.mViews.get(0)).mFullSpan ? true : DEBUG;
        }
        return DEBUG;
    }
    ...
    private void resolveShouldLayoutReverse() {
        ...
        this.mShouldReverseLayout = !this.mReverseLayout ? true : DEBUG;
    }
    ...
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z) {
        ...
        boolean recalculateAnchor = (anchorInfo.mValid && this.mPendingScrollPosition == -1 && this.mPendingSavedState == null) ? DEBUG : true;
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout) {
                ...
                fixStartGap(recycler2, state2, DEBUG);
            } else {
                fixStartGap(recycler2, state2, true);
                fixEndGap(recycler2, state2, DEBUG);
            }
        }
        boolean hasGaps = false;
        if (shouldCheckForGaps && !state2.isPreLayout()) {
            if ((this.mGapStrategy == 0 || getChildCount() <= 0 || (!this.mLaidOutInvalidFullSpan && hasGapsToFix() == null)) ? DEBUG : true) {
                boolean removeCallbacks = removeCallbacks(this.mCheckForGapsRunnable);
                if (checkForGaps()) {
                    hasGaps = true;
                }
        ...
        if (hasGaps) {
            this.mAnchorInfo.reset();
            onLayoutChildren(recycler2, state2, DEBUG);
        }
    }
    ...
    public boolean updateAnchorFromPendingData(RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (this.mPendingSavedState == null || this.mPendingSavedState.mAnchorPosition == -1 || this.mPendingSavedState.mSpanOffsetsSize < 1) {
            ...
            if (child != null) {
                ...
                if (this.mPendingScrollPositionOffset == Integer.MIN_VALUE) {
                    anchorInfo2.mLayoutFromEnd = calculateScrollDirectionForPosition(anchorInfo2.mPosition) == 1 ? true : DEBUG;
                    anchorInfo2.assignCoordinateFromPadding();
                } else {
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        return ScrollbarHelper.computeScrollOffset(state2, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG), findFirstVisibleItemClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        return ScrollbarHelper.computeScrollExtent(state2, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG), findFirstVisibleItemClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        return ScrollbarHelper.computeScrollRange(state2, this.mPrimaryOrientation, findFirstVisibleItemClosestToStart(!this.mSmoothScrollbarEnabled ? true : DEBUG), findFirstVisibleItemClosestToEnd(!this.mSmoothScrollbarEnabled ? true : DEBUG), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        ...
        if (lp.mFullSpan) {
            ...
            measureChildWithDecorationsAndMargin(child, getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, lp.width, DEBUG), getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), lp.height, true), alreadyMeasured);
        } else {
            measureChildWithDecorationsAndMargin(child, getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), lp.width, true), getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, lp.height, DEBUG), alreadyMeasured);
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(sglp.getSpanIndex(), sglp.mFullSpan ? this.mSpanCount : 1, -1, -1, sglp.mFullSpan, DEBUG));
        } else {
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, sglp.getSpanIndex(), sglp.mFullSpan ? this.mSpanCount : 1, sglp.mFullSpan, DEBUG));
        }
    }
    ...
    private void updateLayoutState(int i, RecyclerView.State state) {
        ...
        if (isSmoothScrolling() && (targetPos = state2.getTargetScrollPosition()) != -1) {
            if (this.mShouldReverseLayout == (targetPos < anchorPosition ? true : DEBUG)) {
        ...
        this.mLayoutState.mInfinite = (this.mPrimaryOrientation.getMode() == 0 && this.mPrimaryOrientation.getEnd() == 0) ? true : DEBUG;
    }

    private void setLayoutStateDirection(int i) {
        int direction = i;
        this.mLayoutState.mLayoutDirection = direction;
        this.mLayoutState.mItemDirection = this.mShouldReverseLayout == (direction == -1 ? true : DEBUG) ? 1 : -1;
    }
    ...
    private void updateRemainingSpans(Span span, int layoutDir, int i) {
        ...
        if (layoutDir == -1) {
            if (span2.getStartLine() + deletedSize <= targetLine) {
                this.mRemainingSpans.set(span2.mIndex, DEBUG);
            }
    ...
    private boolean preferLastSpan(int i) {
        int layoutDir = i;
        if (this.mOrientation == 0) {
            return (layoutDir == -1 ? true : DEBUG) != this.mShouldReverseLayout ? true : DEBUG;
        }
        return ((layoutDir == -1 ? true : DEBUG) == this.mShouldReverseLayout ? true : DEBUG) == isLayoutRTL() ? true : DEBUG;
    }
    ...
    private int calculateScrollDirectionForPosition(int i) {
        ...
        return (position < getFirstChildPosition() ? true : DEBUG) != this.mShouldReverseLayout ? -1 : 1;
    }
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        boolean shouldSearchFromStart = (!this.mReverseLayout ? true : DEBUG) == (layoutDir == -1 ? true : DEBUG) ? true : DEBUG;
    ...
    class Span {
        ...
        public int findFirstVisibleItemPosition() {
            ...
            if (this.this$0.mReverseLayout) {
                findOneVisibleChild = findOneVisibleChild(this.mViews.size() - 1, -1, StaggeredGridLayoutManager.DEBUG);
            } else {
                findOneVisibleChild = findOneVisibleChild(0, this.mViews.size(), StaggeredGridLayoutManager.DEBUG);
            }
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i, int i2, boolean z, boolean z2, boolean z3) {
            ...
            while (true) {
                ...
                boolean childStartInclusion = acceptEndPointInclusion ? childStart <= end ? true : StaggeredGridLayoutManager.DEBUG : childStart < end ? true : StaggeredGridLayoutManager.DEBUG;
                boolean childEndInclusion = acceptEndPointInclusion ? childEnd >= start ? true : StaggeredGridLayoutManager.DEBUG : childEnd > start ? true : StaggeredGridLayoutManager.DEBUG;
        ...
        public int findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible) {
            return findOnePartiallyOrCompletelyVisibleChild(fromIndex, toIndex, completelyVisible, true, StaggeredGridLayoutManager.DEBUG);
        }

        /* access modifiers changed from: package-private */
        public int findOnePartiallyVisibleChild(int fromIndex, int toIndex, boolean acceptEndPointInclusion) {
            return findOnePartiallyOrCompletelyVisibleChild(fromIndex, toIndex, StaggeredGridLayoutManager.DEBUG, StaggeredGridLayoutManager.DEBUG, acceptEndPointInclusion);
        }
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            FullSpanItem(Parcel parcel) {
                ...
                this.mHasUnwantedGapAfter = in.readInt() == 1 ? true : StaggeredGridLayoutManager.DEBUG;
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.mLastLayoutRTL = in.readInt() == 1 ? true : StaggeredGridLayoutManager.DEBUG;
