...
import com.google.android.gms.common.internal.C0538zzr;
...
public class C0580ConnectionTracker {
    private static final Object zzb;
    @Nullable
    private static volatile C0580ConnectionTracker zzc;
    @RecentlyNonNull
    ...
    private C0580ConnectionTracker() {
        /*
            r4 = this;
            r0 = r4
            r2 = r0
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.stats.C0580ConnectionTracker.<init>():void");
    }

    @RecentlyNonNull
    @C0206KeepForSdk
    public static C0580ConnectionTracker getInstance() {
        C0580ConnectionTracker connectionTracker;
        if (zzc == null) {
            Object obj = zzb;
            synchronized (obj) {
                try {
                    if (zzc == null) {
                        new C0580ConnectionTracker();
        ...
        C0580ConnectionTracker connectionTracker2 = zzc;
        Object checkNotNull = C0446Preconditions.checkNotNull(connectionTracker2);
    ...
    private final boolean zzb(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i, boolean z) {
        ...
        if (component != null) {
            ...
            try {
                if ((C0628Wrappers.packageManager(context2).getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
    ...
    private static boolean zzc(ServiceConnection serviceConnection) {
        return !(serviceConnection instanceof C0538zzr);
    }
