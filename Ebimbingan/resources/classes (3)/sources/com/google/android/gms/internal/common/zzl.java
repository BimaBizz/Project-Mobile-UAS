...
public final class zzl {
    public static int zza(int i, int i2, @NullableDecl String str) {
        ...
        Object obj = "index";
        if (i3 < 0) {
            zza = zzm.zza("%s (%s) must not be negative", obj, Integer.valueOf(i3));
        } else if (i4 < 0) {
            ...
            zza = zzm.zza("%s (%s) must be less than size (%s)", obj, Integer.valueOf(i3), Integer.valueOf(i4));
        }
    ...
    public static void zzc(int i, int i2, int i3) {
        ...
        if (i4 < 0 || i5 < i4 || i5 > i6) {
            if (i4 < 0 || i4 > i6) {
                ...
                str = zzm.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i5), Integer.valueOf(i4));
            }
    ...
    private static String zzd(int i, int i2, @NullableDecl String str) {
        ...
        String str2 = str;
        if (i3 < 0) {
            return zzm.zza("%s (%s) must not be negative", str2, Integer.valueOf(i3));
        } else if (i4 < 0) {
            new StringBuilder(26);
            StringBuilder append = sb.append("negative size: ");
            StringBuilder append2 = sb.append(i4);
            ...
            return zzm.zza("%s (%s) must not be greater than size (%s)", str2, Integer.valueOf(i3), Integer.valueOf(i4));
        }
    }
}
