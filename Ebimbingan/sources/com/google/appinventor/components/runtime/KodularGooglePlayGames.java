...
public class KodularGooglePlayGames extends AndroidNonvisibleComponent implements ActivityResultListener, OnResumeListener {
    ...
    private C0124GoogleSignInClient googleSignInClient;
    ...
    private C0125GoogleSignInOptions signInOptions;
    ...
    public KodularGooglePlayGames(com.google.appinventor.components.runtime.ComponentContainer r7) {
        /*
            ...
            r2 = r0
            com.google.android.gms.auth.api.signin.GoogleSignInOptions r3 = com.google.android.gms.auth.api.signin.C0125GoogleSignInOptions.DEFAULT_GAMES_SIGN_IN
            r2.signInOptions = r3
            r2 = r0
            r5 = r2
            r2 = r5
            ...
            com.google.android.gms.auth.api.signin.GoogleSignInClient r3 = com.google.android.gms.auth.api.signin.C0121GoogleSignIn.getClient((android.content.Context) r3, (com.google.android.gms.auth.api.signin.C0125GoogleSignInOptions) r4)
    ...
    public void UnlockAchievement(String str) {
        String str2 = str;
        if (!isCompanionMode()) {
            C0122GoogleSignInAccount lastSignedInAccount = C0121GoogleSignIn.getLastSignedInAccount(this.context);
    ...
    private boolean isSignedIn() {
        return C0121GoogleSignIn.getLastSignedInAccount(this.context) != null;
    }
    ...
    private void signInSilently(boolean z) {
        ...
        C0122GoogleSignInAccount lastSignedInAccount = C0121GoogleSignIn.getLastSignedInAccount(this.context);
        C0122GoogleSignInAccount googleSignInAccount = lastSignedInAccount;
        if (C0121GoogleSignIn.hasPermissions(lastSignedInAccount, this.signInOptions.getScopeArray())) {
            onConnected(googleSignInAccount);
            return;
        }
        final boolean z3 = z2;
        new OnCompleteListener<C0122GoogleSignInAccount>(this) {
            private /* synthetic */ KodularGooglePlayGames hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
            ...
            public final void onComplete(Task<C0122GoogleSignInAccount> task) {
                Task<C0122GoogleSignInAccount> task2 = task;
                if (task2.isSuccessful()) {
        ...
        Task<C0122GoogleSignInAccount> addOnCompleteListener = this.googleSignInClient.silentSignIn().addOnCompleteListener((Activity) this.form, onCompleteListener);
    }
    ...
    private void signOut() {
        ...
        Task<Void> addOnCompleteListener = this.googleSignInClient.signOut().addOnCompleteListener((Activity) this.form, onCompleteListener);
        onDisconnected();
    }

    /* access modifiers changed from: private */
    public void onConnected(C0122GoogleSignInAccount googleSignInAccount) {
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i == this.requestCode) {
            C0127GoogleSignInResult signInResultFromIntent = C0031Auth.GoogleSignInApi.getSignInResultFromIntent(intent2);
