...
public interface C0440IGmsServiceBroker extends IInterface {

    /* renamed from: com.google.android.gms.common.internal.IGmsServiceBroker$Stub */
    /* compiled from: com.google.android.gms:play-services-basement@@17.6.0 */
    public static abstract class Stub extends Binder implements C0440IGmsServiceBroker {
        public Stub() {
        ...
        public final boolean onTransact(int i, @RecentlyNonNull Parcel parcel, @Nullable Parcel parcel2, int i2) throws RemoteException {
            ...
            C0439IGmsCallbacks iGmsCallbacks2;
            Throwable th;
            Throwable th2;
            ...
            if (readStrongBinder == null) {
                ...
                if (queryLocalInterface instanceof C0439IGmsCallbacks) {
                    iGmsCallbacks2 = (C0439IGmsCallbacks) queryLocalInterface;
                } else {
                    new C0546zzz(readStrongBinder);
                    iGmsCallbacks2 = iGmsCallbacks;
                }
            }
            if (i3 == 46) {
                if (parcel3.readInt() != 0) {
                    getServiceRequest = C0432GetServiceRequest.CREATOR.createFromParcel(parcel3);
                } else {
                    getServiceRequest = null;
                }
                getService(iGmsCallbacks2, getServiceRequest);
                Object checkNotNull = C0446Preconditions.checkNotNull(parcel4);
                parcel4.writeNoException();
                return true;
            } else if (i3 == 47) {
                if (parcel3.readInt() != 0) {
                    C0520zzai createFromParcel = C0520zzai.CREATOR.createFromParcel(parcel3);
                }
    ...
    @C0206KeepForSdk
    void getService(@RecentlyNonNull C0439IGmsCallbacks iGmsCallbacks, @Nullable C0432GetServiceRequest getServiceRequest) throws RemoteException;
}
