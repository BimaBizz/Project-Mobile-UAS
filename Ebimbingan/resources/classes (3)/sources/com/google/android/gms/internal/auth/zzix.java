...
final class zzix {
    static String zza(zzis zzis, String str) {
        StringBuilder sb;
        new StringBuilder();
    ...
    private static void zza(zzis zzis, StringBuilder sb, int i) {
        Map map;
        Map map2;
        Set set;
        Throwable th;
        ...
        for (String str15 : set2) {
            ...
            if (substring.endsWith("List") && !str17.endsWith("OrBuilderList") && !str17.equals("List")) {
                ...
                if (method2 != null && method3.getReturnType().equals(List.class)) {
                    zza(sb2, i2, zza(str20), zzhm.zza(method3, (Object) zzis2, new Object[0]));
                }
            }
            if (str17.endsWith("Map") && !str17.equals("Map")) {
                ...
                if (method4 != null && method5.getReturnType().equals(Map.class) && !method5.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method5.getModifiers())) {
                    zza(sb2, i2, zza(str23), zzhm.zza(method5, (Object) zzis2, new Object[0]));
                }
            }
            Map map5 = map4;
            ...
            if (((Method) map5.get(str2)) != null) {
                ...
                if (method6 != null) {
                    Object zza = zzhm.zza(method6, (Object) zzis2, new Object[0]);
                    if (method7 == null) {
                        Object obj = zza;
                        Object obj2 = obj;
                        if (obj instanceof Boolean) {
                            ...
                            z = obj2.equals("");
                        } else if (obj2 instanceof zzgi) {
                            z = obj2.equals(zzgi.zza);
                        } else if (obj2 instanceof zzis) {
                            z = obj2 == ((zzis) obj2).zzh();
                        ...
                        booleanValue = ((Boolean) zzhm.zza(method7, (Object) zzis2, new Object[0])).booleanValue();
                    }
                    if (booleanValue) {
        ...
        if (zzis2 instanceof zzhm.zzd) {
            Iterator<Map.Entry<zzhm.zzc, Object>> zzd = ((zzhm.zzd) zzis2).zzc.zzd();
            Iterator<Map.Entry<zzhm.zzc, Object>> it = zzd;
            if (zzd.hasNext()) {
                zzhm.zzc zzc = (zzhm.zzc) it.next().getKey();
                Throwable th2 = th;
                new NoSuchMethodError();
                throw th2;
            }
        }
        if (((zzhm) zzis2).zzb != null) {
            ((zzhm) zzis2).zzb.zza(sb2, i2);
        }
    }
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj2 instanceof List) {
            ...
            if (obj2 instanceof String) {
                StringBuilder append4 = sb2.append(": \"").append(zzjw.zza(zzgi.zza((String) obj2))).append('\"');
            } else if (obj2 instanceof zzgi) {
                StringBuilder append5 = sb2.append(": \"").append(zzjw.zza((zzgi) obj2)).append('\"');
            } else if (obj2 instanceof zzhm) {
                StringBuilder append6 = sb2.append(" {");
                zza((zzhm) obj2, sb2, i2 + 2);
                ...
                zza(sb2, i2 + 2, "value", entry.getValue());
