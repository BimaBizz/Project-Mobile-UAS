...
public class ResolutionAnchor extends ResolutionNode {
    ...
    public String toString() {
        ...
        if (this.state != 1) {
            ...
            new StringBuilder();
            return sb2.append("[").append(this.myAnchor).append(", RESOLVED: ").append(this.resolvedTarget).append(":").append(this.resolvedOffset).append("] type: ").append(sType(this.type)).toString();
        }
    }
