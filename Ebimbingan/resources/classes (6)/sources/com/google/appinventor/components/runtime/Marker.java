...
public class Marker extends MapFeatureBaseWithFill implements MapFactory.MapMarker {
    ...
    private GeoPoint f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;
    ...
    public Marker(com.google.appinventor.components.runtime.util.MapFactory.MapFeatureContainer r12) {
        /*
            ...
            r8 = 0
            r5.<init>(r6, r8)
            r3.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = r4
            r3 = r1
            r4 = -1
    ...
    public void Latitude(double d) {
        ...
        this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setLatitude(d2);
        clearGeometry();
    ...
    public double Latitude() {
        return this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getLatitude();
    }
    ...
    public void Longitude(double d) {
        ...
        this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setLongitude(d2);
        clearGeometry();
        this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
    }
    ...
    public double Longitude() {
        return this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.getLongitude();
    }
    ...
    public void SetLocation(double d, double d2) {
        ...
        this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.setCoords(d, d2);
        clearGeometry();
        this.map.getController().updateFeaturePosition((MapFactory.MapMarker) this);
    }
    ...
    public double BearingToPoint(double d, double d2) {
        IGeoPoint iGeoPoint;
        new GeoPoint(d, d2);
        return this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou.bearingTo(iGeoPoint);
    }
    ...
    public IGeoPoint getLocation() {
        return this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou;
    }

    public void updateLocation(double d, double d2) {
        GeoPoint geoPoint;
        new GeoPoint(d, d2);
        this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou = geoPoint;
        clearGeometry();
    }
    ...
    public Geometry computeGeometry() {
        return GeometryUtil.createGeometry(this.f193wq07duYRO6iFAgWM70EZOSvbCMKs1QznMRJKrct0XuHOBYqCk3XqOKtSBGIpDou);
    }
}
