...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private boolean showsChipIcon() {
        return (!this.chipIconVisible || this.chipIcon == null) ? DEBUG : true;
    }

    private boolean showsCheckedIcon() {
        return (!this.checkedIconVisible || this.checkedIcon == null || !this.currentChecked) ? DEBUG : true;
    }

    private boolean showsCloseIcon() {
        return (!this.closeIconVisible || this.closeIcon == null) ? DEBUG : true;
    }

    private boolean canShowCheckedIcon() {
        return (!this.checkedIconVisible || this.checkedIcon == null || !this.checkable) ? DEBUG : true;
    }
    ...
    private void drawText(@NonNull Canvas canvas, Rect rect) {
        ...
        if (this.unicodeWrappedText != null) {
            ...
            boolean clip = Math.round(getTextWidth()) > Math.round(this.rectF.width()) ? true : DEBUG;
            int saveCount = 0;
            if (clip) {
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        boolean newChecked = (!hasState(getState(), 16842912) || !this.checkable) ? DEBUG : true;
    ...
    private static boolean isStateful(@Nullable ColorStateList colorStateList) {
        ...
        return (colorStateList2 == null || !colorStateList2.isStateful()) ? DEBUG : true;
    }

    private static boolean isStateful(@Nullable Drawable drawable) {
        Drawable drawable2 = drawable;
        return (drawable2 == null || !drawable2.isStateful()) ? DEBUG : true;
    }

    private static boolean isStateful(@Nullable TextAppearance textAppearance2) {
        TextAppearance textAppearance3 = textAppearance2;
        return (textAppearance3 == null || textAppearance3.textColor == null || !textAppearance3.textColor.isStateful()) ? DEBUG : true;
    }
    ...
    private void applyChildDrawable(@Nullable Drawable drawable) {
        ...
        if (drawable2 != null) {
            ...
            boolean visible = drawable2.setVisible(isVisible(), DEBUG);
