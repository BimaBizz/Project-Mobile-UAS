...
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    private boolean needsMirroring() {
        return (!isAutoMirrored() || getLayoutDirection() != 1) ? DEBUG : true;
    }
    ...
    public boolean selectDrawable(int i) {
        ...
        if (this.mDrawableContainerState.mExitFadeDuration > 0) {
            if (this.mLastDrawable != null) {
                boolean visible = this.mLastDrawable.setVisible(DEBUG, DEBUG);
            }
            if (this.mCurrDrawable != null) {
            ...
            boolean visible2 = this.mCurrDrawable.setVisible(DEBUG, DEBUG);
        }
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final int addChild(Drawable drawable) {
            ...
            boolean visible = dr.setVisible(DrawableContainer.DEBUG, true);
