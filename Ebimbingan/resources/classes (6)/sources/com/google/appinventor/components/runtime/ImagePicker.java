...
public class ImagePicker extends Picker implements ActivityResultListener {
    ...
    public void resultReturned(int i, int i2, Intent intent) {
        ...
        if (i == this.requestCode && i3 == -1) {
            this.AsUIHfRHW1pScN9YQW0IsOeuFdHXhbXb53xXbDg8x2ZIBxv57XORnQnTS1wprCIt = B8WBXPBCF2jGfUDZZU2zV5EYdqbUBu0lAZ0THCEqYyuE8VACR9dY7rDnwBIqh64T(intent2.getData());
            AfterPicking(this.AsUIHfRHW1pScN9YQW0IsOeuFdHXhbXb53xXbDg8x2ZIBxv57XORnQnTS1wprCIt);
        }
    }
