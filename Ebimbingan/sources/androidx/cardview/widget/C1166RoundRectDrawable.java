...
class C1166RoundRectDrawable extends Drawable {
    ...
    C1166RoundRectDrawable(ColorStateList backgroundColor, float radius) {
        Paint paint;
        RectF rectF;
        Rect rect;
        this.mRadius = radius;
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            float vInset = C1167RoundRectDrawableWithShadow.calculateVerticalPadding(this.mPadding, this.mRadius, this.mInsetForRadius);
            this.mBoundsI.inset((int) Math.ceil((double) C1167RoundRectDrawableWithShadow.calculateHorizontalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil((double) vInset));
