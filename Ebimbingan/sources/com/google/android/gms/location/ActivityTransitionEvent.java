...
@C0463SafeParcelable.Class(creator = "ActivityTransitionEventCreator")
@C0463SafeParcelable.Reserved({1000})
public class ActivityTransitionEvent extends C0460AbstractSafeParcelable {
    ...
    @C0463SafeParcelable.Field(getter = "getElapsedRealTimeNanos", id = 3)
    ...
    public ActivityTransitionEvent(@C0463SafeParcelable.Param(id = 1) int i, @C0463SafeParcelable.Param(id = 2) int i2, @C0463SafeParcelable.Param(id = 3) long j) {
        int i3 = i;
        int i4 = i2;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        C0462SafeParcelWriter.writeLong(parcel2, 3, getElapsedRealTimeNanos());
