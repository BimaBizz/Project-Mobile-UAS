...
public final class KodularAdManagerBanner extends AndroidViewComponent implements OnDestroyListener, OnPauseListener, OnResumeListener {
    ...
    private final KodularAdManager f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;
    ...
    public KodularAdManagerBanner(com.google.appinventor.components.runtime.ComponentContainer r11) {
        /*
            ...
            r6.<init>(r7, r8)
            r4.f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r5
            r4 = r0
        ...
        if (build.isTestDevice(this.context) || !this.testMode) {
            if (!this.poblgm1P6mADk8QKAia8LTNTlp3hP9LK4vL2LyACRyn6OaTobhLhKjphCbjAETmg) {
                if (this.testMode || this.form.IsCompanion()) {
                    ...
                    this.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.setAdUnitId(this.f125hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.getAdUnit());
                }
            ...
            new KodularContentProtection.OnValidationResultListener(this) {
                ...
                /* renamed from: hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME  reason: collision with other field name */
                private /* synthetic */ KodularAdManagerBanner f126hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME;

                {
                    this.f126hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME = r6;
                }
                ...
                public final void onResult(boolean z, boolean z2, String str) {
                    ...
                    String str2 = str;
                    if (!z || !z3) {
                        this.f126hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME.FailedToLoad(str2);
                    } else {
                        KodularAdManagerBanner.hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME(this.f126hxYOFxFjLpN1maJuWNxUV40nExCGxsxkDPOTgtzMu4zlZCQb3bPlKsXo1SYJg6ME).loadAd(adManagerAdRequest2);
                    }
                }
            };
