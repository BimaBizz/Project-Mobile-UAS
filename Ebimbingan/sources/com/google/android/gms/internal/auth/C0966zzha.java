...
/* renamed from: com.google.android.gms.internal.auth.zzha */
/* compiled from: com.google.android.gms:play-services-auth-base@@17.1.2 */
final class C0966zzha extends C0941zzgc<Double> implements C0985zzht<Double>, C1024zzje, RandomAccess {
    private static final C0966zzha zza;
    private double[] zzb;
    private int zzc;
    ...
    private C0966zzha(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
    ...
    public final boolean equals(java.lang.Object r11) {
        ...
        L_0x0009:
            r6 = r2
            boolean r6 = r6 instanceof com.google.android.gms.internal.auth.C0966zzha
        ...
        L_0x0016:
            r6 = r2
            com.google.android.gms.internal.auth.zzha r6 = (com.google.android.gms.internal.auth.C0966zzha) r6
            r3 = r6
            r6 = r1
            int r6 = r6.zzc
            r7 = r3
        ...
        L_0x004d:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.auth.C0966zzha.equals(java.lang.Object):boolean");
    }

    public final int hashCode() {
        int i = 1;
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + C0980zzho.zza(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (!(collection2 instanceof C0966zzha)) {
            return super.addAll(collection2);
        }
        C0966zzha zzha = (C0966zzha) collection2;
        C0966zzha zzha2 = zzha;
        if (zzha.zzc == 0) {
            return false;
        }
        if (Integer.MAX_VALUE - this.zzc < zzha2.zzc) {
            Throwable th2 = th;
    ...
    public final /* synthetic */ C0985zzht zza(int i) {
        ...
        new C0966zzha(Arrays.copyOf(this.zzb, i2), this.zzc);
        return zzht;
    }
