...
public class PersistentConnection implements Connection.Delegate {
    ...
    public void onDataMessage(Map<String, Object> map) {
        ...
        if (message.containsKey("r")) {
            ...
            if (message.containsKey(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY)) {
                onDataPush((String) message.get(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY), (Map) message.get("b"));
    ...
    public void onDisconnectPut(Path path, Object obj, Firebase.CompletionListener completionListener) {
        ...
        if (canSendWrites()) {
            sendOnDisconnect("o", path2, data, onComplete);
            return;
        }
        new OutstandingDisconnect("o", path2, data, onComplete, (AnonymousClass1) null);
    ...
    private void sendAction(String action, Map<String, Object> message, ResponseListener onResponse) {
        ...
        Object put2 = request.put(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, action);
