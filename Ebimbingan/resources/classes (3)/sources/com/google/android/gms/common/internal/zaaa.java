...
public final class zaaa extends Button {
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        setTextColor((ColorStateList) Preconditions.checkNotNull(resources2.getColorStateList(zab(i4, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))));
        switch (i3) {
            case 0:
