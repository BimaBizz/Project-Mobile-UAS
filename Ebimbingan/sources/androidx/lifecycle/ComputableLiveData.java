...
import androidx.arch.core.executor.C1157ArchTaskExecutor;
...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData() {
        this(C1157ArchTaskExecutor.getIOThreadExecutor());
    }
    ...
    public void invalidate() {
        C1157ArchTaskExecutor.getInstance().executeOnMainThread(this.mInvalidationRunnable);
    }
}
