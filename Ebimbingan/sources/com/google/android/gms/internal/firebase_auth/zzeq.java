...
public final class zzeq implements zzfd<zzp.zzh> {
    ...
    private zzeq(zzfw zzfw, ActionCodeSettings actionCodeSettings, @Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4) {
        String str5 = str;
        String str6 = str4;
        this.zzru = zzc((zzfw) C0446Preconditions.checkNotNull(zzfw));
        this.zzkk = (ActionCodeSettings) C0446Preconditions.checkNotNull(actionCodeSettings);
        this.zzif = null;
        this.zzku = str2;
        this.zzib = str3;
        this.zzhy = null;
    ...
    public final zzeq zzck(String str) {
        this.zzib = C0446Preconditions.checkNotEmpty(str);
        return this;
    }
