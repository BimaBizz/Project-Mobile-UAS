...
final class zzfs {
    private final ConcurrentHashMap<zzfv, List<Throwable>> zza;
    private final ReferenceQueue<Throwable> zzb;

    zzfs() {
        ConcurrentHashMap<zzfv, List<Throwable>> concurrentHashMap;
    ...
    public final List<Throwable> zza(Throwable th, boolean z) {
        ...
        new zzfv(th2, (ReferenceQueue<Throwable>) null);
