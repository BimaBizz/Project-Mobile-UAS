...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean isStateful() {
        ...
        return (super.isStateful() || (this.mVectorState != null && (this.mVectorState.isStateful() || (this.mVectorState.mTint != null && this.mVectorState.mTint.isStateful())))) ? true : DBG_VECTOR_DRAWABLE;
    }
    ...
    private boolean needMirroring() {
        ...
        return (!isAutoMirrored() || DrawableCompat.getLayoutDirection(this) != 1) ? DBG_VECTOR_DRAWABLE : true;
    }
    ...
    private static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean hasTranslucentRoot() {
            return this.mVPathRenderer.getRootAlpha() < 255 ? true : VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
        }
    ...
    private static class VFullPath extends VPath {
        ...
        public boolean isStateful() {
            return (this.mFillColor.isStateful() || this.mStrokeColor.isStateful()) ? true : VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
        }
