...
public class ViewPager extends ViewGroup {
    ...
    public void setPageTransformer(boolean z, @Nullable PageTransformer pageTransformer, int i) {
        ...
        boolean needsPopulate = hasTransformer != (this.mPageTransformer != null ? true : DEBUG) ? true : DEBUG;
    ...
    private void completeScroll(boolean z) {
        ...
        if (needPopulate) {
            setScrollingCacheEnabled(DEBUG);
            if (!this.mScroller.isFinished() ? true : DEBUG) {
                this.mScroller.abortAnimation();
                int oldX = getScrollX();
                int oldY = getScrollY();
                int x = this.mScroller.getCurrX();
    ...
    private boolean resetTouch() {
        ...
        return (this.mLeftEdge.isFinished() || this.mRightEdge.isFinished()) ? true : DEBUG;
    }
    ...
    public boolean canScrollHorizontally(int i) {
        ...
        int scrollX = getScrollX();
        if (direction < 0) {
            return scrollX > ((int) (((float) width) * this.mFirstOffset)) ? true : DEBUG;
        } else if (direction <= 0) {
            return DEBUG;
        } else {
            return scrollX < ((int) (((float) width) * this.mLastOffset)) ? true : DEBUG;
        }
    }
    ...
    public boolean canScroll(View view, boolean z, int i, int i2, int i3) {
        ...
        return (!checkV || !v.canScrollHorizontally(-dx)) ? DEBUG : true;
    }
    ...
    public boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        ...
        return (!(p instanceof LayoutParams) || !super.checkLayoutParams(p)) ? DEBUG : true;
    }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        private boolean canScroll() {
            return (this.this$0.mAdapter == null || this.this$0.mAdapter.getCount() <= 1) ? ViewPager.DEBUG : true;
        }
    }
