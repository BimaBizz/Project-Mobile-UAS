...
class NeuQuant {
    ...
    public void unbiasnet() {
        for (int i = 0; i < 256; i++) {
            ...
            iArr2[1] = iArr2[1] >> netbiasshift;
            int[] iArr3 = this.network[i];
            iArr3[2] = iArr3[2] >> netbiasshift;
            this.network[i][3] = i;
        }
    }
        ...
        while (true) {
            if (j < hi || k > lo) {
                ...
                if (j < hi) {
                    ...
                    int[] iArr = p;
                    try {
                        iArr[0] = iArr[0] - ((a * (p[0] - b)) / alpharadbias);
                        int[] iArr2 = p;
                        iArr2[1] = iArr2[1] - ((a * (p[1] - g)) / alpharadbias);
                        int[] iArr3 = p;
                        iArr3[2] = iArr3[2] - ((a * (p[2] - r)) / alpharadbias);
                    } catch (Exception e) {
                        Exception exc = e;
                    }
                }
                if (k > lo) {
                    ...
                    int[] iArr4 = p2;
                    try {
                        iArr4[0] = iArr4[0] - ((a * (p2[0] - b)) / alpharadbias);
                        int[] iArr5 = p2;
                        iArr5[1] = iArr5[1] - ((a * (p2[1] - g)) / alpharadbias);
                        int[] iArr6 = p2;
                        iArr6[2] = iArr6[2] - ((a * (p2[2] - r)) / alpharadbias);
                    } catch (Exception e2) {
                        Exception exc2 = e2;
                    }
                }
