...
public final class zzap extends zza implements zzao {
    ...
    public final void zza(PendingIntent pendingIntent, C0250IStatusCallback iStatusCallback) throws RemoteException {
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        Parcel parcel = obtainAndWriteInterfaceToken;
    ...
    public final void zza(ActivityTransitionRequest activityTransitionRequest, PendingIntent pendingIntent, C0250IStatusCallback iStatusCallback) throws RemoteException {
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        Parcel parcel = obtainAndWriteInterfaceToken;
