...
public abstract class zzev<K, V> implements Serializable, Map<K, V> {
    private static final Map.Entry<?, ?>[] zza = new Map.Entry[0];
    private transient zzez<Map.Entry<K, V>> zzb;
    private transient zzez<K> zzc;
    ...
    public abstract zzez<Map.Entry<K, V>> zza();

    /* access modifiers changed from: package-private */
    public abstract zzez<K> zzb();
    ...
    public boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r9) {
        ...
        L_0x0028:
            ...
            goto L_0x000e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.auth.zzev.equals(java.lang.Object):boolean");
    }

    public int hashCode() {
        return zzfk.zza((zzez) entrySet());
    }
    ...
    public /* synthetic */ Set entrySet() {
        zzez<Map.Entry<K, V>> zzez = this.zzb;
        zzez<Map.Entry<K, V>> zzez2 = zzez;
        if (zzez != null) {
            return zzez2;
        }
        zzez<Map.Entry<K, V>> zza2 = zza();
        zzez<Map.Entry<K, V>> zzez3 = zza2;
        this.zzb = zzez3;
        return zza2;
    }
