...
public final class zzaj {
    ...
    public static int zza(int i, int i2) {
        ...
        if (i7 < 0) {
            ...
            zza = zzar.zza("%s (%s) must not be negative", objArr2);
        } else if (i6 < 0) {
            Throwable th2 = th;
            ...
            zza = zzar.zza("%s (%s) must be less than size (%s)", objArr5);
        }
    ...
    public static int zzb(int i, int i2) {
        ...
        Throwable th2 = th;
        new IndexOutOfBoundsException(zzb(i5, i3, str));
        throw th2;
    }
    ...
    public static int zza(int i, int i2, @NullableDecl String str) {
        ...
        Throwable th2 = th;
        new IndexOutOfBoundsException(zzb(i3, i4, str2));
        throw th2;
    }
    ...
    private static String zzb(int i, int i2, @NullableDecl String str) {
        ...
        if (i3 < 0) {
            ...
            return zzar.zza("%s (%s) must not be negative", objArr2);
        } else if (i4 < 0) {
            Throwable th2 = th;
            new StringBuilder(26);
            ...
            return zzar.zza("%s (%s) must not be greater than size (%s)", objArr5);
        }
    }
    ...
    public static void zza(int i, int i2, int i3) {
        ...
        if (i4 < 0 || i5 < i4 || i5 > i6) {
            ...
            int i10 = i9;
            if (i9 < 0 || i10 > i7) {
                str = zzb(i10, i7, "start index");
            } else if (i8 < 0 || i8 > i7) {
                str = zzb(i8, i7, "end index");
            } else {
                Object[] objArr = new Object[2];
                objArr[0] = Integer.valueOf(i8);
                Object[] objArr2 = objArr;
                objArr2[1] = Integer.valueOf(i10);
                str = zzar.zza("end index (%s) must not be less than start index (%s)", objArr2);
            }
