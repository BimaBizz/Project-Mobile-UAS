...
public abstract class GcmTaskService extends Service {
    ...
    class zzd extends zzj {
        ...
        public final void handleMessage(Message message) {
            ...
            if (!C0616UidVerifier.uidHasPackageName(this.zzz, message2.sendingUid, "com.google.android.gms")) {
        ...
        try {
            ...
            if (SERVICE_ACTION_EXECUTE_TASK.equals(action)) {
                ...
                if (!(parcelableExtra instanceof PendingCallback)) {
                    ...
                    int e = Log.e("GcmTaskService", sb2.append(packageName).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(stringExtra).append(": Could not process request, invalid callback.").toString());
                    zzd(i4);
                    return 2;
        ...
        synchronized (obj) {
            try {
                ...
                if (z) {
                    ...
                    int w = Log.w("GcmTaskService", sb.append(packageName).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(str2).append(": Task already running, won't start another").toString());
                }
                boolean z3 = z2;
                return z3;
            } catch (Throwable th) {
    ...
    public IBinder onBind(Intent intent) {
        Intent intent2 = intent;
        if (intent2 == null || !C0609PlatformVersion.isAtLeastLollipop() || !SERVICE_ACTION_EXECUTE_TASK.equals(intent2.getAction())) {
            return null;
        }
