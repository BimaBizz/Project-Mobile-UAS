...
class EngineKey implements Key {
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest2.update(this.id.getBytes(Key.STRING_CHARSET_NAME));
        messageDigest2.update(dimensions);
        messageDigest2.update((this.cacheDecoder != null ? this.cacheDecoder.getId() : "").getBytes(Key.STRING_CHARSET_NAME));
        messageDigest2.update((this.decoder != null ? this.decoder.getId() : "").getBytes(Key.STRING_CHARSET_NAME));
        messageDigest2.update((this.transformation != null ? this.transformation.getId() : "").getBytes(Key.STRING_CHARSET_NAME));
        messageDigest2.update((this.encoder != null ? this.encoder.getId() : "").getBytes(Key.STRING_CHARSET_NAME));
        messageDigest2.update((this.sourceEncoder != null ? this.sourceEncoder.getId() : "").getBytes(Key.STRING_CHARSET_NAME));
    }
}
