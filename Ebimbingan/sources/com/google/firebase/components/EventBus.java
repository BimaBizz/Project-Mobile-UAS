...
class EventBus implements Subscriber, Publisher {
    ...
    public void publish(Event<?> event) {
        Event<?> event2 = event;
        Object checkNotNull = C0446Preconditions.checkNotNull(event2);
        synchronized (this) {
            try {
    ...
    public synchronized <T> void subscribe(Class<T> cls, Executor executor, EventHandler<? super T> eventHandler) {
        ...
        synchronized (this) {
            T checkNotNull = C0446Preconditions.checkNotNull(type);
            Object checkNotNull2 = C0446Preconditions.checkNotNull(handler);
            Object checkNotNull3 = C0446Preconditions.checkNotNull(executor2);
