...
public final class zzx implements Parcelable.Creator<SignInConfiguration> {
    ...
    public final /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel3.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 2:
                    ...
                    break;
                case 5:
                    googleSignInOptions = (GoogleSignInOptions) SafeParcelReader.createParcelable(parcel3, i, GoogleSignInOptions.CREATOR);
                    break;
                default:
        ...
        new SignInConfiguration(str, googleSignInOptions);
        return obj;
    }
}
