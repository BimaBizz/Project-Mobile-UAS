...
public final class zzac {
    ...
    public final void zza(Intent intent, TaskCompletionSource<AuthResult> taskCompletionSource, FirebaseAuth firebaseAuth) {
        ...
        Task<AuthResult> addOnFailureListener = firebaseAuth.signInWithCredential(zza).addOnSuccessListener(onSuccessListener).addOnFailureListener(onFailureListener);
    }
    ...
    public final void zza(Intent intent, TaskCompletionSource<AuthResult> taskCompletionSource, FirebaseUser firebaseUser) {
        ...
        Task<AuthResult> addOnFailureListener = firebaseUser.linkWithCredential(zza).addOnSuccessListener(onSuccessListener).addOnFailureListener(onFailureListener);
    }
    ...
    public final void zzb(Intent intent, TaskCompletionSource<AuthResult> taskCompletionSource, FirebaseUser firebaseUser) {
        ...
        Task<AuthResult> addOnFailureListener = firebaseUser.reauthenticateAndRetrieveData(zza).addOnSuccessListener(onSuccessListener).addOnFailureListener(onFailureListener);
    }

    private static AuthCredential zza(Intent intent) {
        Intent intent2 = intent;
        Object checkNotNull = C0446Preconditions.checkNotNull(intent2);
        return zzf.zza(((zzfm) C0464SafeParcelableSerializer.deserializeFromIntentExtra(intent2, "com.google.firebase.auth.internal.VERIFY_ASSERTION_REQUEST", zzfm.CREATOR)).zzq(true));
    }
