...
public final class zzat {
    ...
    public zzat(Context context, String str) {
        ...
        new Logger("StorageHelpers", new String[0]);
        this.zzjt = logger;
    }
    ...
    public final FirebaseUser zzfr() {
        ...
        try {
            ...
            if (jSONObject2.has("type") && "com.google.firebase.auth.internal.DefaultFirebaseUser".equalsIgnoreCase(jSONObject3.optString("type"))) {
